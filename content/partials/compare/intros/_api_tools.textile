...
A globally distributed data stream network providing an "all-encompassing platform":https://ably.com/api-streamer?utm_source={{COMPANY_ID_0}}_v_{{COMPANY_ID_1}}&utm_medium=compare_pages with everything you need to build the realtime experiences is the future. Just something to think about.