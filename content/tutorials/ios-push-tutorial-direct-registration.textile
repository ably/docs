...
To enable Push Notifications on your device, it must be registered with Ably first. This can be done in two ways; you can either have the device register itself directly with Ably or delegate the registration work to your app server, which would then register the device with Ably on its behalf. In this tutorial we'll implement direct device registration. You can jump to "another tutorial":/tutorials/ios-push-tutorial-server-registration if you'd rather like to have a server register the device with Ably.
...
<%= partial 'shared/tutorials/_setup_push_ios' %>

<a href="https://github.com/ably/tutorials/pull/60/commits/d2a105c84e94e3f8a5fdc198df54ed0a19dc0874">See this step in GitHub<a/>

h2(#step5). Step 5 - Setup Node.js server for authentication

<%= partial 'shared/tutorials/_setup_node_push_auth' %>

<a href="https://github.com/ably/tutorials/pull/60/commits/446116a382647196b4ed9055c6543d0737e2e016">See this step in GitHub<a/>
...
<a href="https://github.com/ably/tutorials/pull/60/commits/eb44aa626830711e939fa61739cd65691062491b">See this step in GitHub<a/>

h2(#further-reading). Further Reading

* The source code for this tutorial can be found <a href="https://github.com/ably/tutorials/pull/60">here.<a/>
