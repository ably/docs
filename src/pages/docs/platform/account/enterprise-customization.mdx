...
intro: "If you're an Ably Enterprise customer, then you can optionally create a custom endpoint to tailor the Ably platform to your specific requirements."
...
A custom endpoint enables you to benefit from the following:
