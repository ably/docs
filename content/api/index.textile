...
h3(#auto-generated). Auto-generated API references

Auto-generated API references are available for the realtime and REST client library SDKs. These are generated from the source code of each SDK using tooling common to each language, such as "TypeDoc":https://typedoc.org/ for JavaScript and "Jazzy":https://github.com/realm/jazzy for Swift and Objective-C.    

The SDKs that have this functionality available are:

* "JavaScript":https://ably.com/docs/sdk/js
* "Swift and Objective-C":https://ably.com/docs/sdk/cocoa
