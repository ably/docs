...
blang[php].
  ...
  And to simplify it even further, let's add @iframe@ so we can se result without the need to switch browser windows. Add code below just after the @<h1>Publish & Subscribe sample</h1>@:
