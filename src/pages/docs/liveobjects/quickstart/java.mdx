...
`get(key)` returns an untyped [`PathObject`](/docs/liveobjects/concepts/path-object?lang=java); the `as*` casts select the typed view and never throw. Learn more about [Typed views](/docs/liveobjects/typing?lang=java#typed-views).
...
* Learn about [Typed views](/docs/liveobjects/typing?lang=java) for your LiveObjects.
