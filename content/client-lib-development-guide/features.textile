...
** @(RTC1f)@ @transportParams@ map or equivalent, additional parameters to be sent in the querystring when initiating a realtime connection. Keys are strings, values are be anything stringifiable (at least strings, numbers, or booleans, with booleans represented in the querystring as the strings @true@ and @false@).
