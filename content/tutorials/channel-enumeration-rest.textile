...
Channel enumeration is part of the Channel Status API, and is currently only available via the "REST API":/rest-api. We provide a "REST client library":/rest to make it straightforward to access the REST API and you will be using the client library in this tutorial.
...
3. See "other tutorials":/tutorials to learn more about "Ably's features":/features.
