...
In your `ably-anthropic-agent` directory, create a new file called <If agentLang="javascript">`publisher.mjs`</If><If agentLang="python">`publisher.py`</If> with the following contents:
</If>
<If agentLang="java">
In your agent project, create a new file called `Publisher.java` with the following contents:
</If>
...
In your <If clientLang="javascript">`ably-anthropic-client`</If><If clientLang="java">client</If> project directory, create a new file called <If clientLang="javascript">`subscriber.mjs`</If><If clientLang="java">`Subscriber.java`</If> with the following contents:
</If>
<If clientLang="swift">
