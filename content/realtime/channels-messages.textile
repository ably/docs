...
h6(#publish-msg-array)[java]. public void publish(Message[] messages, CompletionListener listener)
...
h6(#subscribe)[java]. public void subscribe(MessageListener listener)
...
h6(#subscribe-event)[default]. subscribe(name, listener)

h6(#subscribe-event)[java]. public void subscribe(String name, MessageListener listener)
...
h6(#subscribe-event-array)[default]. subscribe(names, listener)

h6(#subscribe-event-array)[java]. public void subscribe(String[] names, MessageListener listener)
...
h6(#unsubscribe)[java]. public void unsubscribe(MessageListener listener)
...
h6(#unsubscribe-event)[default]. unsubscribe(name, listener)

h6(#unsubscribe-event)[java]. public void unsubscribe(String name, MessageListener listener)
