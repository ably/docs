...
describe('<HorizontalMenu />', () => {
  it('should render default styles correctly', () => {
    ...
    expect(screen.getByRole('menu')).toMatchInlineSnapshot(`
      <menu
        class="flex overflow-visible  md:overflow-x-auto m-0 border-b border-charcoal-grey relative p-0"
        role="menu"
      >
        children go here
      </menu>
  ...
  it('should render light menu', () => {
    ...
    expect(screen.getByRole('menu')).toMatchInlineSnapshot(`
      <menu
        class="flex overflow-visible  md:overflow-x-auto m-0 light"
        role="menu"
      >
        children go here
      </menu>
  ...
  it('should render end menu', () => {
    ...
    expect(screen.getByRole('menu')).toMatchInlineSnapshot(`
      <menu
        class="flex overflow-visible  md:overflow-x-auto m-0 end"
        role="menu"
      >
        children go here
      </menu>
