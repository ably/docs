...
intro: "Outbound webhooks trigger serverless functions and notify HTTP endpoints when messages, presence events, or channel changes occur in Ably. Data can be delivered individually or in batches to external services for processing."
