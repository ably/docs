...
"@Channels@":/realtime/channels#channels-object is a reference to the "@Channel@":/realtime/channels/overview collection instance for this library indexed by the channel name. You can use the "@Get@":/realtime/channels#get method of this to get a @Channel@ instance. See "channels":/realtime/channels/overview and "messages":/realtime/messages/ for more information.
