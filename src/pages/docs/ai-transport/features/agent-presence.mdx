...
## Combine presence with active turns <a id="combining-with-active-turns"/>
...
### What is the difference between presence and `useActiveTurns`? <a id="faq-vs-active-turns"/>
