...
Integration limits relate to the rate and concurrency of "webhooks":/docs/general/webhooks, "queues":/docs/general/webhooks and "Firehose":/docs/general/firehose.
...
API request limits are the maximum number of "REST API":/docs/api/rest-api requests, "Control API":/account/control-api requests and "token requests":/auth/token that can be made to Ably.
