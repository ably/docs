...
intro: "Users can send reactions to the entire chat room to show their sentiment as to what is happening."
...
Using room reactions, users can agree with the content in a livestream using a thumbs up, or send a heart when their team scores in a sports game.
