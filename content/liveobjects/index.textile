...
LiveObjects provides a global, durable, and conflict-free shared data layer built on Ably's "global network":/docs/platform/architecture, so your application state stays perfectly synchronized in realtime without the need to build or manage complex infrastructure yourself.
