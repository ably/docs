...
Clients should be configured with an @authCallback@ or @authUrl@, which the Ably client SDK will use to either generate a new token or renew an expired token, as required.
