...
* If you wish to migrate from PubNub/Pusher to Ably, you can use the relevant "protocol adapter":/adapters to "easily":https://support.ably.com/solution/articles/3000054127-can-you-help-ease-the-pain-of-migration-from-another-realtime-service switch to Ably right away and gradually migrate to using native Ably client SDKs.
