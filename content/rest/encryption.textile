---
title: Encryption
meta_description: "Ably client libraries support built-in symmetric encryption of message content, making it easier to build apps that encrypt content fully end-to-end."
meta_keywords: "Encryption, TLS."
section: rest
index: 70
languages:
  - javascript
...
* See "Encryption API Reference - Realtime":/realtime/realtime-api-reference#encryption-api
* See "Encryption API Reference - REST":/rest/rest-api-reference#encryption-api
