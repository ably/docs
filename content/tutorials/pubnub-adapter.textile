...
# Consider gradually transitioning to the Ably client libraries, for platforms which have them. They will be faster and more efficient: faster because native Ably libraries can use "websockets as a transport":https://knowledge.ably.com/which-transports-are-supported (Pubnub can only do "long polling":https://ably.com/topic/long-polling), and more efficient because using native Ably libraries avoids the overhead of protocol translation.
