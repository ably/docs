...
- channel := name of the channel on which the Ably @message@ was published
...
- timestamp := the time in milliseconds between the epoch and the message being received by Ably
