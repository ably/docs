...
The number of rules is the maximum number of integration rules, such as those for "Webhooks":/general/events#configure and "Zapier":/general/events/zapier that can be created per account.
