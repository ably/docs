...
If @[meta]@ is not specified in the permissions, you are unable to access the metachannels. An example of this is shown in the following code:
...
Although the previous example provides all capabilities in all regular channels, without a @[meta]@ permission being explicitly specified you are unable to perform any actions on a @[meta]@ channel.
