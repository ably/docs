---
title: History
intro: "Message history enables retrieval of previously published messages with time-based filtering and pagination. This feature supports message replay, audit trails, and catching up on missed activity."
meta_description: "Ably message history: retrieve previously published messages with time-based filtering, pagination for replay, auditing, and catch-up functionality."
redirect_from:
  - /docs/rest/history
