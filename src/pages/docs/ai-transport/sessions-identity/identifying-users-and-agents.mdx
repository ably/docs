...
{/* Swift example test harness (Vapor + JWT)
ID: identifying-users-and-agents-1
To verify: create a Swift package with Vapor and JWT dependencies (see below), paste the example code, run `swift build`
...
ID: identifying-users-and-agents-2
...
{/* Swift example test harness
ID: identifying-users-and-agents-3
To verify: copy this comment into a Swift file, paste the example code into the function body, run `swift build`
...
{/* Swift example test harness (Vapor + JWT)
ID: identifying-users-and-agents-4
To verify: create a Swift package with Vapor and JWT dependencies (see below), paste the example code, run `swift build`
...
{/* Swift example test harness
ID: identifying-users-and-agents-5
To verify: copy this comment into a Swift file, paste the example code into the function body, run `swift build`

func example(ably: ARTRealtime) {
    // --- example code starts here ---
*/}
```swift
// Client code
...
{/* Swift example test harness
ID: identifying-users-and-agents-6
To verify: copy this comment into a Swift file, paste the example code into the function body, run `swift build`
...
{/* Swift example test harness (Vapor + JWT)
ID: identifying-users-and-agents-7
To verify: create a Swift package with Vapor and JWT dependencies (see below), paste the example code, run `swift build`
...
{/* Swift example test harness
ID: identifying-users-and-agents-8
To verify: copy this comment into a Swift file, paste the example code into the function body, run `swift build`
...
{/* Swift example test harness
ID: identifying-users-and-agents-9
To verify: copy this comment into a Swift file, paste the example code into the function body, run `swift build`
...
{/* Swift example test harness
ID: identifying-users-and-agents-10
To verify: copy this comment into a Swift file, paste the example code into the function body, run `swift build`
...
{/* Swift example test harness
ID: identifying-users-and-agents-11
To verify: copy this comment into a Swift file, paste the example code into the function body, run `swift build`
...
{/* Swift example test harness (Vapor + JWT)
ID: identifying-users-and-agents-12
To verify: create a Swift package with Vapor and JWT dependencies (see below), paste the example code, run `swift build`
...
{/* Swift example test harness
ID: identifying-users-and-agents-13
To verify: copy this comment into a Swift file, paste the example code into the function body, run `swift build`
...
channel.subscribe("prompt") { message in
    // Access the user's role from the user claim in message extras
    let role = (try? message.extras?.toJSON())?["userClaim"]

    print("Message from user with role: \(String(describing: role))")
}
```
{/* --- end example code --- */}
</Code>
...
{/* Swift example test harness
ID: identifying-users-and-agents-14
To verify: copy this comment into a Swift file, paste the example code into the function body, run `swift build`
...
{/* Swift example test harness
ID: identifying-users-and-agents-15
To verify: copy this comment into a Swift file, paste the example code into the function body, run `swift build`
...
channel.subscribe { message in
    if message.clientId == "weather-agent" {
        let model = ((try? message.extras?.toJSON())?["headers"] as? [String: Any])?["model"]
        print("Response from weather agent using \(String(describing: model)):", message.data as Any)
    }
}
```
{/* --- end example code --- */}
