...
1. Enumerate API - returns a list of objects in [some order]. Can be paginated.
2. Traverse API - returns the objects state in tree format.
3. Compact API - returns the object state in a compact tree format.
