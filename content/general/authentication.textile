...
| Users need to indentify themselves | <div style="text-align: center;"><img src="/images/table-images/exclamation.png"></div>  | <div style="text-align: center;"><img src="/images/table-images/tick.svg"></div> | If the user can be trusted to identify itself, Basic Authentication is fine. If the user cannot be trusted however, Token Authentication is better as it allows for a trusted token distributor to identify the user instead. |
