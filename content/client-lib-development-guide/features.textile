...
** @(RSA17d)@ If the @targets@ parameter is null or empty, then the function must respond with an error containing @"targets cannot be null or empty"@ message.
** @(RSA17e)@ Optional for languages that cannot enforce nullability in compile time: If any @TokenRevocationTarget@ in @targets@ parameter is invalid that is it either does not contain 'type' or 'value' or both, the function must respond with @"Invalid RevocationTarget in targets array"@ message.
