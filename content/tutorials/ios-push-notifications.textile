...
Now that we have the P12 certificate ready to be used, let's get set up with an Ably account. If you are not already signed up, you should "sign up now for a free Ably account":https://www.ably.io/signup. Once you have an Ably account, log into your Ably account, go to your "Apps Dashboard":https://knowledge.ably.com/how-do-i-access-my-app-dashboard-1 and choose an existing app or create a new one as shown below:
...
The last thing to do in the setup stage is to enable the Push Notifications option for an Ably channel or namespace that you'll use in your app. In you app's dashboard, head to the "Settings" tab and add a new channel rule or edit an existing one as shown below. You can "learn more about channel namespaces from our support articles":https://knowledge.ably.com/what-is-a-channel-namespace-and-how-can-i-use-them-1.
