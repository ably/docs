...
Webhooks are configured from the Reactor tab in your "app dashboard":https://knowledge.ably.com/how-do-i-access-my-app-dashboard. The following fields are shared between each webhook:
