...
intro: "Message annotations append metadata to existing channel messages for features like reactions, categorization, and moderation flags. This system enables interactive message enhancements without altering original message content."
meta_description: "Ably message annotations: append metadata to channel messages for reactions, categorization, and moderation flags without altering original content."
---
