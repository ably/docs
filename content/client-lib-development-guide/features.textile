...
* @(TL3)@ @TokenRevocationTarget#value is the value of specified for target key.
...
* @(TX2)@ @TokenRevocationResponse#revocations@ is a collection of @TokenRevocationDetail@s representing the result of the token revocation request.

h4. TokenRevocationDetail
* @(TY1)@ @TokenRevocationDetails@ is an object representing a single token revocation result.
* @(TY2)@ @TokenRevocationDetails#target@ is a @TokenRevocationTarget@ representing the target of the token revocation.
* @(TY3)@ @TokenRevocationDetails#issuedBefore@ is a timestamp (in milliseconds since the epoch) representing the time the token was issued.
* @(TY4)@ @TokenRevocationDetails#appliesAt@ is a timestamp (in milliseconds since the epoch) representing the time the revocation takes effect.
