...
- <div lang="go">Action</div> := the event signified by a PresenceMessage. See "@PresenceMessage::action@":/api/realtime-sdk/types#presence-action<br>__Type: @const PresenceMessage::PresenceAbsent,PresencePresent,PresenceEnter,PresenceLeave,PresenceUpdate@__
