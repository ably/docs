...
```[objc]
[channel.presence get:^(NSArray<ARTPresenceMessage *> *members, NSError *error) {
...
[channel.presence history:query callback:^(ARTPaginatedResult<ARTPresenceMessage *> *resultPage, NSError *error) {
...
bq(definition#enter-none).
  ...
  objc,swift: enter(data: nil, cb: ((ARTErrorInfo?) -> Void)?)
...
bq(definition#enter-data).
  ...
  objc,swift: enter(data: AnyObject?, cb: ((ARTErrorInfo?) -> Void)?)

Enter a presence channel and provide data that is associated with the current present member.

h4. Parameters

- <div lang="jsall">data</div> := data payload for the current present member. The supported payload types are Strings, JSON objects and arrays, buffers containing arbitrary binary data, and null.<br>__Type: Object__
- <div lang="java">data</div> := data payload for the current present member. The supported payload types are Strings, JsonObject, binary data as byte arrays, and null.<br>__Type: Object__
- <div lang="ruby">data</div> := data payload for the current present member. The supported payload types are Strings, Hash or Array objects that can be serialised to JSON using @to_json@, binary data as @ASCII-8BIT@ byte arrays, and null.<br>__Type: Object__
- <div lang="objc,swift">data</div> := data payload for the message. The supported payload types are <span lang="objc">@NS@</span>@String@, <span lang="objc">@NS@</span>@Dictionary@ or <span lang="objc">@NS@</span>@Array@ objects that can be serialised to JSON, binary data as @NSData@, and @nil@.<br>__Type: Object__
...
bq(definition#leave-none).
  ...
  swift,objc: leave(data: nil, cb: ((ARTErrorInfo?) -> Void)?)
...
bq(definition#leave-data).
  ...
  swift,objc: leave(data: AnyObject?, cb: ((ARTErrorInfo?) -> Void)?)
...
bq(definition#update-data).
  ...
  swift,objc: update(data: AnyObject?, cb: ((ARTErrorInfo?) -> Void)?)
...
h4. <span lang="default">@options@ parameters</span><span lang="objc,swift">@ARTRealtimePresenceQuery@ properties</span>
...
bq(definition).
  ...
  objc,swift: history(query: ARTRealtimeHistoryQuery?, callback: ("ARTPaginatedResult":#paginated-result<"ARTPresenceMessage":#presence-message>?, NSError?) -> Void) throws
...
bq(definition#subscribe-listener).
  ...
  objc,swift: subscribe(cb: ("ARTPresenceMessage":#presence-message) -> Void) -> ARTEventListener
...
bq(definition#subscribe-event).
  ...
  objc,swift: subscribe(action: ARTPresenceAction, cb: ("ARTPresenceMessage":#presence-message) -> Void) -> ARTEventListener
...
bq(definition#enter-client-none).
  ...
  objc,swift: enterClient(clientId: String, data: nil, cb: ((ARTErrorInfo?) -> Void)?)
...
bq(definition#enter-client-data).
  ...
  objc,swift: enterClient(clientId: String, data: AnyObject?, cb: ((ARTErrorInfo?) -> Void)?)

Enter a presence channel and provide data that is associated with the current present member.

h4. Parameters

- <div lang="jsall">data</div> := data payload for the member. The supported payload types are Strings, JSON objects and arrays, buffers containing arbitrary binary data, and null.<br>__Type: Object__
- <div lang="java">data</div> := data payload for the member. The supported payload types are Strings, JsonObject, binary data as byte arrays, and null.<br>__Type: Object__
- <div lang="ruby">data</div> := data payload for the member. The supported payload types are Strings, Hash or Array objects that can be serialised to JSON using @to_json@, binary data as @ASCII-8BIT@ byte arrays, and null.<br>__Type: Object__
- <div lang="objc,swift">data</div> := data payload for the message. The supported payload types are <span lang="objc">@NS@</span>@String@, <span lang="objc">@NS@</span>@Dictionary@ or <span lang="objc">@NS@</span>@Array@ objects that can be serialised to JSON, binary data as @NSData@, and @nil@.<br>__Type: Object__
...
bq(definition#leave-client-none).
  ...
  swift,objc: leaveClient(clientId: String, data: nil, cb: ((ARTErrorInfo?) -> Void)?)
...
bq(definition#leave-client-data).
  ...
  swift,objc: leave(clientId: String, data: AnyObject?, cb: ((ARTErrorInfo?) -> Void)?)
...
bq(definition#update-client-data).
  ...
  swift,objc: update(clientId: String, data: AnyObject?, cb: ((ARTErrorInfo?) -> Void)?)
