...
intro: "Control which integration rules execute when publishing messages to prevent infinite loops and unnecessary processing. Privileged users can selectively skip specific rules or disable all integrations for targeted messages."
