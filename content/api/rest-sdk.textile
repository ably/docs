...
A reference to the "<span lang="default">@LocalDevice@</span><span lang="objc,swift">@ARTLocalDevice@</span>":/docs/push/device object.
</div>
...
bq(definition).
  ...
  jsall:      stats(params?): Promise<"PaginatedResult":/docs/api/realtime-sdk/types#paginated-result<"Stats":docs/api/rest-sdk/types#stats>>
