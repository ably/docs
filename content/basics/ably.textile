...
For long term storage, you can use an Ably "integration":/docs/general/webhooks to send all, or a subset of messages to your own database or data warehouse.
