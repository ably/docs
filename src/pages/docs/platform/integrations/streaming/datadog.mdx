...
intro: "Monitor your application performance by streaming comprehensive Ably statistics directly to Datadog dashboards and alerts. Track messages, connections, and channel activity in Realtime with automated OAuth authentication and customizable metrics collection."
