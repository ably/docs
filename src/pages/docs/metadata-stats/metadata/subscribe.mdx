...
intro: "Metadata subscriptions deliver realtime updates through metachannels about connections, channels, and API requests. These enable monitoring app activity and implementing reactive behaviors."
