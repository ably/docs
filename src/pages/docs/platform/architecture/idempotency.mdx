---
title: Idempotency
intro: "Ably ensures exactly once message delivery through idempotent publishing that prevents duplicate messages even during network failures and retries. Ably's platform combines unique message identification with cross region coordination to guarantee precise message processing."
