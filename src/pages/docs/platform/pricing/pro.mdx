---
title: Pro package
intro: "Accommodate rapid business growth with higher throughput limits and enhanced support for demanding Realtime applications. The Pro package delivers 10,000 messages per second with 50,000 concurrent connections and priority technical support."
...
Pro package support includes access to Ably support via email with a Service Level Agreement (SLA) of less than 1 business day for general guidance and less than 4 business hours for system impediments or system down.
