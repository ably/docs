---
title: SSE
intro: Ably SSE enables Realtime streaming for browsers that support Server-Sent Events without needing a full SDK. This lightweight HTTP streaming protocol is perfect for subscribe-only use cases where minimal resources are essential.
