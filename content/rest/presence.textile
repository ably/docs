...
h4. <span lang="default">@options@ parameters</span><span lang="objc,swift">@ARTPresenceQuery@ properties</span><span lang="csharp">Parameters</span>
...
bq(definition).
  ...
  csharp:  Task<"PaginatedResult":#paginated-result<"PresenceMessage":#presence-message>> HistoryAsync("DataRequestQuery":"/rest/types#data-request" query);
