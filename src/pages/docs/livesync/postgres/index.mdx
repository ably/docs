...
In catastrophic datacenter failures, Ably automatically reroutes all traffic in under 2 minutes, maintaining service continuity. [See evidence here 🕵️](/docs/platform/architecture/edge-network#dns-organization-and-latency-based-routing)
</Aside>
