...
Ably provides direct integrations between your chat room and various moderation providers, to give you access to powerful moderation platforms with minimal code and setup. If a provider you are looking for is not listed, please get in touch!

Alternatively, you might have a custom solution you wish to integrate with, or a provider that Ably doesn't yet directly support. If this is the case, Ably offers a "Bring Your Own" option, where you can utilise serverless functions such as AWS Lambda or other transports to reach out to your own infrastructure to moderate chat messages. Again, if a transport you're looking for isn't available, please get in touch.
