...
bq(definition).
  ...
  csharp:  public Task<"PaginatedResult":/realtime/types#paginated-result<"Stats":/realtime/types#stats>> StatsAsync(StatsDataRequestQuery query)
...
bq(definition).
  ...
  csharp: public Task<DateTimeOffset> TimeAsync()
