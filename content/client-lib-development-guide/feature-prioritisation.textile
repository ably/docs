...
Whilst all "officially supported Ably client libraries":https://www.ably.io/download support all features defined in the "specification":https://github.com/ably/ably-ruby/blob/main/SPEC.md, we recommend an approach that focuses on the most commonly used features first.
...
* Simple realtime connection over "WebSockets":https://www.ably.io/topic/websockets with JSON & MessagePack support - see "#initialization, #connect and #close within connection spec":https://github.com/ably/ably-ruby/blob/main/SPEC.md#ablyrealtimeconnection and "ProtocolMessage object spec":https://github.com/ably/ably-ruby/blob/main/SPEC.md#ablymodelsprotocolmessage
