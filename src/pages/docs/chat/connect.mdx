...
Ably's SDKs automatically resolve edge network failures within 30 seconds, keeping your users connected even during infrastructure issues. [Learn about Ably's edge network](/docs/platform/architecture/edge-network).
</Aside>
