...
* Push notification statistics are currently disabled. Therefore, you are not currently charged for push notifications and and the push notification stats in your "app dashboard":https://knowledge.ably.com/how-do-i-access-my-app-dashboard-1 will be zero. Please note that each push notification, when stats are enabled, will "count as one message from a billing perspective":https://knowledge.ably.com/how-does-ably-count-messages-1. We plan to enable push statistics soon, "get in touch":https://www.ably.io/contact if you need statistics now.
