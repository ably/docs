...
meta_description: "Details on the deprecation of Ably's realtime protocol version 1 and migration to protocol version 2."
meta_keywords: "Ably, deprecation policy, deprecation, sunset"
---

SDKs using version 1 of Ably's realtime protocol were sunset on 1st November 2025.
...
## Affected SDKs <a id="sdks"/>

SDK versions earlier than those listed below are now considered deprecated. If you are using a version older than those listed, upgrade to a supported SDK version.
