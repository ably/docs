...
The codec is documented in detail on the [transport](/docs/ai-transport/concepts/transport#codec) page and in the [codec API reference](/docs/ai-transport/api-reference/codec).
