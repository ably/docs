...
As part of "Events":/general/events, it is possible to integrate with various systems via webhooks.
...
For more details on the specifics of how Events and our integrations work, check out our "Events documentation":/general/events.
