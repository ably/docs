---
title: Operations
intro: "Operations define atomic changes to LiveObjects that propagate across all subscribed clients through channel messages. These update primitives ensure consistent state modifications while maintaining synchronization guarantees across distributed applications."
meta_description: "Ably LiveObjects operations: atomic changes propagating across clients via channel messages with consistent state modification guarantees."
---
