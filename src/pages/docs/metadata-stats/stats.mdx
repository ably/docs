---
title: Statistics
intro: "Statistics provide usage metrics for monitoring messages, connections, channels, and API requests. Data is aggregated by minute, hour, day, and month for analysis and billing transparency."
