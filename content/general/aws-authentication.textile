...
When adding an Integration rule for an AWS endpoint such as for an "AWS Lambda function rule":/docs/general/webhooks/aws-lambda/, or a "Firehose rule":/docs/general/firehose/ for AWS Kinesis or AWS SQS, there are two AWS authentication methods that can be used with Ably:
...
* "Firehose":/docs/general/firehose
