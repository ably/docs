...
Ably Integrations are powered by a rules engine that enables realtime data to be streamed into our "Ably Queue service":/docs/general/queues or any third party queue, streaming provider or endpoint.
...
* **Message queues** allow you to distribute the message processing work between your servers to enable horizontal scaling and reliability for applications that need to respond to realtime data as it happens. "Find out more":/docs/general/queues
