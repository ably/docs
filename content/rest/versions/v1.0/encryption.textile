...
On success, the method returns a complete "@CipherParams@":#cipher-params object. Failure will raise an <span lang="php,ruby,java,python">"@AblyException@":/api/rest-sdk/types/#ably-exception </span><span lang="default">exception</span>.
...
bq(definition).
  default: Crypto.generateRandomKey(Int keyLength?, callback("ErrorInfo":/api/rest-sdk/types#error-info err, @Buffer@ key))
...
blang[java,ruby,objc,swift,php,python,csharp].
  ...
  On success, the method returns the generated key as a <span lang="java">@byte[]@ array</span><span lang="python">@bytes@</span><span lang="ruby">byte array</span><span lang="php">binary string</span><span lang="objc,swift">@NSData@</span>. Failure will raise an "@AblyException@":/api/rest-sdk/types/#ably-exception .
