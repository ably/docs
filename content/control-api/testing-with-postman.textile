...
You can also use the command-line tool "Curl":https://curl.se/ to test out the Control API. Some examples of using Curl are provided "here":/control-api/curl-examples.
