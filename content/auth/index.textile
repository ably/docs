...
h2. API keys in code samples

Note, that in code samples provided here, basic authentication is sometimes used for convenience. It should be stressed that in your own applications, you should never use basic authentication on the client-side, as it exposes your key.

If you are logged into your Ably account, the code samples will be populated with your actual key for convenience, otherwise, if you are not logged into Ably, a temporary key is generated for you.
...
If you would like to step through some examples, then take a look at our tutorials:
