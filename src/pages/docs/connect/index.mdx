...
Ably automatically recovers connections and prevents message loss or duplication when clients reconnect within two minutes, ensuring [exactly-once delivery](/docs/platform/architecture/idempotency#connection-recovery-and-exactly-once-delivery) during recovery.
</Aside>
...
Ably's SDKs automatically resolve [edge network failures](/docs/platform/architecture/edge-network) within 30 seconds, keeping your users connected even during infrastructure issues.
</Aside>
