...
blang[javascript,nodeejs].
  ...
  In this step, you will subscribe to receive presence events from "chatroom" channel. Events include when new members enter the channel, or existing ones leave the channel or update their data.

  Presence messages will include the @client ID@ of the member, and an @action@ that tells you what happened to that member: either @enter@, @update@, or @leave@.
...
And that's it. To see Presence in action, try out the live demo below.
