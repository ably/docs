...
Before we get started, you will need an "Ably API key":https://knowledge.ably.com/setting-up-and-managing-api-keys to authenticate with Ably. If you are not already signed up, you should "sign up now for a free Ably account":https://www.ably.io/signup. Once you have an Ably account:
