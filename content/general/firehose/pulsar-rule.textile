...
See some examples of creating rules in the "rules section":/control-api/curl-examples#examples-rules of the Control API documentation. You can also refer to the "rules section":/api/control-api#tag/rules/paths/~1apps~1{app_id}~1rules/post of the Control API Reference for information on creating a Pulsar rule. You will need to select a @ruleType@ of @pulsar@.
