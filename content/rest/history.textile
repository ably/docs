...
- <span lang="ruby">:</span>start := _beginning of time_ earliest <span lang="ruby">@Time@ or </span>millisecond since epoch time for any message retrieved<br>__Type: Long<span lang="ruby">, Time</span>__
- <span lang="ruby">:</span>end := _current time_ latest <span lang="ruby">@Time@ or </span>millisecond since epoch time for any messages retrieved<br>__Type: Long<span lang="ruby">, Time</span>__
...
- <span lang="default">option</span><span lang="java">"Param":#param[] option</span> := <span lang="default">an optional object containing the query parameters</span><span lang="ruby">an optional set of key value pairs containing the query parameters</span>, as specified below.
...
- <span lang="ruby">:</span>start := _beginning of time_ earliest <span lang="ruby">@Time@ or </span>millisecond since epoch time for any presence event retrieved<br>__Type: Long<span lang="ruby">, Time</span>__
- <span lang="ruby">:</span>end := _current time_ latest <span lang="ruby">@Time@ or </span>millisecond since epoch time for any presence events retrieved<br>__Type: Long<span lang="ruby">, Time</span>__
- <span lang="ruby">:</span>direction := _backwards_ <span lang="ruby">@:@</span>@forwards@ or <span lang="ruby">@:@</span>@backwards@<br>__Type: <span lang="default">String</span><span lang="ruby">Symbol</span>__
- <span lang="ruby">:</span>limit := _100_ maximum number of presence event messages to retrieve up to 1,000<br>__Type: Integer__
