---
title: Ably Queues
intro: "Enable asynchronous processing of Realtime messages through traditional message queuing with guaranteed delivery. Scale horizontally by adding consumers that process messages independently with automatic failover and backlog management."
