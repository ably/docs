...
```[javascript]
const room = await chatClient.rooms.get('basketball-stream', DefaultRoomOptions);
```

```[react]
import * as Ably from 'ably';
import { ChatClientProvider, ChatRoomProvider, LogLevel, DefaultRoomOptions } from '@ably/chat';
...
blang[javascript].
  You can also use the @DefaultRoomOptions@ property for each @RoomOption@ to configure whether the default settings should be used:

  ```[javascript]
  const room = await chatClient.rooms.get('basketball-stream', {presence: DefaultRoomOptions.presence});
  ```
...
blang[javascript].
  ...
  | "Presence":/chat/rooms/presence | @presence@ | @DefaultRoomOptions.presence@ |
  | "Occupancy":/chat/rooms/occupancy | @occupancy@ | @DefaultRoomOptions.occupancy@ |
  | "Typing indicators":/chat/rooms/typing | @typing@ | @DefaultRoomOptions.typing@ |
  | "Room reactions":/chat/rooms/reactions | @reactions@ | @DefaultRoomOptions.reactions@ |
