...
This will return a "ChannelDetails":/realtime/channel-lifecycle#channel-details object.
...
- by := _value_ optionally specifies whether to return just channel names (@by=id@) or "ChannelDetails":realtime/channel-lifecycle#channel-details (@by=value@)
