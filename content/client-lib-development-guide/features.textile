...
h4. RevokedToken
* @(TY1)@ @RevokedToken@ is an object representing a single token revocation result.
* @(TY2)@ @RevokedToken#target@ is a @TokenRevocationTarget@ representing the target of the token revocation.
* @(TY3)@ @RevokedToken#issuedBefore@ is a timestamp (in milliseconds since the epoch) representing the time the token was issued.
* @(TY4)@ @RevokedToken#appliesAt@ is a timestamp (in milliseconds since the epoch) representing the time the revocation takes effect.
