...
Encryption is supported for the @data@ attribute (payload) of "published messages":/api/realtime-sdk/types#messages and "presence member messages":/api/realtime-sdk/types#presence-message on a channel, over both REST and Realtime publish operations. Decryption is supported in Realtime "message":/realtime/messages and "presence message":/realtime/presence subscriptions and in REST and "Realtime history":/storage-history/history operations.
