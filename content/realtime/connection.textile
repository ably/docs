...
<div lang="jsall">
bq(definition). on(String[] states, listener("ConnectionStateChange":#connection-state-change stateChange))
...
- <div lang="jsall">state(s)</div> := the connection state(s) to subscribe to<br>__Type: @String@ or @String[]@__
...
Removes the given listener from all "ConnectionState":#connection-state states in the array.

bq(definition). off(String state)

Removes all listeners for a given "ConnectionState":#connection-state state.

bq(definition). off(String[] states)

Removes all listeners for all "ConnectionState":#connection-state states in the array.
...
- <div lang="jsall">state(s)</div> := the connection state(s) to unsubscribe from<br>__Type: @String@ or @String[]@__
