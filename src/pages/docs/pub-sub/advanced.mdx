...
<Aside data-type='note'>
The Chat SDK publishes messages via REST. The Chat SDK handles message publishing internally, so you do not need to manage idempotency keys for Chat messages.
</Aside>
