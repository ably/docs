...
Rate limits can be scoped to individual channels or to namespaces of channels, see our "namespaces documentation":/general/channel-rules-namespaces/ for more information. The rate limit with the most specific scope will be applied to the user. 
