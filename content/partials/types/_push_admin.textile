...
bq(definition).
  ...
  jsall:        publish(Object recipient, Object payload): Promise<void>
...
- <span lang="default">data</span><span lang="jsall">payload</span> := <span lang="default">an object</span><span lang="php">an array</span><span lang="ruby">a Hash</span> containing the push notification data. See the "push admin payload structure":/docs/push/publish#payload for details on the supported push payload fields
...
- <span lang="default">device</span><span lang="jsall">deviceDetails</span> := a "@DeviceDetails@":#device-details object containing at a minimum the @deviceId@ of the requested device
...
- <span lang="default">device</span><span lang="jsall">deviceDetails</span> := a "@DeviceDetails@":#device-details object
...
bq(definition#device-remove-id).
  ...
  jsall:        remove(String deviceId): Promise<void>
...
bq(definition#device-remove-device).
  ...
  jsall:        remove("DeviceDetails":#device-details deviceDetails): Promise<void>
...
- <span lang="default">device</span><span lang="jsall">deviceDetails</span> := a "@DeviceDetails@":#device-details object containing at a minimum the @deviceId@ of the device
...
bq(definition).
  ...
  jsall:        removeWhere(Object params): Promise<void>
...
bq(definition).
  ...
  jsall:        listChannels(Object params): Promise<"PaginatedResult":#paginated-result<String>>
...
- <span lang="default">channelSubscription</span><span lang="jsall">subscription</span><span lang="ruby,python">channel_subscription</span> := a "@PushChannelSubscription@":#push-channel-subscription object
...
bq(definition).
  ...
  jsall:        remove("PushChannelSubscription":#push-channel-subscription subscription): Promise<void>
