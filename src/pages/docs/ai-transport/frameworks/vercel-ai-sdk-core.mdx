...
- [Server transport API reference](/docs/ai-transport/api/javascript/server-transport): the full API surface for the server transport.
- [Codec API reference](/docs/ai-transport/api/javascript/codec): the codec interface that `UIMessageCodec` implements.
