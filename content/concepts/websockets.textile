...
WebSockets have been generally available only since a few years. Before they came along, we had still been able to build robust, essentially "real-time" applications for a while, but it was a lot more painful to do so, and more so the further back in time we look.
...
Find out more on "Ably's website":https://ably.io.
