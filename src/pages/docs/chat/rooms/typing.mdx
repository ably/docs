...
<If lang="javascript">
Use the [`typing.currentTypers`](/docs/chat/api/javascript/typing#properties) property to retrieve the users that are currently typing in the room:
</If>
