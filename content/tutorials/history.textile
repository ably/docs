...
1. If you would like to find out more about how to use the history API from your devices and apps, see the "Realtime history documentation":https://ably.com/docs/storage-history/storage. Typically on servers customers prefer to use the "REST history API":https://ably.com/docs/rest/history
