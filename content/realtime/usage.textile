...
- params := an optional object containing the query parameters, as specified in the "stats":/rest-client-library/stats API documentation.
...
Further details of the paginated response are in the "stats API":/rest-client-library/statistics documentation.
</div>
