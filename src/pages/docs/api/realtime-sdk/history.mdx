---
title: History
intro: "Retrieve previously published messages and presence events from channel storage using time-based queries. The History API enables message replay, backfill scenarios, historical data analysis, and filtered retrieval."
