...
API references generated from the source code are available for the realtime and REST client library SDKs. They have been generated for each SDK using tooling common to that language, such as "Jazzy":https://github.com/realm/jazzy for Swift and Objective-C.
