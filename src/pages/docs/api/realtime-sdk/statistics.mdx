...
|-----------|-------------|------|
| <If lang="csharp">query</If><If lang="java">options</If> | An optional object containing the query parameters | <If lang="csharp">[`StatsRequestParams`](#stats-request-params)</If><If lang="java">[`Param[]`](#param)</If> |
...
#### <If lang="objc,swift">`ARTStatsQuery` properties</If><If lang="csharp">`StatsRequestParams` properties</If><If lang="ruby,java">`options` parameters</If>
...
### <If lang="objc,swift">ARTStats <a id="stats-type" /></If><If lang="java">io.ably.lib.types.Stats <a id="stats-type" /></If><If lang="ruby">Ably::Models::Stats <a id="stats-type" /></If><If lang="csharp">IO.Ably.Stats <a id="stats-type" /></If>
...
#### <If lang="java">Members</If><If lang="ruby">Attributes</If><If lang="objc,swift,csharp">Properties</If>
...
### <If lang="objc,swift">ARTStatsGranularity <a id="stats-granularity" /></If><If lang="csharp">StatsIntervalGranularity <a id="stats-granularity" /></If>
