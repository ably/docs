...
<If lang="javascript,swift,kotlin">
Use the <If lang="javascript">[`typing.current()`](https://sdk.ably.com/builds/ably/ably-chat-js/main/typedoc/interfaces/chat-js.Typing.html#current)</If><If lang="swift">[`typing.current`](https://sdk.ably.com/builds/ably/ably-chat-swift/main/AblyChat/documentation/ablychat/typing/current)</If><If lang="kotlin">[`typing.current`](https://sdk.ably.com/builds/ably/ably-chat-kotlin/main/dokka/chat/com.ably.chat/-typing/current.html)</If> method to retrieve a set of `clientId`s for all users that are currently typing in the room:
</If>
