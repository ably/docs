...
An "Ably API key":/auth/api-key can have single set of permissions, applied to any number of channels or "queues":/general/queues. To create a key with certain permissions, simply go to create a new API key and "select the desired capabilities":/auth/api-key.
...
<!-- TODO: Add a new screenshot here of capabilities for a key -->
