...
The "@subscribe()@":/realtime/channels#subscribe method lets you subscribe to the channel to receive realtime updates. After you've done that, Ably will automatically push updates over a duplex connection that will remain open while the application is running. You can "learn more about how WebSockets work":https://www.ably.io/topics/websockets from our in-depth explanatory article.
