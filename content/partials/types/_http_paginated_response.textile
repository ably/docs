...
- <span lang="default">errorCode</span><span lang="ruby">error_code</span><span lang="csharp,go">ErrorCode</span> := the error code if the @X-Ably-Errorcode@ HTTP header is sent in the response<br>__Type: <span lang="default">@Int@</span><span lang="jsall">@Number@</span>__
