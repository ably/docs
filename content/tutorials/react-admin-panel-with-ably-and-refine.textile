...
refine is a react-based framework for building data-intensive applications such as admin panels and dashboards. It comes with built-in features for routing, authentication, and i18n. It supports most popular UI frameworks, design systems, and cloud-based platforms like Firebase, Supabase, and "Ably":https://ably.com.

"Ably":https://ably.com/ is a cloud-based platform that can help you provide reliable, low-latency realtime experience. It has realtime data streaming capabilities like chat, data broadcast, notifications, and more.
...
Ably is a platform that provides realtime solutions using web socket connections to distribute realtime data. It removes the burden of running and maintaining infrastructure and its associated challenges. It can save you considerable time and money.

With Ably’s distributed network of data centers, you can provide a low-latency synchronized realtime experience. The Ably ecosystem has client SDKs for the browser, Node, React Native, and several other platforms to improve the development experience.

It is worth pointing out that the refine ecosystem has a package for integrating Ably into your refine project. The refine Ably package internally uses the Ably realtime JavaScript client library.
...
h3. We are ready for testion realtime feature on the app
...
<a href="/images/tutorials/ably-refine/img4.png" target="_blank">
  <img src="/images/tutorials/ably-refine/img4.png" style="width: 100%"
  title="Click to enlarge" alt="The realtime dashboard working">
</a>

This tutorial illustrates how you can build a basic CRUD app with realtime feature with refine and Ably. There is a lot you can do with refine and Ably that I have not highlighted in this article. Check out the "refine":https://refine.dev/docs/ or "Ably":https://www.ably.com/docs documentation.

h2. Conclusion

As explained above, you need considerable resources to build a complete data-intensive realtime platform from the ground up. However, you can also quickly bootstrap a complete realtime application with React frameworks such as refine and cloud-based platforms like Ably.

As highlighted above, refine is a feature-rich React-based framework. It is an excellent choice, especially when building data-intensive front-end applications. The refine ecosystem has features for integrating some cloud-based solutions, such as Ably, into your front-end application.

You can quickly build realtime solutions with refine and Ably’s distributed network of reliable, low-latency data centers. As highlighted above, getting started with refine and Ably is relatively straightforward.

Here you can find the source code of the Ably live provider example implementation. "https://github.com/refinedev/refine/tree/master/examples/live-provider-ably":https://github.com/refinedev/refine/tree/master/examples/live-provider-ably