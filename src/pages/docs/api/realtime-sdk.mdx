...
| Property | Description | Type |
|----------|-------------|------|
| <If lang="javascript,nodejs">items</If><If lang="csharp">Items</If> | Contains a page of results; for example, an array of [`Message`](#message) or [`PresenceMessage`](#presence-message) objects for a channel history request | `Array<>` |
