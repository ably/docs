@DataRequestQuery@ is a type that encapsulates the parameters for a history or stats query. The stats query uses @StatsDataRequestQuery@ which extends @DataRequestQuery@. For example usage see "@Channel#history@":/realtime/history#channel-history.
