...
"Ably's global platform":https://ably.com/platform organizes all of the message traffic within its applications into named "channels":https://ably.com/pub-sub-messaging. Channels are the "unit" of message distribution; clients attach to any number of channels to publish or subscribe to messages. Every message published to a channel is broadcast to all subscribers.
...
You can also see the "complete code for this tutorial":https://github.com/ably/tutorials/commit/inband-occupancy-javascript-complete-code.
