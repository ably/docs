# Message history - rewind with Pub/Sub

Rewind with history enables users to retrieve a set number of historical messages published to an application.
...
Rewind with history enables users to retrieve a set number of messages that have been previously published within an application. It enables provides users with context as to how the current state has been reached.
...
```sh
cd /examples/pub-sub-history-rewind/react/
```
