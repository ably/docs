...
|---|---|---|
| Space name | The full identifier for the collaborative space | Identify specific spaces and namespaces |
| Member count | Real-time number of members currently connected | Monitor activity patterns and detect issues |
| Inspect button | Eye icon for detailed space access | Access advanced monitoring and configuration |
...
| Space rules | Identification required, TLS required | Enforce security requirements |
...
|---|---|---|
| Client ID | Application-defined identifier (shows N/A if not set) | Identify members in your application logic |
...
| Message counter | Displays total message count | Show space activity volume |
