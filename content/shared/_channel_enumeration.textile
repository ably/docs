...
This will return a "ChannelDetails":/general/channel-lifecycle#channel-details object.
...
Client libraries do not currently provide a dedicated API to enumerate channels, but make this available using the "request":/rest/usage#request method. When using this, you can simply iterate through the "PaginatedResults":rest/types#paginated-result to enumerate through the results.
