...
blang[swift].
  ...
  2. Open @AblyAssetTracking.xcworkspace@ in Xcode. "This workspace includes both the SDKs and the example apps":https://github.com/ably/ably-asset-tracking-swift#package-structure.
  ...
  6. Select the @PublisherExample@ project, choose a target device, and then press the run button.

  <a href="/images/screenshots/asset-tracking/swift/run-publishing-example-app.png" target="_blank">
    <img src="/images/screenshots/asset-tracking/swift/run-publishing-example-app.png" style="width: 100%" alt="Run the publishing app">
  </a>

  The following screen displays:

  <a href="/images/screenshots/asset-tracking/swift/publisher-enter-tracking-id.png" target="_blank">
    <img src="/images/screenshots/asset-tracking/swift/publisher-enter-tracking-id.png" style="width: 50%" alt="Provide a tracking ID">
  </a>
  ...
  <a href="/images/screenshots/asset-tracking/swift/publisher-running.png" target="_blank">
    <img src="/images/screenshots/asset-tracking/swift/publisher-running.png" style="width: 50%" alt="Starting the Publisher Example app">
  </a>
  ...
  <a href="/images/screenshots/asset-tracking/swift/publisher-and-subscriber-apps-running.png" target="_blank">
    <img src="/images/screenshots/asset-tracking/swift/publisher-and-subscriber-apps-running.png" style="width: 100%" alt="Publisher and subscriber apps running together">
  </a>
