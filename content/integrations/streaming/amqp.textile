...
Use Ably's "Firehose":/docs/integrations/continuous-streaming/firehose#firehose-rules AMQP rule to send "data":/docs/integrations/continuous-streaming/firehoset#data-sources such as messages, occupancy, lifecycle and presence events from Ably to AMQP.
