...
Idempotency ensures that multiple publishes of the same message cannot result in duplicates messages. "Find out more about how what idempotency is, and how we provide idempotency in our REST operations.":https://www.ably.io/concepts/idempotency
