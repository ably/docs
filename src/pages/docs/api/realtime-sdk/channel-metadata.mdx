...
intro: "Monitor channel occupancy and lifecycle data without requiring subscription to the channel. The Metadata API enables tracking active connections, presence counts, channel status, and operational insights."
