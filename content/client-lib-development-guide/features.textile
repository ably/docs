...
***** @(RSH3a2a5)@ If the platform supports actively requesting the current push recipient details for the device, it must verify that the platform's details and the LocalDevice's details match. If they don't, the LocalDevice must be updated.
...
**** @(RSH3d1c)@ If the platform supports actively requesting the current push recipient details for the device, it must verify that the platform's details and the LocalDevice's details match. If they don't, it must enqueue a @GotPushDeviceDetails@ event with the new details.
**** @(RSH3d1a)@ Otherwise, makes @Push#activate@ return or call its callback with no error.
