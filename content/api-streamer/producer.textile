...
You can do this by either by using our "Realtime Client SDKs":/realtime, our "REST Client SDKs":/rest, our "MQTT adapter":/protocols/mqtt, or directly using our "raw REST API":/rest-api (although this last option isn't recommended as it is inferior to our SDKs in terms of performance and resilience).
