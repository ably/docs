...
Ably queues provide a way to consume realtime data using the AMQP or STOMP protocols.
...
<p>If your application requires more than the default limits (e.g. longer TTLs or more messages), contact "Ably support":https://ably.com/support to discuss custom configurations.</p>
</aside>
