...
**Server-side batching** is ideal when you need complete message history but can tolerate some latency. Consider a live sports dashboard with 100,000 viewers and a data source publishing 10 updates per second during an exciting match:
