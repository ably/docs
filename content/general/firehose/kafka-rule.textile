...
You can use a Kafka rule to send "data":/docs/general/firehose#data-sources such as messages, occupancy, lifecycle and presence events from Ably to Kafka.
...
* "Ably Kafka Connector":/docs/general/kafka-connector
