@ARTChannelEvent@ is the enum emitted as the event in @ARTRealtimeChannel.on@. The variants correspond to "@Realtime Channel@ state":/realtime/channels-messages/#channel-state changes, plus an arbitrary @Error@.
