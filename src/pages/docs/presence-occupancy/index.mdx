...
<Aside data-type='usp'>
Reliable state during network disruptions.

Ably maintains connection state for up to two minutes during disconnections, ensuring presence membership and occupancy counts remain accurate during temporary network issues. [Learn how Ably recovers connections seamlessly](/docs/platform/architecture/connection-recovery).
</Aside>
