...
Ably Client Library SDKs are available in multiple programming languages. Some SDKs have a realtime and a REST interface, whilst others only have a REST interface. The "SDK downloads":https://ably.com/download page lists availability. For further information on when it's best to use the realtime or REST SDK, see "the best practice guide":https://ably.com/documentation/best-practice-guide#choosing-between-realtime-rest-mqtt.
...
blang[nodejs].
  ...
  To get started with your project, add the SDK into your @package.json@ file or install it manually:
...
blang[ruby].
  ...
  To get started with your project, add the SDK to your @Gemfile@ or install it manually:
...
blang[python].
  The Ably Client Library SDK is available from "PyPI":https://pypi.python.org/pypi/ably. Note that the SDK is only available with a REST interface for Python.
...
blang[php].
  The Ably Client Library SDK is available as a composer package on "packagist":https://packagist.org/packages/ably/ably-php. Note that the SDK is only available with a REST interface for PHP.
...
blang[java].
  The Ably Client Library SDK is hosted on "GitHub":https://github.com/ably/ably-java.

  To get started with your project, add the SDK into your @build.gradle@ dependencies section.
  ...
  *Note*: In the above examples a specific version of the SDK is referenced. It's recommended to always use the latest stable version available for "Java":https://bintray.com/ably-io/ably/ably-java and "Android":https://bintray.com/ably-io/ably/ably-android.
...
blang[default].
  ...
  Alternatively, you can use your own API key if you already have an account, or "sign up":https://ably.com/signup for a free account to obtain one. Just make sure the key provides the subscribe and publish "capabilities":/core-features/authentication#capabilities-explained.

blang[python,php].
  The <span lang="python">Python</span><span lang="php">PHP</span> SDK is only available with a REST interface. You will need to use one of the realtime libraries to create a realtime connection to Ably. Use the language selector above to change language.
...
blang[python,php].
  The <span lang="python">Python</span><span lang="php">PHP</span> SDK is only available with a REST interface. You will need to use one of the realtime libraries to subscribe to a channel and receive messages. Use the language selector above to change language.
...
blang[python,php].
  The <span lang="python">Python</span><span lang="php">PHP</span> SDK is only available with a REST interface. You will need to use one of the realtime libraries to create or manage a connection to Ably. Use the language selector above to change language.
