@StatsRequestParams@ is a type that encapsulates the parameters for a stats query. For example usage see "<span lang="default">@Realtime#stats@</span><span lang="csharp">@Realtime#Stats@</span>":/metadata-stats/stats.
