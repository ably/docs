...
blang[java,csharp].
  <%= partial 'types/versions/v1.0/_ably_exception', indent: 2, skip_first_indent: true %>

blang[ruby].
  <%= partial 'types/versions/v1.0/_base_ably_exception', indent: 2, skip_first_indent: true %>
...
blang[jsall,ruby].
  <%= partial 'types/versions/v1.0/_device_details', indent: 2, skip_first_indent: true %>
...
<%= partial 'types/versions/v1.0/_error_info' %>
...
<%= partial 'types/versions/v1.0/_message' %>
...
<%= partial 'types/versions/v1.0/_presence_message' %>
...
<%= partial 'types/versions/v1.0/_presence_action' %>
...
<%= partial 'types/versions/v1.0/_paginated_result' %>

h3(#http-paginated-response).
  default: HttpPaginatedResponse

<%= partial 'types/versions/v1.0/_http_paginated_response' %>

h3(#param).
  java:    io.ably.lib.types.Param

blang[java].
  <%= partial 'types/versions/v1.0/_param', indent: 2, skip_first_indent: true %>
...
blang[jsall,ruby].
  <%= partial 'types/versions/v1.0/_push_channel_subscription', indent: 2, skip_first_indent: true %>
...
<%= partial 'types/versions/v1.0/_token_details' %>
...
<%= partial 'types/versions/v1.0/_token_request' %>
...
<%= partial 'types/versions/v1.0/_stats' %>

h3(#stats-granularity).
  objc,swift: ARTStatsGranularity

<%= partial 'types/versions/v1.0/_stats_granularity' %>
...
<%= partial 'types/versions/v1.0/_auth_options' %>
...
<%= partial 'types/versions/v1.0/_client_options' %>
<%= partial 'types/versions/v1.0/_realtime_client_options' %>
...
<%= partial 'types/versions/v1.0/_channel_options' %>
...
<%= partial 'types/versions/v1.0/_channel_state' %>
...
<%= partial 'types/versions/v1.0/_channel_event' %>
...
<%= partial 'types/versions/v1.0/_channel_state_change' %>

h3(#channel-state-listener).
  java:   io.ably.lib.realtime.ChannelStateListener

blang[java].
  <%= partial 'types/versions/v1.0/_channel_state_listener', indent: 2, skip_first_indent: true %>
...
<%= partial 'types/versions/v1.0/_cipher_params' %>

h3(#completion-listener).
  java:   io.ably.lib.realtime.CompletionListener

blang[java].
  <%= partial 'types/versions/v1.0/_completion_listener', indent: 2, skip_first_indent: true %>
...
<%= partial 'types/versions/v1.0/_connection_state' %>
...
<%= partial 'types/versions/v1.0/_connection_event' %>

h3(#connection-state-listener).
  java: io.ably.lib.realtime.ConnectionStateListener

blang[java].
  <%= partial 'types/versions/v1.0/_connection_state_listener', indent: 2, skip_first_indent: true %>
...
<%= partial 'types/versions/v1.0/_connection_state_change' %>

h3(#history-request-params).
  csharp: IO.Ably.HistoryRequestParams

blang[csharp].
  <%= partial 'types/versions/v1.0/_history_request_params', indent: 2, skip_first_indent: true %>

h3(#message-listener).
  java: io.ably.lib.realtime.Channel.MessageListener

blang[java].
  <%= partial 'types/versions/v1.0/_message_listener', indent: 2, skip_first_indent: true %>

h3(#last-connection-details).
  javascript: LastConnectionDetails

blang[javascript].
  <%= partial 'types/versions/v1.0/_last_connection_details', indent: 2, skip_first_indent: true %>
...
blang[ruby].
  ...
  <%= partial 'types/versions/v1.0/_deferrable', indent: 2, skip_first_indent: true %>
...
<%= partial 'types/versions/v1.0/_token_params' %>
