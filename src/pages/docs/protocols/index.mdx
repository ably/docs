...
Protocol adapters run alongside Ably's core service in every datacenter, ensuring clients using any protocol connect to the [closest point of presence](/docs/platform/architecture/edge-network#dns-organization-and-latency-based-routing) with minimal added latency.
</Aside>
