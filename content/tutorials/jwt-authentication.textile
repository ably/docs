...
The server will output it's logs messages in the terminal window.
...
5. Open the browser developer console, to see client's logged messages.

6. Enter any data into the @username@ and @password@ fields and click **login**.
