...
intro: "Deploy your Realtime applications to production with increased capacity and professional support for growing businesses. The Standard package offers unlimited messages with higher concurrent limits and enhanced SLA support."
