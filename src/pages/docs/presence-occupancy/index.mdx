...
Ably [maintains connection state](/docs/platform/architecture/connection-recovery) for up to two minutes during disconnections, ensuring presence membership and occupancy counts remain accurate during temporary network issues.
</Aside>
