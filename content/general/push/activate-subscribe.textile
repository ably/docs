...
To receive messages on an Android device, you need to implement a service that extends "@FirebaseMessagingService@":https://firebase.google.com/docs/reference/android/com/google/firebase/messaging/FirebaseMessagingService. To handle incoming push notifications, override "@onMessageReceived()@":https://firebase.google.com/docs/reference/android/com/google/firebase/messaging/FirebaseMessagingService. Though these messages are sent through Ably, when received on the device, they (@RemoteMessage@) do not interact with the Ably clients, and you should implement logic to handle the push notification messages appropriately, such as showing a UI "notification":https://developer.android.com/guide/topics/ui/notifiers/notifications.
