...
bq(definition#publish-data).
  ...
  csharp:   public Task PublishAsync(string name, object data, string clientId = null)
...
bq(definition#publish-msg-array).
  ...
  csharp:   public Task PublishAsync(IEnumerable<"Message":#message> messages)
...
bq(definition).
  ...
  csharp:  public Task<"PaginatedResult":#paginated-result<"Message":#message>> HistoryAsync(DataRequestQuery dataQuery)
