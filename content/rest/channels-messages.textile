...
bc[jsall]. var channel = rest.channels.get('myChannel');
...
bc[jsall]. var channel = rest.channels.get('myChannel', channelOpts);

bc[java]. import io.ably.lib.rest.Channel;
...
bc[jsall]. channel.publish("myEvent", "This is my message", function(err) {
  if(err)
...
bc[java]. import io.ably.lib.rest.CompletionListener;
