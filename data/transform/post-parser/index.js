...
const checkEnclosingSpans = (content) => {
  console.log(content.match(/^.*&lt.*$/));
  return content;
}

const postParser = compose(checkEnclosingSpans, convertExternalLinksToBlankTarget, convertBlangBlocksToHtml, addGithubLineBreaks);
