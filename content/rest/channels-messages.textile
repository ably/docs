...
If you would prefer to just dive into code and see some examples of how to use channels and messages, then we recommend you take a look at our "REST tutorials":/tutorials.
...
<%= partial 'shared/_message_from_encoded' %>
