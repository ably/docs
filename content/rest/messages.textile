---
title: Messages
meta_description: "The Ably service allows for clients to send information with messages, which contain data the client wishes to communicate."
meta_keywords: "Message, publish, subscribe"
section: rest
index: 24
languages:
  - javascript
...
* See "Message API Reference - Realtime":/realtime/realtime-api-reference#message-api
* See "Message API Reference - REST":/rest/rest-api-reference#message-api
