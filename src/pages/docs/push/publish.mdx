...
Proactive capacity management with headroom maintenance ensures performance isn't degraded by capacity limitations, regardless of demand levels. [Learn how Ably manages capacity and quality of service](/docs/platform/architecture/performance#capacity-management-and-quality-of-service).
</Aside>
