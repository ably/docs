...
intro: "Message storage retains all messages for two minutes by default, with extended retention available up to a year or longer. Integrations enable long-term storage outside Ably for compliance and archival needs."
meta_description: "Ably message storage: retain messages from two minutes up to a year, with integrations for long-term storage and compliance requirements."
---
