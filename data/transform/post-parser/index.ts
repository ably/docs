 ...
 */
export const addGithubLineBreaks: StringTransformation = (content) => content.replaceAll('{{{github_br}}}', '\n');

const LINK_EXTERNAL_REGEX = /(<a[^>]*)class="external"([^>]*>)/m;

export const convertExternalLinksToBlankTarget: StringTransformation = (content) =>
