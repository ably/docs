---
title: Connection
intro: "Manage persistent WebSocket connections to Ably's realtime infrastructure for reliable messaging. The Connection API provides state monitoring, event handling, automatic recovery, and connection lifecycle control."
