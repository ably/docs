...
Using one of the application keys created via the "application dashboard":http://support.ably.com/solution/articles/3000030053-how-do-i-access-my-app-dashboard, basic authentication provides the simplest method to authenticate with Ably, but has two important limitations:
