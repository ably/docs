...
Custom restrictions also apply to [presence](/docs/presence-occupancy/presence) messages and individual [annotations](/docs/messages/annotations). In both cases, the user claim is included in `extras.userClaim`.
