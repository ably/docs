...
For this application, we'll use add the Ably Realtime SDK via Cocoapods, which is a dependency manager for Swift and Obj-C projects. You can learn more about it and install it from "its official website":https://cocoapods.org/ using the following command from the project folder:
