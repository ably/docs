...
h2.
  ...
  swift: Step 2 - Setup Xcode project and install Ably
...
blang[swift].
  ...
  To be able to subscribe to a channel add a button that will start subscription to "sports" channel. Go to your @ExampleViewController@ and add an @UIButton@ from @Object library@. Name the action "subscribeAction".
  ...
  In similar fashion add two @UILabels@ and connect one of them so that it will show the last message received. Name it "receivedMessageText".
  Your @ExampleViewController@ should look similar to that view:
