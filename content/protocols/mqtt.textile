...
To use rewind with MQTT you specify the @rewind@ channel option with a numerical value equal to the position you want to attach to, for example @"1"@ to rewind 1 message previous. This will apply to all channels specified in the query string.
