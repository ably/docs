...
For chat applications, the [Chat SDK](/docs/chat) provides built-in [presence](/docs/chat/rooms/presence) and [occupancy](/docs/chat/rooms/occupancy) features. The example below illustrates how these primitives work at the Pub/Sub level.
</Aside>
