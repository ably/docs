...
intro: "Trigger AWS Lambda functions from Ably events to enable serverless processing that scales automatically and integrates with your AWS ecosystem. Execute functions in response to messages, presence updates, and channel activity without managing servers or infrastructure."
