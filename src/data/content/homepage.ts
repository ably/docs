      ...
      cards: [
        {
          ...
          image: 'pub-sub.png',
          links: [{ text: 'Get started', href: '/docs/products/channels' }],
        },
        {
          title: 'Spaces',
          type: 'feature',
          ...
          image: 'spaces.png',
          links: [{ text: 'Get started', href: '/docs/products/spaces' }],
        },
        {
          title: 'LiveSync',
          type: 'feature',
          ...
          image: 'livesync.png',
          links: [{ text: 'Get started', href: '/docs/products/livesync' }],
        },
        {
          title: 'Chat',
          type: 'feature',
          ...
          image: 'chat.png',
          links: [{ text: 'Get started', href: '/docs/products/chat' }],
        },
        {
          ...
          links: [{ text: 'Get started', href: '/docs/products/asset-tracking' }],
        },
      ],
    },
    {
