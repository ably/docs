...
intro: "Stream Realtime events to AWS Kinesis for scalable data processing and analytics pipelines. Automatically forward messages, presence updates, and channel events with secure IAM role authentication and customizable partition routing."
...
| [Source](/docs/platform/integrations/streaming#sources) | Specifies the event types being sent to Kinesis. |
...
| Partition key | Specifies the [partition key](/docs/messages#routing) used to route messages to a Kinesis stream shard. |
