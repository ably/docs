...
Ably's platform achieves this by providing the lowest latencies of any Pub/Sub WebSockets platform, with a **global mean latency of 37ms**.
...
This is the most important metric for realtime applications as it represents the end-to-end delay that your users experience.
