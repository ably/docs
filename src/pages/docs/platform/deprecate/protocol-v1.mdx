...
intro: "Upgrade to newer SDK versions to ensure continued access to Ably's enhanced capabilities and features. Protocol version 1 will be sunset on November 1st, 2025, requiring migration to version 2 or later."
