...
Whilst the realtime client libraries allow a device to activate itself and subscribe for push notifications, the API is designed primarily to facilitate push functionality for the device it is running on.

As such, a separate push admin API is provided in our client libraries specifically designed for use by your servers to help with "direct publishing":#direct-publishing push notifications and managing your devices and their channel subscriptions.
