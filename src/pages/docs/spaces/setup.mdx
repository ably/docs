---
title: SDK setup
intro: Install and configure the Spaces SDK to enable Realtime collaboration features in your application. Get started with authentication, installation, and instantiation for avatar stacks, live cursors, and component locking.
