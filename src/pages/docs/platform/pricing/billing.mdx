---
title: Billing
intro: "Billing calculates monthly costs based on package fees plus actual usage, with invoices issued in arrears on the 1st of each month. Usage minutes are rounded up and charges reflect the previous month's consumption."
