...
<If lang="swift">
[LiveMap](/docs/liveobjects/map) is a key/value data structure similar to a `Dictionary`:
</If>

<If lang="java">
[LiveMap](/docs/liveobjects/map) is a key/value data structure similar to a `HashMap` or `Map`:
</If>

* Keys must be strings
* Values can be [primitive types][#primitive-types] or [references](#composability) to other objects
