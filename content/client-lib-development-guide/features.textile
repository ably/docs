...
* @(RTE5)@ @EventEmitter#off@ deregisters every matching listener for the specified event if given, else it is deregisters every matching listener for any registrations i.e. registrations for any event and registrations for a specific event
