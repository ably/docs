...
- "Multiple availability zones":https://support.ably.io/solution/articles/3000029525-where-are-ably-s-servers-located-around-the-world := in every region our our data is replicated between servers in at least two independent data-centers ensuring outages in one data centre cannot cause data loss
- "Multiple regions":https://support.ably.io/solution/articles/3000029525-where-are-ably-s-servers-located-around-the-world := ensuring that data is always stored in at least two regions protects against complete region outage or network partitoning
