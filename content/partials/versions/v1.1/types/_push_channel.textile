...
A @PushChannel@ is a property of a "@RealtimeChannel@":/api/realtime-sdk/channels#properties or "@RestChannel@":/api/rest-sdk/channels#properties. It provides "push devices":/push the ability to subscribe and unsubscribe to push notifications on channels.
...
"Subscribe all devices associated with your device's clientId":/push/publish#sub-channels to the channel's push notifications.
...
"Unsubscribe all devices associated with your device's clientId":/push/publish#sub-channels from the channel's push notifications.
