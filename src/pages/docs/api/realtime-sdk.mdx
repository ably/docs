...
<If lang="java,swift,objc,csharp,flutter">
...
<If lang="ruby,java,swift,objc,flutter,csharp">
...
<If lang="java,swift,objc,flutter">
...
## <If lang="java">io.ably.lib.AblyRealtime Members</If><If lang="ruby">Ably::Realtime::Client Attributes</If><If lang="objc,swift">ARTRealtime Properties</If><If lang="csharp,flutter">AblyRealtime Properties</If> <a id="properties" />
...
<If lang="objc,swift,csharp,flutter">

The Realtime client exposes the following public properties:

</If>

### <If lang="csharp">`Auth`</If><If lang="ruby,java,swift,objc,flutter">`auth`</If> <a id="auth" />
...
### <If lang="csharp">`Channels`</If><If lang="ruby,java,swift,objc,flutter">`channels`</If> <a id="channels" />
...
### <If lang="csharp">`Connection`</If><If lang="ruby,java,swift,objc,flutter">`connection`</If> <a id="connection" />
...
## <If lang="java">io.ably.lib.AblyRealtime Methods</If><If lang="ruby">Ably::Realtime::Client Methods</If><If lang="objc,swift">ARTRealtime Methods</If><If lang="csharp,flutter">AblyRealtime Methods</If> <a id="methods" />

### <If lang="csharp">Connect</If><If lang="ruby,java,swift,objc,flutter">connect</If> <a id="connect" />
...
### <If lang="csharp">Close</If><If lang="ruby,java,swift,objc,flutter">close</If> <a id="close" />
...
### <If lang="csharp">Stats</If><If lang="ruby,java,swift,objc,flutter">stats</If> <a id="stats" />
...
|-----------|-------------|------|
| <If lang="java,flutter">options</If><If lang="csharp">query</If> | An optional object containing the query parameters | <If lang="flutter">Object</If><If lang="java">[`Param[]`](#param)</If><If lang="csharp">`StatsRequestParams`</If> |
...
#### <If lang="java,flutter,ruby">`options` parameters</If><If lang="objc,swift">`ARTStatsQuery` properties</If><If lang="csharp">`StatsRequestParams` properties</If>

The following options, as defined in the [REST `/stats` API](/docs/api/rest-api#stats) endpoint, are permitted:

| Property | Description | Type | Default |
|----------|-------------|------|---------|
| <If lang="java,swift,objc,flutter">start</If><If lang="ruby">:start</If><If lang="csharp">Start</If> | Earliest <If lang="csharp">`DateTimeOffset` or </If><If lang="ruby">`Time` or </If>time in milliseconds since the epoch for any stats retrieved | <If lang="java">`Long`</If><If lang="ruby">`Int` or `Time`</If><If lang="csharp">`DateTimeOffset`</If><If lang="swift,objc,flutter">`Long`</If> | beginning of time |
| <If lang="java,swift,objc,flutter">end</If><If lang="ruby">:end</If><If lang="csharp">End</If> | Latest <If lang="csharp">`DateTimeOffset` or </If><If lang="ruby">`Time` or </If>time in milliseconds since the epoch for any stats retrieved | <If lang="java">`Long`</If><If lang="ruby">`Int` or `Time`</If><If lang="csharp">`DateTimeOffset`</If><If lang="swift,objc,flutter">`Long`</If> | current time |
| <If lang="java,swift,objc,flutter">direction</If><If lang="ruby">:direction</If><If lang="csharp">Direction</If> | <If lang="ruby">`:forwards` or `:backwards`</If><If lang="java,swift,objc,flutter">`forwards` or `backwards`</If><If lang="csharp">`forwards` or `backwards`</If> | <If lang="java,swift,objc,flutter">`String`</If><If lang="ruby">`Symbol`</If><If lang="csharp">`Direction` enum</If> | backwards |
| <If lang="java,swift,objc,flutter">limit</If><If lang="ruby">:limit</If><If lang="csharp">Limit</If> | Maximum number of stats to retrieve up to 1,000 | <If lang="java">`Integer`</If><If lang="ruby,csharp,swift,objc,flutter">`Integer`</If> | 100 |
| <If lang="java,swift,objc,flutter">unit</If><If lang="ruby">:unit</If><If lang="csharp">Unit</If> | <If lang="ruby">`:minute`, `:hour`, `:day` or `:month`.</If><If lang="java,swift,objc,flutter">`minute`, `hour`, `day` or `month`.</If><If lang="csharp">`minute`, `hour`, `day` or `month`.</If> Based on the unit selected, the given start or end times are rounded down to the start of the relevant interval depending on the unit granularity of the query | <If lang="java">`String`</If><If lang="objc,swift">[`ARTStatsGranularity`](#stats-granularity)</If><If lang="ruby">`Symbol`</If><If lang="csharp">[`StatsIntervalGranularity`](/docs/api/realtime-sdk/types#stats-granularity) enum</If> | minute |
...
### <If lang="csharp">Time</If><If lang="ruby,java,swift,objc,flutter">time</If> <a id="time" />
...
### <If lang="flutter,java,objc,ruby,swift">request</If><If lang="csharp">Request</If> <a id="request" />
...
| Parameter | Description | Type |
|-----------|-------------|------|
| method | Either `get`, `post`, `put`, `patch` or `delete` | <If lang="csharp">string</If><If lang="ruby,java,objc,swift,flutter">String</If> |
...
### <If lang="swift,objc">ARTClientOptions</If><If lang="java">io.ably.types.ClientOptions</If><If lang="csharp">IO.Ably.ClientOptions</If><If lang="flutter">ably.ClientOptions</If><If lang="ruby">ClientOptions</If> <a id="client-options" />
...
#### <If lang="java">Members</If><If lang="ruby">Attributes</If><If lang="csharp,swift,objc,flutter">Properties</If>
...
| :log_level | Log level for the standard Logger that outputs to `STDOUT`. Can be set to `:fatal`, `:error`, `:warn`, `:info`, `:debug` or `:none`. Alternatively a [`Logger` severity constant](https://ruby-doc.org/3.4.1/stdlibs/logger/Logger.html#class-Logger-label-Severity) can be specified<br />**Type:** `Symbol`, [`Logger::SEVERITY`](https://ruby-doc.org/3.4.1/stdlibs/logger/Logger.html#class-Logger-label-Severity)<br />**Default:** `:error` |
| :logger | A [Ruby `Logger`](https://ruby-doc.org/3.4.1/stdlibs/logger/Logger.html#class-Logger-label-Synopsis) compatible object to handle each line of log output. If `logger` is not specified, `STDOUT` is used<br />**Type:** [Ruby `Logger`](https://ruby-doc.org/3.4.1/stdlibs/logger/Logger.html#class-Logger-label-Synopsis)<br />**Default:** `STDOUT Logger` |
...
### <If lang="swift,objc">ARTStats</If><If lang="java">io.ably.lib.types.Stats</If><If lang="ruby">Ably::Models::Stats</If><If lang="csharp">IO.Ably.Stats</If> <a id="stats-type" />
...
#### <If lang="flutter,swift,csharp,obj-c">Properties</If><If lang="java">Members</If><If lang="ruby">Attributes</If>
...
#### <If lang="swift,objc,flutter,csharp">Properties</If><If lang="java">Members</If><If lang="ruby">Attributes</If>
...
| Property | Description | Type |
|----------|-------------|------|
| <If lang="csharp">StatusCode</If> | The HTTP status code of the response | `Number` |
| <If lang="csharp">Success</If> | Whether the HTTP status code indicates success. This is equivalent to <If lang="csharp">`200 <= StatusCode < 300`</If> | `Boolean` |
| <If lang="csharp">Headers</If> | The headers of the response | `Object` |
| <If lang="csharp">ErrorCode</If> | The error code if the `X-Ably-Errorcode` HTTP header is sent in the response | <If lang="csharp">`Int`</If> |
| <If lang="csharp">ErrorMessage</If> | The error message if the `X-Ably-Errormessage` HTTP header is sent in the response | `String` |
...
##### <If lang="objc,flutter,swift,java">hasNext</If><If lang="csharp">HasNext</If><If lang="ruby">has_next?</If>
...
Returns `true` if there are more pages available by calling <If lang="objc,swift,flutter,java,ruby">`next`</If><If lang="csharp">`Next`</If> and returns `false` if this page is the last page available.

</If>

##### <If lang="objc,swift,flutter,java">isLast</If><If lang="csharp">IsLast</If><If lang="ruby">last?</If>
...
Returns `true` if this page is the last page and returns `false` if there are more pages available by calling <If lang="java,ruby,flutter,objc,swift">`next`</If><If lang="csharp">`Next`</If> available.

</If>

##### <If lang="java,ruby,flutter,objc,swift">next</If><If lang="csharp">Next</If>
