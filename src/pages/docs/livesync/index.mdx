...
<Aside data-type='see-evidence'>
Messages published using Realtime have consistent ordering for all subscribers, with each message assigned a unique serial number to preserve their place. [See evidence here 🕵️](/docs/platform/architecture/message-ordering)
</Aside>
