...
Ably's SDKs automatically resolve [edge network](/docs/platform/architecture/edge-network) failures within 30 seconds, keeping your users connected even during infrastructure issues.
</Aside>
