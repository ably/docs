...
Retrieve "presence":/presence-occupancy/presence history using the "@history()@":/docs/api/realtime-sdk/presence#history method on the presence object. This enables a client to retrieve historical presence events from the channel.
