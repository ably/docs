...
Resolution:
* Retry the operation on an object that is not a tombstone and is [reachable](/docs/liveobjects/concepts/objects#reachability) from the [channel object](/docs/liveobjects/concepts/objects#channel-object).
