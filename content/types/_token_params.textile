...
- <span lang="default">timestamp</span><span lang="ruby">:timestamp</span> := <span lang="default">The timestamp (in milliseconds since the epoch)</span><span lang="ruby,objc,swift,csharp">The timestamp</span> of this request. @timestamp@, in conjunction with the @nonce@, is used to prevent token requests from being replayed.<br>__Type: <span lang="default">@Integer@</span><span lang="java">@Long Integer@</span><span lang="ruby">@Time@</span><span lang="objc,swift">@NSDate@</span><span lang="csharp">@DateTimeOffset@</span>__

- <span lang="default">ttl</span><span lang="ruby">:ttl</span> := _1 hour_ Requested time to live for the token being created <span lang="default">in milliseconds</span><span lang="ruby">in seconds</span><span lang="objc,swift">as a @NSTimeInterval@</span><span lang="csharp">as a @TimeSpan@. When omitted, the Ably REST API default of 60 minutes is applied by Ably<br>__Type: <span lang="default">@Integer@ (milliseconds)</span><span lang="ruby">@Integer@ (seconds)</span><span lang="objc,swift">@NSTimeInterval@</span><span lang="java">@Long Integer@</span><span lang="csharp">@TimeSpan@</span>__
