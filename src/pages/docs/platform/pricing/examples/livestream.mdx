...
| 360,000 messages sent → ~900M delivered (with batching) | ✓ Room reactions |
| 10,000 room reactions → ~70M delivered (with batching) | |
| 25,000 viewers × 1 hour = 1.5M connection minutes | |
...
|------|-------------|------|
| Messages (with batching) | 900M × $2.50/M | $2,250 |
| Room reactions (with batching) | 70M × $2.50/M | $175 |
| Connection minutes | 1.5M mins × $1.00/M mins | $1.50 |
...
|------|---------|----------|-------|------|
| Chat messages | 360K | 900M | 900.36M | $2,250 |
| Room reactions | 10K | 70M | 70.01M | $175 |
| Moderation* | 360K | — | 360K | ~$1 |
| **Message costs** | **730K** | **970M** | **970.73M** | **$2,426** |
...
| With batching | $2,250 | 900M messages | **$20,250** |
