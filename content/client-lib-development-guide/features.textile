...
h3(#rest-batch). Batch
* @(BO1)@ The batch object is accessible through @Rest#batch@ or @Realtime#batch@
* @(BO2)@ @Batch#publish@ function:
** @(BO2a)@ Sends a @POST@ request to @<restHost>/messages@ with the supplied @BatchPublishRequest@ or @[]BatchPublishRequest@ as the request body where @<restHost>@ represents the current rest host as described by "@RSC11@":#RSC11
** @(BO2b)@ Takes a @BatchPublishRequest@ or @[]BatchPublishRequest@ as an argument. In languages where function overloading is not supported an array is preferred.
** @(BO2c)@ Returns the response body as a @BatchResult<BatchPublishResponse>@ object or an @ErrorInfo@ if a failure response is receieved
* @(BO2)@ @Batch#getPresence@ function:
** @(BO2a)@ Sends a @GET@ request to @<restHost>/messages@ with the supplied with the supplied channel names joined by a comma as the @channel@ query param where @<restHost>@ represents the current rest host as described by "@RSC11@":#RSC11
** @(BO2b)@ Takes an array of strings as an argument, representing the channel names to include in the batch request
** @(BO2c)@ Returns the response body as a @BatchResult<BatchPublishResponse>@ object or an @ErrorInfo@ if a failure response is received
...
** @(BPD2c)@ @error@ is an @ErrorInfo@ object which, if included, indicates that the request failed for the specified channel
...
class BatchOperations:
  publish([BatchPublishRequest]) => BatchResult<BatchPublishResponse> // BO2a
  publish(BatchPublishRequest) => BatchResult<BatchPublishResponse> // BO2a
...
class BatchPresenceResponse:
  ...
  presence: []PresenceMessage // PBD2b
  error: ErrorInfo?
