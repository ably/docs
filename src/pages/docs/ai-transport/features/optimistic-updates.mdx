...
Without optimistic updates, every user message would wait for a server round trip before appearing. In a realtime conversation, even a few hundred milliseconds of delay makes the UI feel sluggish. Optimistic insertion makes the conversation feel instant.
</Aside>
