---
title: Presence
intro: "Track which clients are currently active on channels and enable realtime awareness features using presence events. The Presence API manages member states, occupancy counts, presence notifications, and client status updates."
