...
Reaction events are delivered to all connected users without loss, even during brief network disruptions. [Learn how Ably maintains delivery guarantees](/docs/platform/architecture/connection-recovery).
</Aside>
