...
However, if your use case requires longer retention of messages, i.e. longer than the default two minutes, you can enable "persisted history": using both the "Realtime":/realtime and the "REST":/rest libraries of Ably. If "persisted history is enabled":#persisted-history for a channel, its messages will "typically be stored for 24 - 72 hours on disk":https://knowledge.ably.com/how-long-are-messages-stored-for.
