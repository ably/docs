...
intro: "Build iOS apps with realtime state synchronization using conflict-free LiveObjects data structures. This guide covers Swift SDK integration and implementing collaborative features."
meta_description: "Get started with Ably LiveObjects in Swift: build iOS apps with realtime state synchronization and conflict-free collaborative features."
---
