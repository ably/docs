...
Login to your "Apple developer account":https://developer.apple.com and click on "Certificates, Identifiers and Profiles". Now, select "App IDs" tab from the side menu and create a new App ID using the plus button, as shown below.
...
This will create a new downloadable Push certificate with a validity of one year as shown below. Go ahead and download it.
