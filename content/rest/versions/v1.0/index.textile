...
- Presence requests := Providing "channel presence state and history retrieval":/presence-occupancy/presence on channels.
...
* If you want to consume realtime data from one or more of your servers, then we recommend you consider using our "Ably Queues":/general/queues or "Firehose":/general/firehose. With Integrations you can consume realtime data in a robust, resilient and scalable way across multiple support protocols. "Find our more about Ably Integrations":/general/integrations.
