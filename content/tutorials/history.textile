...
By default, channels will only store messages in memory for up to two minutes. However, using "channel rules":https://support.ably.com/solution/articles/3000030057, you can configure messages published on matching channels to be persisted to disk for "typically 24 - 72 hours":https://support.ably.com/solution/articles/3000030059. Those messages will then be immediately available for retrieval via our Realtime and REST API clients for as long as the message is stored on disk.
...
# Visit your "account dashboard":https://support.ably.com/solution/articles/3000048664, navigate to the same app you chose in Step 1 when obtaining your API key earlier
...
<audio id="sound-A2" src="https://files.ably.com/tutorials/piano/samples/A2.ogg" preload="auto"></audio>
<audio id="sound-Bb2" src="https://files.ably.com/tutorials/piano/samples/Bb2.ogg" preload="auto"></audio>
<audio id="sound-B2" src="https://files.ably.com/tutorials/piano/samples/B2.ogg" preload="auto"></audio>
<audio id="sound-Ab3" src="https://files.ably.com/tutorials/piano/samples/Ab3.ogg" preload="auto"></audio>
<audio id="sound-A3" src="https://files.ably.com/tutorials/piano/samples/A3.ogg" preload="auto"></audio>
<audio id="sound-Bb3" src="https://files.ably.com/tutorials/piano/samples/Bb3.ogg" preload="auto"></audio>
<audio id="sound-B3" src="https://files.ably.com/tutorials/piano/samples/B3.ogg" preload="auto"></audio>
<audio id="sound-C3" src="https://files.ably.com/tutorials/piano/samples/C3.ogg" preload="auto"></audio>
<audio id="sound-Db3" src="https://files.ably.com/tutorials/piano/samples/Db3.ogg" preload="auto"></audio>
<audio id="sound-D3" src="https://files.ably.com/tutorials/piano/samples/D3.ogg" preload="auto"></audio>
<audio id="sound-Eb3" src="https://files.ably.com/tutorials/piano/samples/Eb3.ogg" preload="auto"></audio>
<audio id="sound-E3" src="https://files.ably.com/tutorials/piano/samples/E3.ogg" preload="auto"></audio>
<audio id="sound-F3" src="https://files.ably.com/tutorials/piano/samples/F3.ogg" preload="auto"></audio>
<audio id="sound-Gb3" src="https://files.ably.com/tutorials/piano/samples/Gb3.ogg" preload="auto"></audio>
<audio id="sound-G3" src="https://files.ably.com/tutorials/piano/samples/G3.ogg" preload="auto"></audio>
<audio id="sound-Ab4" src="https://files.ably.com/tutorials/piano/samples/Ab4.ogg" preload="auto"></audio>
<audio id="sound-A4" src="https://files.ably.com/tutorials/piano/samples/A4.ogg" preload="auto"></audio>
<audio id="sound-Bb4" src="https://files.ably.com/tutorials/piano/samples/Bb4.ogg" preload="auto"></audio>
<audio id="sound-B4" src="https://files.ably.com/tutorials/piano/samples/B4.ogg" preload="auto"></audio>
<audio id="sound-C4" src="https://files.ably.com/tutorials/piano/samples/C4.ogg" preload="auto"></audio>
<audio id="sound-Db4" src="https://files.ably.com/tutorials/piano/samples/Db4.ogg" preload="auto"></audio>
<audio id="sound-D4" src="https://files.ably.com/tutorials/piano/samples/D4.ogg" preload="auto"></audio>
<audio id="sound-Eb4" src="https://files.ably.com/tutorials/piano/samples/Eb4.ogg" preload="auto"></audio>
<audio id="sound-E4" src="https://files.ably.com/tutorials/piano/samples/E4.ogg" preload="auto"></audio>
<audio id="sound-F4" src="https://files.ably.com/tutorials/piano/samples/F4.ogg" preload="auto"></audio>
<audio id="sound-Gb4" src="https://files.ably.com/tutorials/piano/samples/Gb4.ogg" preload="auto"></audio>
<audio id="sound-G4" src="https://files.ably.com/tutorials/piano/samples/G4.ogg" preload="auto"></audio>
<audio id="sound-C5" src="https://files.ably.com/tutorials/piano/samples/C5.ogg" preload="auto"></audio>
...
blang[java].
  ...
  Don't forget to replace your @ExampleActivity#API_KEY@ field with "Ably API key":https://support.ably.com/support/solutions/articles/3000030502-setting-up-and-managing-api-keys.
...
blang[javascript].
  ...
  And then run the demo locally by adding your "Ably API key":https://support.ably.com/support/solutions/articles/3000030502-setting-up-and-managing-api-keys to @example.html@ and opening the page in your browser.
...
blang[ruby].
  ...
  And then run the demo locally by adding your "Ably API key":https://support.ably.com/support/solutions/articles/3000030502-setting-up-and-managing-api-keys to @example.rb@ and running the demo @bundle exec ruby example.rb@
...
blang[php].
  ...
  And then run the demo locally by adding your "Ably API key":https://support.ably.com/support/solutions/articles/3000030502-setting-up-and-managing-api-keys to @history.php@, install the composer dependencies with:
...
blang[python].
  ...
  And then run the demo locally by adding your "Ably API key":https://support.ably.com/support/solutions/articles/3000030502-setting-up-and-managing-api-keys to @history.py@, install the required libraries with:
