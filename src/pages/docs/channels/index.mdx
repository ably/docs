...
Use channel namespaces to apply operations to all channels within that group, such as [capabilities](/docs/auth/capabilities), [rules](#rules) and [integrations](/docs/platform/integrations).
...
Rules are used to enforce settings for specific channels, or channel namespaces. They can be broadly categorized into three different types:
