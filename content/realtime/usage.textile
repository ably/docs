...
blang[flutter].
  The Ably library is "hosted on Github":https://github.com/ably/ably-flutter and is available as a "Dart package":https://pub.dev/packages/ably-flutter/. Update your @pubspec.yaml@ with appropriate package version:
