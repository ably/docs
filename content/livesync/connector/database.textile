...
This example adds a comment and logs the event in an outbox:
...
- @data@ := is the actual content or details of the mutation.

For more information, see "outbox table schema.":#schema
