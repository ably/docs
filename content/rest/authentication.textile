...
bq(definition). Rest.auth.requestToken(options, callback)
...
bq(definition). Rest.auth.authorise(options, callback)
...
bq(definition). Rest.auth.createTokenRequest(options, callback)
