...
Alternatively, you can use "channel mode flags":/realtime/channels#setting-channel-mode-flags to specify a subset of "capabilities":/auth/capabilities available on the API key or token a client is using.
