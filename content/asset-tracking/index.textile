...
Each @Trackable@ added to the @Publisher@ has a destination and set of @ResolutionConstraints@. Both @destination@ and @resolutionConstraints@ are optional for @Trackable@, but having them improves the resolution policy. The SDK provides an optional set of "default resolution constraints":#default-resolution-constraints, @DefaultResolutionContraints@.
