...
meta_description: "The AI Transport roadmap across three horizons: features available now, features in active development, and features planned for the future."
...
This page shows where AI Transport is heading. Ably updates the roadmap as customers say what they need. The fastest way to influence it is to [contact Ably](https://ably.com/contact), explaining what you are trying to build and where AI Transport can help you.
...
| Enterprise-ready platform | SOC 2 Type II and HIPAA, on [Ably's realtime platform](/docs/ai-transport/why#why-ably). |
...
Coming up, and unlikely to change.
