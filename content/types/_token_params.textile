...
- <span lang="default">ttl</span><span lang="ruby">:ttl</span> := _1 hour_ Requested time to live for the token being created <span lang="default">in milliseconds</span><span lang="ruby">in seconds</span><span lang="objc,swift">as a @NSTimeInterval@</span>. When omitted, the Ably REST API default of 60 minutes is applied by Ably<br>__Type: <span lang="default">@Integer@ (milliseconds)</span><span lang="ruby">@Integer@ (seconds)</span><span lang="objc,swift">@NSTimeInterval@</span><span lang="java">@Long Integer@</span>__
