...
Member locations build upon the functionality of the Ably Pub/Sub "presence":/presence-occupancy/presence feature. Members are entered into the presence set when they "enter the space":/spaces/space#enter.
