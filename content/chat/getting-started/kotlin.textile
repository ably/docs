...
* Install "JDK":https://docs.aws.amazon.com/corretto/latest/corretto-8-ug/downloads-list.html version 8 or greater.
* Install "Android Studio":https://developer.android.com/studio or "IntelliJ IDEA":https://www.jetbrains.com/idea/download.
* Open IDE (Android Studio or IntelliJ IDEA).
* Select File > New > Project.
* Choose Empty Activity from the wizard.
* Name your project (e.g., @AblyChatDemo@).
* Choose @Kotlin@ as the build configuration language.
* Add Ably Chat SDK to the list of dependencies:

```[kotlin]
implementation("com.ably.chat:chat-android:<latest-version>")
```
* Add the Kotlinx Coroutines library for asynchronous operations:

```[kotlin]
implementation("org.jetbrains.kotlinx:kotlinx-coroutines-core:<coroutine-version>")
```
