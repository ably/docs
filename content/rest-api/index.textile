...
- Auth required := no (for signed Ably TokenRequests), yes (for unsigned Ably TokenRequests, "basic":#basic-authentication or "token":#token-authentication permitted)
