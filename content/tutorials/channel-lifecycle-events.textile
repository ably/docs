...
Many times, developers find it helpful to be aware of specific metadata related to their channels and apps in general. This metadata can be accessed in the form of the "channel lifecycle events":/realtime/channel-metadata#lifecycle-events, "channel occupancy events":/realtime/channel-metadata#occupancy-realtime or even "channel enumeration":/rest/channel-metadata/enumeration-rest, i.e., listing all the active channels associated with a particular API key in an app via our Channel Lifecycle API. In this tutorial, we'll see how to subscribe to the channel lifecycle events.
...
"See this step in GitHub":https://github.com/ably/tutorials/commit/4712946
...
"See this step in GitHub":https://github.com/ably/tutorials/commit/1fe9cb3
...
"See this step in GitHub":https://github.com/ably/tutorials/commit/1dc3b56
...
"See this step in GitHub":https://github.com/ably/tutorials/commit/def4a7f
...
2. If you would like to check out the other two related tutorials to work with channel metadata, see "Channel Occupancy Events":/tutorials/channel-occupancy-events and "Channel Enumeration":/tutorials/channel-enumeration-rest tutorials .
...
var ably = new Ably.Realtime(userApiKey);
var metaChannel = ably.channels.get("[meta]channel.lifecycle");
var resultArea = document.getElementById("result");
resultArea.scrollTop = resultArea.scrollHeight;
