...
meta_description: "How to implement video calling using WebRTC and Ably."
meta_keywords: "Ably realtime, WebRTC"
---

In this lesson, we will take a look at implementing Video calling using WebRTC and Ably.
With the advent of "WebRTC":https://ably.com/blog/what-is-webrtc and the increasing capacity of browsers to handle peer-to-peer communications in real time, its easier now than ever to build realtime video calling apps.
