...
If you wish to use your own IDs for idempotent publishing, you can specify it when you "publish a message":/rest/channels#publish as the "id":#id element of the "Message":#properties object.
