...
Terraform is used to manage the resources provisioned for AWS and all other cloud services providers. This means that the entire layout of the infrastructure and much of its configuration is managed as code, providing numerous benefits for operational reliability.
...
A dedicated service configuration system is used to define the configuration of all configurable parameters of the running system. This system complements the static infrastructure defined in Terraform by handling dynamic, runtime parameters.
