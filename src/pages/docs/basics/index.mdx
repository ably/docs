...
Pub/Sub SDKs provide a consistent and idiomatic API across a variety of [supported platforms](/docs/getting-started) and are the most feature-rich method of integrating Ably into an application. Ably SDKs contain a realtime and a REST interface, each of which can be used to satisfy different use cases.
