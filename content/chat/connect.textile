...
blang[javascript,swift,kotlin].
  Use the <span lang="javascript">@off()@</span><span lang="swift">@unsubscribe()@</span><span lang="kotlin">@unsubscribe()@</span> function returned in the @onDiscontinuity()@ response to remove a listener:
