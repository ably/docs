...
Rewind by a certain number of messages (@rewind=20@) is restricted by the channel's persistence period. If you've not enabled "persisted history":/realtime/history#persisted-history, this will be 2 minutes. If you have persistence enabled, this will be 24 hours for free accounts, and 72 hours for paid accounts.
...
View the "@ChannelOptions@ object":/api/realtime-sdk/channels#channel-options for the associated Client Library SDK API reference.
