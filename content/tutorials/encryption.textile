...
1. If you would like to find out more about how to use the encryption API from your devices and apps, see the "Realtime encryption documentation":https://ably.com/docs/realtime/encryption. Typically on servers customers prefer to use the "REST encryption API":https://ably.com/docs/rest/encryption
...
3. Gain a good technical "overview of how the Ably realtime platform works":https://ably.com/docs/how-ably-works
