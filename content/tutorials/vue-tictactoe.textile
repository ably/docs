...
meta_description: "How to build a multiplayer Tic Tac Toe game using Ably and Vue.js."
meta_keywords: "Ably realtime, multiplayer game, Vue.js"
---
...
# In your "application dashboard":https://ably.com/dashboard, go to the &quot;Settings&quot; tab and scroll down to the &quot;Channel rules&quot; section.
...
Now we'll implement the @enterLobby@ function. It has one parameter, @onGamePending@, which is a callback function provided in the @lobby.vue@ file that we implemented earlier. See the "Ably documentation on Presence":/presence-occupancy/presence for full details on how presence works. In the code below, we subscribe to the lobby's @presence@ channel. The documentation for the @presence.subscribe()@ method "explains this in more detail":/api/realtime-sdk/presence#subscribe.
...
And then run the demo locally by adding your "Ably API key":https://faqs.ably.com/setting-up-and-managing-api-keys to @server/index.js@, and building and running the client and server as described at the start of the tutorial.

h2. Next steps

1. Find out more about Realtime "channels":/channels & "messages":/channels/messages
2. "Find out more about Presence":/presence-occupancy/presence
3. "Find out more about History":/storage-history/history
4. "Find out more about Authentication":/auth
5. Learn more about other "Ably features":https://ably.com/platform by stepping through our other "Ably tutorials":https://ably.com/tutorials
6. Gain a good technical "overview of how the Ably realtime platform works":/basics/ably
7. "Vue.js and Node.js tutorial: a realtime collaboration app hosted in Azure Static Web Apps":https://ably.com/blog/tutorial-vuejs-nodejs-azure-static-web-apps
