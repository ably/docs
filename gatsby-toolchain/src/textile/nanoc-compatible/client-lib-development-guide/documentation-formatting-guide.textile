...
First Company's docs ID, as used in '/data/yaml/compare.yaml': {{COMPANY_ID_0}}
...
Compare pages make use of the @/data/yaml/compare.yaml@ file to automatically generate content. This yaml contains company information, and comparison points between all the companies organized under certain categories (i.e. Interoperability).
...
* You can add an additional piece of help at the end of a step by using the following custom block
