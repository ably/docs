...
# "Ensure you are still logged into your app dashboard":https://support.ably.com/support/solutions/articles/3000030053-how-do-i-access-my-app-dashboard and navigate back to the app dashboard you used to provision your queue.
...
And then run the demo locally by adding your "Ably API key":https://support.ably.com/support/solutions/articles/3000030502-setting-up-and-managing-api-keys and Neutrino User ID and API Key to @server.js@, setting up the queues and queue rules as described in this tutorial and running the demo @node server.js@
