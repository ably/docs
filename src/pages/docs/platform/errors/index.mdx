...
* The [Dev console](/docs/platform/account/app/dev-console) in your Ably dashboard is a quick and easy way to inspect errors and events, especially during development or debugging.
...
The [Dev console](/docs/platform/account/app/dev-console) in your Ably dashboard is a quick and easy way to inspect errors. It provides a live stream of all events in your application, which is especially useful during early-stage development or low-traffic periods when events are easier to track:
