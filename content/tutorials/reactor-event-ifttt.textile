...
The game publishes game move "commands" to an Ably channel using the "Ably Realtime API":/api/realtime-sdk. Take a look at the *ablyConnector.js* file in the root, you'll see some code like this:
