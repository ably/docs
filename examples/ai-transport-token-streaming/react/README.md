...
Token streaming is implemented using [Ably AI Transport](/docs/products/ai-transport). AI Transport provides purpose-built APIs for real-time AI applications, offering reliable message delivery, automatic ordering, and seamless reconnection handling to ensure no tokens are lost during network interruptions.

## Resources

Use the following components to implement AI Transport token streaming:

- [`AblyProvider`](/docs/getting-started/react-hooks#ably-provider): initializes and manages a shared Ably client instance, passing it down through React context to enable real-time AI Transport functionality across the application.
...
Find out more about [AI Transport](/docs/products/ai-transport) and [message history](/docs/channels/history).
...
7. Try it out by opening [http://localhost:5173/](http://localhost:5173/) with your browser and selecting a prompt to see real-time AI token streaming.
