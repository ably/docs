...
* See [global round-trip latency statistics](/docs/platform/architecture/latency#latency-metrics) measured externally by Uptrends.
...
Use the Ably [Chat](/docs/chat) SDKs to build live chat components in your applications. It provides a set of purpose-built APIs to manage features such as rooms and messages, users' online status, [typing indicators](/docs/chat/rooms/typing), and [room-level reactions](/docs/chat/rooms/reactions).
...
Spaces is effective when building features such as interactive whiteboards, [avatar stacks](/docs/spaces/avatar), and displaying and [locking elements](/docs/spaces/locking) on a page, such as a cell in a spreadsheet, or a slide in a slideshow presentation.
