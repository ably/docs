...
Errors can occur in various scenarios when using Ably, such as invalid inputs in requests, authentication issues, or connection problems caused by network disruptions. Proper error handling is essential for building a reliable application and troubleshooting.

You can handle errors in your Ably-supported app using the following:
...
The "Dev console":/docs/account/app/console, accessible from your "Ably dashboard":https://ably.com/accounts/any, is a tool for inspecting and debugging realtime errors. It provides a live stream of all events in your application, which is especially useful during early-stage development or low-traffic periods when events are easier to track:
