...
intro: "Build collaborative applications with conflict-free LiveObjects data structures and automatic state synchronization. This guide covers SDK installation, authentication, and implementing shared objects."
meta_description: "Get started with Ably LiveObjects in JavaScript: build collaborative apps with conflict-free data structures and automatic state synchronization."
redirect_from:
