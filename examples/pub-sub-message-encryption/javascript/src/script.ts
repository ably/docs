...
async function encryptedMessages() {
  document.getElementById('title').textContent = 'Public channel without encryption key';
...
async function decryptedMessages() {
  document.getElementById('title').textContent = 'Public channel with encryption key';
...
function initializeMessagingMode() {
