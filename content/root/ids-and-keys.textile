...
In the "Ably dashboard":https://ably.com/accounts/any select the app you want to find the aspp ID for. Click on the 'Settings' tab:
...
API keys should be kept secret and only shared with trusted parties. 
