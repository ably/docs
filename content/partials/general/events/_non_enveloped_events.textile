...
- x-ably-message-name := The "name":/api/realtime-sdk/message#name of the @Message@

The payload will contain the "data":/api/realtime-sdk/message#data of the @Message@.
