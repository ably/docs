...
See the "queues documentation":/integrations/queues and "Wikipedia":https://en.wikipedia.org/wiki/Advanced_Message_Queuing_Protocol for further information.
...
See the "batch request documentation":/messages/batch#batch-publish for further information.
...
See the "channels documentation":/channels for further information.
...
See the "channel namespace documentation":/channels#namespaces for further information.
...
See the "connection documentation":/connect for further information.
...
See the "Control API documentation":/account/control-api for further information.
...
See the "dead letter queue documentation":/integrations/queues#deadletter for further information.
...
See the "delta compression documentation":/channels/options/deltas for further information.
...
See the "idempotent messages documentation":/pub-sub/advanced#idempotency for further information.
...
See the "inband channel occupancy documentation":/presence-occupancy/occupancy for further information.
...
See the "Kinesis rule documentation":/integrations/streaming/kinesis for more information.

h2(#lambda). Lambda

Lambda is an event-driven serverless service provided by Amazon Web Services that allows users to easily run code when specified conditions are met. You can set up Ably "Webhooks":/integrations/webhooks to trigger Lambda functions when events occur.

See the "Lambda documentation":/integrations/webhooks/lambda for more information.
...
See the "messages documentation":/channels/messages for further information.
...
See the "metachannels documentation":/metadata-stats/metadata/subscribe for further information.
...
See the "MQTT Adapter documentation":/protocols/mqtt for further information.
...
See the "occupancy documentation":/presence-occupancy/occupancy for further information.
...
See the "presence documentation":/presence-occupancy/presence for further information.
...
See the "push notification documentation":/push for further information.
...
See the "queues documentation":/integrations/queues for further information.
...
See the "available SDKs":/sdks for further information on the realtime interface and the languages and platforms supported by the SDKs.

h2(#rest). REST interface

The REST interface of an Ably SDK communicates with the Ably service using the HTTP protocol and is effectively stateless. The REST interface provides a convenient way to access the "REST HTTP API":/api/rest-api and is intended to be used by clients that don't require realtime updates.

See the "available SDKs":/sdks for further information on the REST interface and the languages and platforms supported by the SDKs.
...
See the "Rewind documentation":/channels/options/rewind for further information.
...
See the "SQS rule documentation":/integrations/streaming/sqs for more information.
...
See the "queues documentation":/integrations/queues and "Wikipedia":https://en.wikipedia.org/wiki/Streaming_Text_Oriented_Messaging_Protocol for further information.
...
See the "incoming webhook documentation":/integrations/inbound/webhooks and "outbound webhook documentation":/integrations/webhooks for further information.
