...
To demonstrate these concepts, we're going to build a simple app that keeps track of users as they join an Ably channel. "You can see the full code for this demo on github":https://github.com/ably/tutorials/tree/tutorial-p2p-vue/p2p-vue-demo
...
This app will use "Ably Channels":https://www.ably.io/channels and "Token Authentication":https://www.ably.io/documentation/rest/authentication/#token-authentication.

h2. Making sure we send consistent messages by wrapping our Ably client
...
h2. Resilience - what happens if we disconnect?
...
h2. Yay, the end, but there's more
...
h2. Running the demo on your machine
