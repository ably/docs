...
6. Install [Node.js](https://nodejs.org/en) version 16 or greater.

7. Create a new project in your IDE and install the Ably Pub/Sub JavaScript SDK:
...
8. Create a `.env` file in your project root and add your API key:
...
Replace `{{API_KEY}}` with your actual API key from step 2, and add `.env` to your `.gitignore` file to avoid committing your API key to version control.
</Aside>
