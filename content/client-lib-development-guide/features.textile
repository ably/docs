...
** @(RSA17a)@ Revokes tokens based on provided function arguments. It internally creates request for  "REST revokeTokens endpoint":/rest-api/#revokeTokens and handles the response.
