...
Use Ably's "Firehose":/docs/integrations/continuous-streaming/firehose#firehose-rules Pulsar rule if you want to send "data":/docs/integrations/continuous-streaming/firehoset#data-sources such as messages, occupancy, lifecycle and presence events from Ably to Pulsar.
...
|_. Section                                                        |_. Purpose                                                                                              |
|"Source":/docs/integrations/continuous-streaming/firehose#data-sources |Defines the type of event to deliver.                                                                   |
