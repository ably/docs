...
This private connection key can also be used by other REST clients to publish on behalf of this client. See the "publishing over REST on behalf of a realtime client documentation":/api/rest-sdk/channels#publish-on-behalf  for more info.
