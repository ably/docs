  ...
  return (
    <div className="flex justify-center items-center min-h-screen p-4">
      <div className="w-1/2 h-1/2 flex flex-col space-y-4">
        <h2 className="text-xl font-bold text-center mb-4">Public channel with encryption key</h2>
...
function DecodedMessages() {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen p-4">
      <div className="w-1/2 h-1/2 flex flex-col space-y-4">
        <h2 className="text-xl font-bold text-center mb-4">Public channel without encryption key</h2>
        <div className="flex space-x-2">
          <input
            type="text"
            value={message}
