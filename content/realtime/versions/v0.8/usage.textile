...
A reference to the "@Channel@":/realtime/channels/overview collection instance for this library indexed by the channel name. See "channels":/realtime/channels/overview and "messages":/realtime/messages for more information.
