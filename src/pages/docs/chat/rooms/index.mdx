...
<If lang="javascript,swift,kotlin">
When you create or retrieve a room using `rooms.get()`, you can provide custom configuration for some features for that room by passing a <If lang="javascript">[`RoomOptions`](/docs/sdk/chat-js/v0/interfaces/chat-js.RoomOptions.html)</If><If lang="swift">[`RoomOptions`](/docs/sdk/chat-swift/v0/roomoptions)</If><If lang="kotlin">[`RoomOptions`](/docs/sdk/chat-kotlin/v0/chat-android/com.ably.chat/-room-options/index.html)</If> object as the second argument. If you do not provide a `RoomOptions` object, the default settings will be used.
...
<If lang="javascript,swift,kotlin">
Once <If lang="javascript">[`rooms.release()`](/docs/sdk/chat-js/v0/interfaces/chat-js.Rooms.html#release)</If><If lang="swift">[`rooms.release()`](/docs/sdk/chat-swift/v0/rooms/release%28roomid%3A%29)</If><If lang="kotlin">[`rooms.release()`](/docs/sdk/chat-kotlin/v0/chat-android/com.ably.chat/-rooms/release.html)</If> has been called, the room will be unusable and a new instance will need to be created using [`rooms.get()`](#create) if you want to reuse it.
...
Use the <If lang="javascript">[`attach()`](/docs/sdk/chat-js/v0/interfaces/chat-js.Room.html#attach)</If><If lang="swift">[`attach()`](/docs/sdk/chat-swift/v0/room/attach%28%29)</If><If lang="kotlin">[`attach()`](/docs/sdk/chat-kotlin/v0/chat-android/com.ably.chat/-room/attach.html)</If> method on a room to attach to it:
</If>
...
<If lang="javascript,swift,kotlin">
Use the <If lang="javascript">[`detach()`](/docs/sdk/chat-js/v0/interfaces/chat-js.Room.html#detach)</If><If lang="swift">[`detach()`](/docs/sdk/chat-swift/v0/room/detach%28%29)</If><If lang="kotlin">[`detach()`](/docs/sdk/chat-kotlin/v0/chat-android/com.ably.chat/-room/detach.html)</If> method on a room to detach from it and stop receiving messages and events:
...
<If lang="javascript,swift,kotlin">
Use the <If lang="javascript">[`status`](/docs/sdk/chat-js/v0/interfaces/chat-js.Room.html#status)</If><If lang="swift">[`status`](/docs/sdk/chat-swift/v0/roomstatus)</If><If lang="kotlin">[`status`](/docs/sdk/chat-kotlin/v0/chat-android/com.ably.chat/-room/status.html)</If> property to check which status a room is currently in:
</If>
...
Use the <If lang="javascript">[`room.onStatusChange()`](/docs/sdk/chat-js/v0/interfaces/chat-js.Room.html#onStatusChange)</If><If lang="swift">[`room.onStatusChange()`](/docs/sdk/chat-swift/v0/room/onstatuschange%28%29-s9g)</If><If lang="kotlin">[`room.onStatusChange()`](/docs/sdk/chat-kotlin/v0/chat-android/com.ably.chat/-room/on-status-change.html)</If> method in a room to register a listener for status change updates:
