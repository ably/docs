...
Applications maintain their state during disruptions. All messages are received in correct order with no message loss. [Learn how Ably identifies and recovers messages](/docs/platform/architecture/connection-recovery#message-identification-with-timeserial).
</Aside>
