...
It can also be set to skip only specific rules. The rule id can be found alongside the rule on the integrations tab, as an output value from Ably's Terraform provider, or as part of the message envelope that is delivered to the integration.
