...
blang[jsall].
  ...
  Returns a promise. On success, the promise is fulfilled with the generated key as <span lang=javascript>an @ArrayBuffer@</span><span lang=nodejs>a @Buffer@</span>. On failure, the promise is rejected with an "@ErrorInfo@":/docs/api/rest-sdk/types#error-info object that details the reason why it was rejected.
