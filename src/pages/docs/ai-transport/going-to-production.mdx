...
See [Set up authentication](/docs/ai-transport/getting-started/authentication) for the recipes and [authentication concept](/docs/ai-transport/concepts/authentication) for the model.
...
- [Set up authentication](/docs/ai-transport/getting-started/authentication): the practical auth setup.
- [Authentication concept](/docs/ai-transport/concepts/authentication): the three-layer model and capability reference.
