...
Ably achieves a global median message delivery latency of 37ms, ensuring typing indicators appear instantly as users type. [See evidence](/docs/platform/architecture/latency#how-latency-is-measured).
</Aside>
