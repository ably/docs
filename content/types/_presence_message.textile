...
- <div lang="java">extras</div> := Metadata and/or ancillary payloads, if provided<br>__Type: @JSONObject@, @JSONArray@__
- <div lang="csharp">Extras</div> := Metadata and/or ancillary payloads, if provided<br>__Type: plain C# object that can be converted to Json__
- <div lang="jsall">extras</div> := Metadata and/or ancillary payloads, if provided<br>__Type: @JSON Object@__
- <div lang="ruby">extras</div> := Metadata and/or ancillary payloads, if provided<br>__Type: @Hash@, @Array@__
- <div lang="python">extras</div> := Metadata and/or ancillary payloads, if provided<br>__Type: @Dict@, @List@__
- <div lang="swift">extras</div> := Metadata and/or ancillary payloads, if provided<br>__Type: @Dictionary@, @Array@__
- <div lang="objc">extras</div> := Metadata and/or ancillary payloads, if provided<br>__Type: @NSDictionary *@, @NSArray *@__
- <div lang="php">extras</div> := Metadata and/or ancillary payloads, if provided<br>__Type: @Associative Array@, @Array@__
