...
<%= partial partial_version('shared/_events_examples_intro') %>

h3(#batch-examples). Batched event payloads

<%= partial partial_version('shared/_batched_event_headers') %>

<%= partial partial_version('shared/_batched_events') %>

h3(#envelope-examples). Enveloped event payloads

<%= partial partial_version('shared/_enveloped_event_headers') %>

<%= partial partial_version('shared/_enveloped_events') %>

h3(#no-envelope-examples). Non-enveloped event payloads

<%= partial partial_version('shared/_non_enveloped_event_headers') %>

<%= partial partial_version('shared/_non_enveloped_events') %>
