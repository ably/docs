...
bq(definition#on-state-listener).
  default: on(state, listener("ConnectionStateChange":#connection-state-change stateChange))
  ruby:    on(*state) -> yields "ConnectionStateChange":#connection-state-change
  java:    public void on("ConnectionState":#connection-state state, "ConnectionStateListener":#connection-state-listener listener)

Register the given listener <span lang="ruby">block</span> for the specified "ConnectionState":#connection-state <span lang="default">@state@</span><span lang="ruby">@state(s)@</span><span lang="java">@state@</span> changes on the @Connection@. The listener is passed a "ConnectionStateChange":#connection-state-change object that contains the current state, previous state, and an optional reason for the state change.</span>
...
Register the given listener <span lang="ruby">block</span> for all "ConnectionState":#connection-state changes on the @Connection@. The listener is passed a "ConnectionStateChange":#connection-state-change object that contains the current state, previous state, and an optional reason for the state change.</span>
...
- <div lang="jsall">listener</div> := is a function of the form @listener(stateChange)@ to be notified for matching state changes
...
bq(definition#once-state-listener).
  default: once(state, listener("ConnectionStateChange":#connection-state-change stateChange))
  ruby:    once(*state) -> yields "ConnectionStateChange":#connection-state-change
  java:    public void once("ConnectionState":#connection-state state, "ConnectionStateListener":#connection-state-listener listener)

Register the given listener <span lang="ruby">block</span> for a single occurence of the specified "ConnectionState":#connection-state <span lang="default">@state@</span><span lang="ruby">@state(s)@</span><span lang="java">@state@</span> change on the @Connection@. Once the listener has been called, it is removed as a registered listener and will not be called again. The listener is passed a "ConnectionStateChange":#connection-state-change object that contains the current state, previous state, and an optional reason for the state change.
...
- <div lang="jsall">listener</div> := is a function of the form @listener(stateChange)@ to be notified for a single occurence of a matching state change
