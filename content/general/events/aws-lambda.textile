...
At present, it is not possible to "batch":/general/events#batching messages to AWS Lambda Functions, nor can messages be "encoded":/general/events#encoding in anything besides JSON.
