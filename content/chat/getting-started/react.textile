...
Ensure you import tailwind in your local App.CSS file and add it to your Vite config.
For installation instructions, see the "Tailwind CSS documentation for Vite":https://tailwindcss.com/docs/guides/vite.
...
The "AblyProvider":/docs/getting-started/react#ably-provider and "ChatClientProvider":https://sdk.ably.com/builds/ably/ably-chat-js/main/typedoc/functions/chat-react.ChatClientProvider.html
...
This enables them to send and receive messages in realtime across channels. This hook must be nested within a @ChatClientProvider@.
...
<aside data-type='note'>
<p>Provider@ is required when working with any other hooks exposed by the Chat SDK, such as the "useMessages":https://sdk.ably.com/builds/ably/ably-chat-js/main/typedoc/functions/chat-react.useMessages.html hook.</p>
</aside>
