...
meta_description: "How clients can use token authentication and how to issue tokens with correct permissions on the server."
...
7. Gain a good technical "overview of how the Ably realtime platform works":https://ably.com/documentation/key-concepts
