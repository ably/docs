---
title: Types
intro: "Define data structures, configuration options, and callback interfaces used throughout the Realtime SDK. The Types reference enables proper integration, type safety, and interface consistency across SDK operations."
