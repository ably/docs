...
The examples use [basic authentication](/docs/platform/auth/basic) to demonstrate usage for convenience. In your own applications, basic authentication should never be used on the client-side as it exposes your Ably API key. Instead use [token authentication.](/docs/platform/auth/token)
</Aside>
