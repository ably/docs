...
![Access token management interface](../../../../images/content/screenshots/dash/access-token.png)
...
![Access token creation dialog](../../../../images/content/screenshots/dash/access-token-set.png)
