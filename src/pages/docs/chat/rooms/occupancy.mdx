...
Use the <If lang="javascript">[`occupancy.get()`](/docs/sdk/chat-js/v0/interfaces/chat-js.Occupancy.html#get)</If><If lang="swift">[`occupancy.get()`](/docs/sdk/chat-swift/v0/documentation/ablychat/occupancy/get%28%29)</If><If lang="kotlin">[`occupancy.get()`](/docs/sdk/chat-kotlin/v0/-occupancy/get.html)</If> method to retrieve the occupancy of a room:
