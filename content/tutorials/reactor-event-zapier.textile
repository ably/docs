...
We'll use "Ably's MQTT adapter":/mqtt to communicate with the IoT device and Zapier to send messages to Slack. "Ably Integrations":/general/integrations provide a way to trigger events and to stream data from Ably's pub/sub channels.
