...
bc[rt_javascript]. // For the full code sample see here: https://github.com/ably/quickstart-js
let ably = new Ably.Realtime.Promise('{{API_KEY}}');
await ably.connection.once('connected');
console.log('Connected to Ably!');

bc[rt_nodejs]. // For the full code sample see here: https://github.com/ably/quickstart-js
const ably = new Ably.Realtime.Promise('{{API_KEY}}');
await ably.connection.once('connected');
console.log('Connected to Ably!');
...
bc[rt_ruby]. EventMachine.run do -
  foo = bar
