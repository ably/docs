...
## Why the edge network matters {#why-matters}
...
## Edge network architecture {#architecture}
...
### Global deployment across multiple regions {#global-deployment}
...
### AWS CloudFront and network load balancers {#cloudfront-nlb}
...
### DNS organization and latency-based routing {#dns-routing}
...
### Fallback endpoints and secondary domains {#fallback-endpoints}
...
### Protocol-level resilience {#protocol-resilience}
...
### Infrastructure redundancy {#redundancy}
...
## Protection against denial of service attacks {#dos-protection}
...
### Layer 3/4 DoS protection with AWS Shield Advanced {#shield-advanced}
...
### Layer 7 protection with CloudFront WAF {#waf}
...
### Scalable infrastructure for absorbing traffic spikes {#traffic-scaling}
...
## Global connectivity considerations {#global-connectivity}
...
### Geographic coverage and edge presence {#geographic-coverage}
...
### Protocol support and transport optimization {#protocol-support}
...
### Handling network transitions and interruptions {#network-transitions}
...
## Operational monitoring and management {#monitoring}
...
### Health monitoring and alerting {#health-monitoring}
