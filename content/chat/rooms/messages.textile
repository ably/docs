...
```sh
  curl 'https://rest.ably.io/chat/v2/rooms/<roomId>/messages?envelope=json' \
    -H 'X-Ably-ClientId: <your-client-id>' \
    -H 'X-Ably-Version: 3' \
...
For the request parameters, the following need to be provided:

|_. Parameter |_. Description |_. Type |
| roomId | The unique identifier of the room you wish to send a message to. | String |
| envelope | The format of the response; either @json@ or @msgpack@. | String |
| X-Ably-ClientId | The unique identifier of the client making the request. | String |
| X-Ably-Version | The version of the Ably API to use. Current latest version is @3@. | Number |
| authorization | The token to authenticate the request, see "Generate a token":/docs/auth/token for more information. | String |
...
|_. Parameter |_. Description |_. Type |
| roomId | The unique identifier of the room you in which the message for update belongs. This should be URI encoded | String |
...
|_. Parameter |_. Description |_. Type |
| roomId | The unique identifier of the room you wish to query history for. This should be URI encoded | String |
