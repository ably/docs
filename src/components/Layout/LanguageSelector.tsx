...
import { useLayoutContext, FE_LANGUAGES, BE_LANGUAGES } from 'src/contexts/layout-context';
  ...
  return (
    ...
    >
      <DualLanguageDropdown
        label="Client"
        paramName="fe_lang"
        languages={FE_LANGUAGES}
        selectedLanguage={activePage.feLanguage ?? null}
      />
      <DualLanguageDropdown
        label="Agent"
        paramName="be_lang"
        languages={BE_LANGUAGES}
        selectedLanguage={activePage.beLanguage ?? null}
      />
    </div>
  );
};
