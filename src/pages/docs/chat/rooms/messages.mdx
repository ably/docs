...
<If lang="javascript,swift,kotlin">
Use the <If lang="javascript">[`messages.subscribe()`](/docs/sdk/chat-js/v0/interfaces/chat-js.Messages.html#subscribe)</If><If lang="swift">[`messages.subscribe()`](https://sdk.ably.com/builds/ably/ably-chat-swift/main/AblyChat/documentation/ablychat/messages/subscribe%28%29-8jolq)</If><If lang="kotlin">[`messages.subscribe()`](/docs/sdk/chat-kotlin/v0/-messages/subscribe.html)</If> method to receive messages in a room. To filter for updated messages, provide a listener that checks the <If lang="javascript,kotlin">`type`</If><If lang="swift">`action`</If> property of the message event:
</If>
...
<If lang="javascript,swift,kotlin">
Use the <If lang="javascript">[`messages.subscribe()`](/docs/sdk/chat-js/v0/interfaces/chat-js.Messages.html#subscribe)</If><If lang="swift">[`messages.subscribe()`](https://sdk.ably.com/builds/ably/ably-chat-swift/main/AblyChat/documentation/ablychat/messages/subscribe%28%29-8jolq)</If><If lang="kotlin">[`messages.subscribe()`](/docs/sdk/chat-kotlin/v0/-messages/subscribe.html)</If> method to receive messages in a room. To filter for deleted messages, provide a listener that checks the <If lang="javascript,kotlin">`type`</If><If lang="swift">`action`</If> property of the message event:
</If>
