...
redirect_from:
  - /api/versions/v1.1/rest-sdk/encryption
  - /api/versions/v1.0/rest-sdk/encryption
  - /api/versions/v0.8/rest-sdk/encryption
---
...
You will rarely need to call this yourself, since the client library will handle it for you if you specify @cipher@ params when initializing a channel (as in the example "at the top":/channels/options/encryption)<span lang="jsall"> or when setting channel options with @channel#setOptions@</span>.
