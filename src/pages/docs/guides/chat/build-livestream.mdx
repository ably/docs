...
Ably automatically handles millions of concurrent chat connections, managing all websocket servers, failover, and scaling for you. [See evidence](/docs/platform/architecture/scalability).
</Aside>
