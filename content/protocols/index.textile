---
title: Protocols
meta_description: "Clients can use the Ably network protocol adapters. This is especially useful where an Ably Client Library SDK is not available for your language of choice, or where platform resource constraints prohibit use of a Client Library SDK."
---

Ably Client Library SDKs are the recommended method for connecting to Ably because they offer support for a comprehensive set of Ably features, such as automatic "connection management":/connect, "authentication token renewal":/auth/token and "presence":/presence-occupancy.
...
Ably has a number of fully supported adapters:
