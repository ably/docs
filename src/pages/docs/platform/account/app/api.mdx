---
title: API keys
intro: API key management enables secure access control for your Ably applications through customizable permissions and resource restrictions. Create keys with specific capabilities, set channel access rules, and implement revocable tokens for enhanced security.
