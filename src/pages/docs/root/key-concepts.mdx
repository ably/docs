...
![Channel concept diagram](../../../images/content/diagrams/How-ably-works.png)
...
![Ably Integrations diagram](../../../images/content/diagrams/Ably-Reactor.png)
...
![Ably TokenRequest from your server concept diagram](../../../images/content/diagrams/Ably-token-auth-1.png)
...
![Ably JWT from your server concept diagram](../../../images/content/diagrams/Ably-Auth-Overview2.png)

##### Client identity and access control <a id="client-identity"/>
...
### Global message routing <a id="global-message-routing"/>
...
![Global routing diagram](../../../images/content/diagrams/Ably-Global-Message-Routing.png)
...
![Ably redundancy diagram](../../../images/content/diagrams/Ablys-redundancy.png)
...
| **[Multiple availability zones](https://ably.com/network)** | In every region our data is replicated between servers in at least two independent datacenters ensuring outages in one datacenter cannot cause data loss |
...
### Security and Encryption <a id="security-and-encryption"/>
...
### Any internet enabled device support <a id="any-internet-device"/>
