...
| *Messages (billable)* | Number of messages that were billable. |
| *Messages published (REST & Realtime)* | Number of messages sent in REST & Realtime. |
| *Messages received (Realtime)* | Number of messages received in realtime. |
| *Messages persisted (history)* | Number of messages retrieved from history. |
| *Presence events (REST & Realtime)* | Number of messages persisted to history in REST & Realtime. |
| *Presence events (REST & Realtime)* | Number of presence-related events in REST & Realtime. |
| *Webhook / Function* | Usage related to webhooks or functions. |
| *Ably Queue* | Usage of Ably queue services. |
| *Firehose* | Number of messages related to the Firehose service. |
