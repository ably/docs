...
- <span lang="default">force</span><span lang="csharp">Force</span><span lang="ruby">:force</span><span lang="python">force</span> := _false_ When true, this indicates to <span lang="default">"@authorise@":/realtime/authentication#authorise</span><span lang="csharp">Authorise</span> that a new token should be requested, even if the current token is still valid<br>__Type: @Boolean@__
