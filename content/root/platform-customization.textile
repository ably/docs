...
Ably can run a dedicated cluster on behalf of our Enterprise customers, or if required, directly on instances provided to us by our customers using their Amazon EC2 account.
...
If you are interested in applying processing or storage restraints to regions other than Europe or the US, then please speak to your customer success manager.
