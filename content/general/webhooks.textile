...
<a href="/images/diagrams/webhooks-overview.png" target="_blank">
  <img src="/images/diagrams/webhooks-overview.png" style="width: 100%" alt="Ably Webhooks Overview">
</a>
...
- channel.lifecycle := If the source @channel.lifecycle@ is selected, you receive notifications of "channel lifecycle events":/channels#attach, such as when a channel is created (following the first client attaching to this channel) or discarded (when there are no more clients attached to the channel).
