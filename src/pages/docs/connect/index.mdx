...
* Connection state is preserved for 2 minutes if the connection is not explicitly closed.
...
If you need predictable connection closure behavior, consider these options:
