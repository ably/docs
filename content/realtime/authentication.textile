...
meta_description: "Authentication of Ably clients can be achieved using Basic Authentication or Token Authentication."
meta_keywords: "Authentication, Basic Auth, Basic Authentication, JWT, Token Auth, TokenRequest"
section: realtime
index: 40
languages:
  - javascript
...
* See "Authentication API Reference - Realtime":/realtime/realtime-api-reference#auth-api
* See "Authentication API Reference - REST":/rest/rest-api-reference#auth-api
