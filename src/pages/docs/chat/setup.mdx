...
<If lang="react">
Pass the `ChatClient` into the [`ChatClientProvider`](/docs/sdk/chat-react/v0/functions/chat-react.ChatClientProvider.html). The `ChatClient` instance will be available to all child components in your React component tree.
</If>
