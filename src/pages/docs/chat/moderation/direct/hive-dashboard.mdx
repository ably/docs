...
5. Set the "Endpoint URL" field to `https://rest.ably.io/chat/v2/moderation/hive/delete` (if you have a [dedicated cluster](https://ably.com/docs/platform/account/enterprise-customization#setting-up-a-custom-environment) the domain should be your custom REST domain)
