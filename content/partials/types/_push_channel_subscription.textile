An @PushChannelSubscription@ is a type encapsulating the subscription of a device or group of devices sharing a "client identifier":/auth/identified-clients to a channel in order to receive push notifications.
...
- <span lang="default">clientId</span><span lang="ruby">client_id</span> := devices with this "client identifier":/auth/identified-clients are included in this channel subscription. When present, <span lang="default">@deviceId@</span><span lang="ruby">@device_id@</span> is never present<br>__Type: @String@__
...
A static factory method to create a @PushChannelSubscription@ object for a channel and group of devices sharing a "client identifier":/auth/identified-clients.

h4. Parameters

- channel := channel name linked to this push channel subscription<br>__Type: @String@__
- <span lang="default">clientId</span><span lang="ruby">client_id</span> := devices with this "client identifier":/auth/identified-clients are included in the new push channel subscription<br>__Type: @String@__
