...
The `Auth` interface is responsible for managing tokens and [authentication](/docs/auth) for an Ably client. Access it via the `auth` property of a [`Rest`](/docs/pub-sub/api/javascript/rest/rest-client) client instance.
