...
** @(RSA17c)@ If the @TokenRevocationRequest#targets@ attribute is null or empty (as per @TF3@), then the function must throw an error with a @"targets cannot be null or empty"@ message.
...
*** @(RSA17g2)@ Given a null or empty @TokenRevocationRequest#targets@ attribute, verify that the function throws an error with a @"targets cannot be null or empty"@ message.
*** @(RSA17g3)@ Given a non-null @TokenRevocationRequest#key@ attribute and a valid @TokenRevocationRequest#targets@ attribute, verify that the function creates the request and executes it.
*** @(RSA17g4)@ Given a non-null but invalid @TokenRevocationRequest#key@ attribute and a valid @TokenRevocationRequest#targets@ attribute, verify that client library throws an API error.
*** @(RSA17g5)@ Given a valid @TokenRevocationRequest#key@ attribute and a valid @TokenRevocationRequest#targets@ attribute, verify that the function executes the request and returns a @TokenRevocationResponse@ with targets matching with the original targets in request.
*** @(RSA17g6)@ Given valid required attributes in @TokenRevocationRequest@ and a timestamp in the future for @TokenRevocationRequest#issuedBefore@ attribute, verify that the request is rejected. 
*** @(RSA17g7)@ Given valid required attributes in @TokenRevocationRequest@ and a timestamp in the past > 1 hour for @TokenRevocationRequest#issuedBefore@ attribute, verify that the request is rejected. 
