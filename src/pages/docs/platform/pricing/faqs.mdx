...
Data in transit is stored ephemerally (not on disk) in all 16+ data centres [globally](https://ably.com/network). Each region can have two or more data centres.
