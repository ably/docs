...
"View our client library SDKs feature support matrix":https://ably.io/download/sdk-feature-support-matrix to see the list of all the available features.
...
bq(definition).
  ...
  go:       NewRestClient(keyOrTokenId string) (&ast;RestClient, error)
...
bq(definition).
  ...
  go:       NewRestClient(opts &ast;"ClientOptions":#client-options) (&ast;RestClient, error)
...
bq(definition).
  ...
  go:         (c &ast;RestClient) Time() (time.Time, "error":/rest/types#error-info)
