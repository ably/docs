...
* *Postgres and Models SDK*: sync data models to frontend clients directly from your Postgres database in realtime. Comes with built in optimistic updates, and hooks for intial load of you datamodel's data.
