...
## Channel namespaces <a id="channel-namespaces"/>
...
See the [Control API documentation](/docs/platform/account/control-api) for further information.
...
## Dead letter queue <a id="dead-letter"/>
...
## Delta compression <a id="delta-compression"/>
...
## Inband channel occupancy <a id="inband-occupancy"/>
...
## MQTT Adapter <a id="mqtt-adapter"/>
