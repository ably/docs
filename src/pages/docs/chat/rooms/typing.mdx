...
<If lang="javascript,swift,kotlin">
Use the <If lang="javascript">[`typing.current()`](/docs/sdk/chat-js/v0/interfaces/chat-js.Typing.html#get)</If><If lang="swift">[`typing.get()`](https://sdk.ably.com/builds/ably/ably-chat-swift/main/AblyChat/documentation/ablychat/typing/get%28%29)</If><If lang="kotlin">[`typing.get()`](/docs/sdk/chat-kotlin/v0/-typing/get.html)</If> method to retrieve a set of `clientId`s for all users that are currently typing in the room:
</If>
