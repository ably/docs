...
<Aside data-type='important'>
While using an API key is fine for this guide, you should never expose your API key in client-side code in production. Use [token authentication](/docs/platform/auth/token) in production to keep your API key secure on your server.
</Aside>
