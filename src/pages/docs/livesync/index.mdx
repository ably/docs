...
intro: "LiveSync synchronizes database changes to application clients at scale through realtime pub/sub channels. This system ensures ordered, reliable propagation of data updates while maintaining low latency and data integrity."
meta_description: "Ably LiveSync: synchronize database changes to application clients at scale with realtime pub/sub channels, ensuring ordered, reliable data updates."
redirect_from:
...
## Channel-based broadcasting <a id="channel-based-broadcasting"/>
