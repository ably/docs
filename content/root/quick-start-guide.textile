...
If you are using Ably on another platform, follow the package instructions from your chosen platform, see the "download page":https://www.ably.io/download.
...
bc[swift]. channel = ably.channels.get('quickstart')
channels.get('quickstart').publish('greeting', 'hello!')
