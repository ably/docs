...
blang[csharp].
  @IO.Ably.ChannelOptions@ may optionally be specified when instancing a "@Channel@":/realtime/channels-messages, and this may be used to specify channel-specific options.
