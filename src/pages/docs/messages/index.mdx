...
Applications maintain their state during disruptions. All messages are received in correct order with [no message loss](/docs/platform/architecture/connection-recovery#message-identification-with-timeserial).
</Aside>
