...
** @(RSA17e)@ Optional for languages that cannot enforce nullability in compile time: If any @TokenRevocationTarget@ in @targets@ parameter is invalid that is it either does not contain 'type' or 'value' or both, the function must respond with @"Invalid RevocationTarget in targets"@ message.
