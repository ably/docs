...
Consumption is calculated on the last day of the month and invoices are issued in arrears on the 1st of the following month. Note that for consumption, minutes are the smallest unit that we bill against. So if a connection was open for 10.01 minutes then this will be billed as 11 minutes of usage.
...
<p>If you have an "Enterprise contract":/pricing/enterprise with Ably, then contact your Customer Success Manager to discuss any details or queries you may have regarding your package.</p>
</aside>
