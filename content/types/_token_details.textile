...
- @expires@ := <span lang="default">The time (in millis since the epoch)</span><span lang="ruby">The time</span> at which this token expires<br>__Type: <span lang="default">Integer</span><span lang="java">Long Integer</span><span lang="ruby">Time</span>__
- @issued@ :=  <span lang="default">The time (in millis since the epoch)</span><span lang="ruby">The time</span> at which this token was issued<br>__Type: <span lang="default">Integer</span><span lang="java">Long Integer</span><span lang="ruby">Time</span>__
