...
| | `serial`: | Set to the serial of the update action. |
| | `timestamp`: | Set to the time the message was updated. |
| | `clientId`: | The client identifier of the user who performed the update. |
| | `description`: | Optional description provided in the update request. |
| | `metadata`: | Optional metadata provided in the update request. |
...
| version | Contains additional fields compared to `message.create` action: |
| | `serial`: | Set to the serial of the deletion action. |
| | `timestamp`: | Set to the time the message was deleted. |
| | `clientId`: | The client identifier of the user who performed the deletion. |
| | `description`: | Optional description provided in the delete request. |
| | `metadata`: | Optional metadata provided in the delete request. |
