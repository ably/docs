...
| metadata | Optional metadata associated with the reaction. For example, 'fireworks' might be passed to trigger a custom effect in the user's user interface. | Any |
