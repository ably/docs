...
h3. Channels in the Realtime API
...
Channels expose a @history@ method whereby a client can obtain message history. See the "history":/realtime/history documentation for details.
