...
bq(definition).
  ...
  csharp:  public static CipherParams GetDefaultParams(byte[] key = null, byte[] iv = null, CipherMode? mode = null)
...
bq(definition).
  ...
  csharp:  public static byte[] GenerateRandomKey(CipherMode? mode = null, int? keyLength = null)
