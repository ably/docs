...
intro: "Connection recovery is a core feature of Ably's platform, ensuring service continuity to clients during temporary network disruption. It provides reliable message delivery throughout periods of disruption and minimizes the impact on end-user experience."
