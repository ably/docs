...
- Intelligent routing := Ensuring that "requests are automatically serviced by an available datacenter":https://knowledge.ably.com/routing-around-network-and-dns-issues.
...
* If you want to consume realtime data from one or more of your servers, then we recommend you consider using our "Reactor Queues":/general/queues or "Reactor Firehose":/general/firehose. With the Reactor, you can consume realtime data in a robust, resilient and scalable way across multiple support protocols. "Find our more about the Ably Reactor":https://ably.com/integrations.
...
* If you want to use another realtime protocol such as MQTT or perhaps even one of our competitors' protocols, you should review "the realtime protocols we support with our Protocol Adapters":http://ably.com/protocols
