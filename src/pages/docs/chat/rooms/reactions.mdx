...
Use [server-side batching](/docs/messages/batch#server-side) to group high-frequency room reactions, minimizing message costs while ensuring all participants see reactions in realtime.
</Aside>
