...
See the "push admin publish documentation":/general/push/admin#publish for the client library API details, and the "raw push publish REST API documentation":/api/rest-api#push-publish for information on the underlying direct publishing endpoint used by the client libraries.
