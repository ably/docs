...
### API references generated from source code <a id="auto-generated" />
...
* [Java](https://ably.com/docs/sdk/java/v1.6/)
* [JavaScript](https://ably.com/docs/sdk/js/v2.21)
...
## SSE API <a id="sse-api" />

The [Ably Server-Sent Events API](/docs/api/sse), and raw HTTP streaming API, provide a way to get a realtime stream of events from Ably in circumstances where using a full Ably Pub/Sub client library, or even an MQTT library, is impractical due to resource constraints. HTTP streaming can be used where an SSE client is not supported.

## Control API <a id="control-api" />
