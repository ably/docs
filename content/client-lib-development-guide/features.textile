...
** @(RSA8a)@ Method signature is @revokeToken(TokenRevocationRequest)@.
** @(RSA18b)@ If the @TokenRevocationRequest#keys@ attribute is null or invalid (as per @TF2@ ), then the function must throw an error with a @"keys are invalid"@ message.
...
** @(RSA18d)@ If the @TokenRevocationRequest#keys@ and @TokenRevocationRequest#targets@ valid, then the function must create the request and execute it.
...
*** @(RSA18g1)@ Given a null @TokenRevocationRequest#keys@ attribute, verify that the function throws an error with a @"keys are invalid"@ message.
*** @(RSA18g2)@ Given an empty @TokenRevocationRequest#keys@ attribute, verify that the function throws an error with a @"keys are invalid"@ message.
