...
h3(#message-reactions). Message reactions

"Message reactions":/docs/chat/rooms/message-reactions enable users to add reactions to messages, such as 👍 or ❤. Others can see who reacted to the message. Message reactions can be added and removed.
