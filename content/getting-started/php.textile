...
To use this JWT for authenticating frontend clients, you would typically expose it through an API endpoint that your frontend application can call. For example, you might create an endpoint like @/auth/token@ that returns this JWT. Your frontend clients, a Javascript application in the example below, can then use this JWT when instantiating their Ably client:
