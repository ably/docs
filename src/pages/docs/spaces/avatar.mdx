---
title: Avatar stack
intro: Display the online status and profile information of members in your collaborative space. Show users who is currently active, recently left, or just joined with customizable avatar components and profile data.
