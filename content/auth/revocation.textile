...
Designating a revocation key for a token, or a group of tokens, enables the revocation process to be used at any level of granularity, depending on the needs of the application. To designate a revocation key, include the following additional claim:
