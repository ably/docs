...
In this tutorial, we will see how to use the "Ably Realtime client library":/realtime to build a realtime London Tube schedule clockface app for Fitbit. Ably enables realtime data sharing using Pub/Sub messaging architecture via a concept called "channels":https://ably.com/pub-sub-messaging.
...
And then run the app locally by adding your "Ably API key":https://knowledge.ably.com/setting-up-and-managing-api-keys and Google Map API key to @companion/index.js@ and run
