...
jump_to:
  ...
  Push API:
    ...
    - unsubscribe from channel#delete-channel-subscription
  Authentication API:
...
h3(#delete-device-registration). Unregister device for push notifications

h6. DELETE rest.ably.io/push/deviceRegistrations

Unregister device. All its subscriptions will be removed.
...
h3(#delete-channel-subscription). Unsubscribe from push notifications
