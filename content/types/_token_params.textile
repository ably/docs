...
- <span lang="default">capability</span><span lang="ruby">:capability</span> := JSON stringified capability of the token. If the token request is successful, the capability of the returned token will be the intersection of this capability with the capability of the issuing key.__Type: <span lang="default">@Function@</span><span lang="java">@TokenCallback@</span><span lang="ruby">@Proc@</span>__
