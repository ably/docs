...
In addition, note that since the metadata of various channels is prone to change very frequently, unless you have a special use case within your app, we recommend you to subscribe to the "Channel Metadata APIs":/realtime/channel-metadata realtime events rather than poll for updates via REST, as this is inefficient and data is still likely to become stale as soon as you have received it.
...
h2(#subscribing-to-metadata-events). Subscribing to Channel Metadata APIs realtime events
