...
See the "presence history documentation":/realtime/history/api/realtime-sdk/history#story for further details of the supported query parameters.
...
Further details of the supported @options@ params, see "presence history API documentation":/realtime/history/api/realtime-sdk/history#story.
