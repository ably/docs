---
title: Running the example apps
...
jump_to:
  Help with:
    - Running the example apps (Android)#android
    - See also#see-also
---
...
1. Download and install "Android Studio":https://developer.android.com/studio, if not already available.
...
<a href="/images/screenshots/asset-tracking/android/publishing-app.png" target="_blank">
  <img src="/images/screenshots/asset-tracking/android/publishing-app.png" style="width: 75%" alt="Select app to run and target">
</a>
