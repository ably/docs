---
title: Messages
intro: "Publish and receive realtime messages through channels with payload, metadata, and delivery information. The Messages API handles publishing, subscription, message processing, and encoding for live data exchange."
