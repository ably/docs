...
bq(definition).
  ...
  dotnet:  public Task<"PaginatedResult":/rest/types#paginated-result<"Stats":/rest/types#stats-type>> StatsAsync(@StatsDataRequestQuery@ query)
...
h3(#stats-granularity).
  ...
  dotnet:     IO.Ably.StatsGranularity
