...
Note that the 15 second delay from being removed from the presence set is only for abrupt or unplanned disconnects. If a client calls "@leave()@":#leave or "@close()@":/api/realtime-sdk/connection#close they immediately send a @leave@ event.
