---
title: Queues
intro: "Ably queues provide a way to consume realtime data using the AMQP or STOMP protocols."
...
The queues tab enables you to:

* Access a list of all your existing [queues](/docs/platform/integrations/queues).
