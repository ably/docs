...
To append to messages, clients need one of the following [capabilities](/docs/platform/auth/capabilities):

| Capability | Description |
| ---------- | ----------- |
| **message-update-own** | Can append to your own messages (more precisely, messages where the original publisher's `clientId` matches your `clientId`, where both are [identified](/docs/platform/auth/identified-clients)). |
