...
section: root
index: 10
meta_description: "A quickstart guide to learn the basics of integrating Ably."
meta_keywords: "quickstart, getting started, basics"
languages:
  - javascript
  - java
  - python
...
jump_to:
  Help with:
    - Add the Ably client library#step-1
...
blang[default].
  ...
  The codeblock below explicitly closes the realtime connection to Ably and prints the message @Closed the connection to Ably.@.

blang[python,php].
  The <span lang="python">Python</span><span lang="php">PHP</span> library is only available as a REST client. You will need to use one of the realtime libraries to create or manage a connection to Ably. Use the language selector above to change language.
...
* Find out more about the "realtime client library":/realtime.
* Find out more about the "REST client library":/rest.
