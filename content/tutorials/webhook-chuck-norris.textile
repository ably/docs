...
And then run the demo locally by adding your "Ably API key":https://knowledge.ably.com/setting-up-and-managing-api-keys-1 to @config/secrets.yml@, configuring the Webhook rules as described in this tutorial and running the demo @rails server@
