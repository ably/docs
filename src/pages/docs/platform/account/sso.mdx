...
Single sign-on (SSO) enables your users to authenticate via any SAML-compatible identity provider. Access your [organization settings](https://ably.com/accounts/any/organization) to configure SSO for your account.

![Single sign-on configuration showing SAML settings and identity provider options](../../../../images/content/screenshots/dash/sso-config-placeholder.png)
