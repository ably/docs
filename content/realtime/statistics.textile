...
bq(definition).
  ...
  java:    public "PaginatedResult":/realtime/types#paginated-result<"Stats":/realtime/types#stats-type> stats("Param":#param[] options)
  ...
  dotnet:  public Task<"PaginatedResult":/realtime/types#paginated-result<"Stats":/realtime/types#status>> StatsAsync("StatsDataRequestQuery":#statsdatarequest query)
...
h3(#stats-granularity).
  ...
  dotnet: StatsIntervalGranularity

<%= partial 'types/_stats_granularity' %>

h3(#statsdatarequest).
  dotnet: IO.Ably.StatsDataRequestQuery

blang[dotnet].
  <%= partial 'types/_data_request', indent: 2, skip_first_indent: true %>  
