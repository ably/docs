...
Rewind by time (@rewind=30s@) can only get messages at most 2 minutes old. So, if you specify @rewind=3m@, you will only get the last 2 minutes of history upon attaching.
