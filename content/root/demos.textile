...
<img src="/images/demos/depictit.png" style="width: 200px;" alt="Screenshot of Depict-it game">
...
A Realtime Multiplayer Space Invaders Game with Phaser 3 and Ably. This demo shows how to build a multiplayer game which runs in the browser with a central NodeJS server controlling the game state.
