...
- <span lang="default">token</span><span lang="csharp">Token</span> := The "Ably Token":/general/authentication#ably-tokens itself. A typical "Ably Token":/general/authentication#ably-tokens string may appear like @{{TOKEN}}@<br>__Type: @String@__
...
- <span lang="default">capability</span><span lang="csharp">Capability</span> :=  The capability associated with this "Ably Token":/general/authentication#ably-tokens. The capability is a a JSON stringified canonicalized representation of the resource paths and associated operations. "Read more about authentication and capabilities":/general/authentication/#capabilities-explained<br>__Type: <span lang="default">@String@</span><span lang="csharp">@Capability@</span>__
- <span lang="default">clientId</span><span lang="ruby,python">client_id</span><span lang="csharp">ClientId</span> := The client ID, if any, bound to this "Ably Token":/general/authentication#ably-tokens. If a client ID is included, then the "Ably Token":/general/authentication#ably-tokens authenticates its bearer as that client ID, and the "Ably Token":/general/authentication#ably-tokens may only be used to perform operations on behalf of that client ID. The client is then considered to be an "identified client":/general/authentication#identified-clients<br>__Type: @String@__
