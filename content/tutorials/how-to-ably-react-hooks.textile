...
Because you also have access to the Ably client library SDK from your call to @useChannel@, you can perform any other operations on the channel. For example, retrieving "channel history":/storage-history/storage:
