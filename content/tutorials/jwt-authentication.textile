...
In the @index.html@ file, instantiate the Ably client library with a "@ClientOptions@":/api/realtime-sdk/types#client-options object, passing in your authentication endpoint URL as the @authUrl@ property.
