...
| *History* | Allow permission to retrieve message and presence history. |
| *Presence* | Enable clients to register presence on a channel. |
| *Channel metadata* | Enable querying of channel metadata. |
| *Push admin and push-subscribe* | Allow management and subscription to push notifications. |
| *Statistics* | Enable access to usage statistics. |
| *Privileged headers* | Allow setting of privileged headers, such as skipping channel rules. |
