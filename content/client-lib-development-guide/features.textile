...
class PushChannel:
  ...
  getSubscriptions() => io PaginatedResult<PushChannelSubscription>
...
class PushDeviceRegistrations:
  ...
  get(transportIds: [(PushDeviceType, String)], state?: .Active | .Failed) -> io PaginatedResult<PushDeviceRegistration>device
...
class PushChannelSubscriptions:
  ...
  get(type: PushDeviceType, transportId: String, channelName: String?) => io PaginatedResult<PushChannelSubscription>
...
class PushChannelSubscription:
  constructor(transportType: DevicePushTransportType, transportId: String, channelName: String) -> PushChannelSubscription
  constructor(clientId: String, channelName: String) -> PushChannelSubscription
  transportType: DevicePushTransportType? // PCS1, PCS5, PCS6
  transportId: String? // PCS2, PCS5, PCS6
