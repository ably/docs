...
<If lang="javascript">
[LiveMap](/docs/liveobjects/map) is a key/value data structure similar to a JavaScript [Map](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Map):
</If>

<If lang="swift">
[LiveMap](/docs/liveobjects/map) is a key/value data structure similar to a swift `Dictionary`:
</If>

<If lang="java">
[LiveMap](/docs/liveobjects/map) is a key/value data structure similar to a java `Map`:
</If>
