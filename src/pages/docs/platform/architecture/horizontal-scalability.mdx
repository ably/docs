...
Vertical scaling has inherent limitations. There is a physical ceiling to how powerful a single machine can become, and costs increase more than linearly as you approach hardware limits. Even powerful machines still represent single points of failure, and the disruptive impact of failure or replacement events, as a fraction of overall capacity, is far higher.
