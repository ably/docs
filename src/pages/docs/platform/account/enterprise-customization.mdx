...
If you're an [Ably Enterprise](https://ably.com/pricing) customer, then you can optionally create a **custom endpoint** to tailor the Ably platform to your specific requirements. Contact your customer success manager through your [account dashboard](https://ably.com/accounts/any) to configure enterprise customization options. A custom endpoint enables you to benefit from the following:
...
### Decide whether to use an Ably subdomain, or your own domain <a id="decide-domain"/>
...
### Request a custom endpoint <a id="request-endpoint"/>
...
### Test the custom endpoint <a id="test-endpoint"/>
