...
<a href="/images/tutorials/file-transfer.gif" target="_blank">
  <img src="/images/tutorials/file-transfer.gif" style="width: 100%" alt="Demo image">
</a>
...
In our @sendMessage@ method, we use the @currentChat@ variable to figure out who it is that we are trying to send the file to. 
...
<iframe src="https://ablyfiletransfer.herokuapp.com/" height="400px" width="100%" ></iframe>
...
Please note that for the demo to work, the browser instances must be on the same IP address.
