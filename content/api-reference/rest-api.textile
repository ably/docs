...
This page provides a detailed API Reference for the Ably REST API. 

For information on how to use the REST API, and key concepts, refer to the "overview":/rest-api.

h2(#channel). Channel endpoints

API endpoints providing access to the messaging service within a channel scope.
...
h2(#application). Application endpoints

API endpoints providing access to the messaging service within an application scope.
