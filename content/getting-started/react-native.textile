...
h3(#prerequisites-create-project). Create a React Native project
...
If you'd like to open your project on the web, you also need to install the following required dependencies:

```[sh]
npx expo install react-dom react-native-web @expo/metro-runtime
```

Now replace the contents of @App.tsx@ with the following:
...
Then, update your @App@ component in the @App.tsx@ file to include the @ConnectionState@ component:
...
<aside data-type='note'>
<p>To run the React Native app in simulators, make sure your development environment is properly set up. Refer to the Expo documentation for guidance on configuring the "Android Emulator":https://docs.expo.dev/get-started/set-up-your-environment/?platform=android&device=simulated&mode=expo-go and the "iOS Simulator":https://docs.expo.dev/get-started/set-up-your-environment/?platform=ios&device=simulated&mode=expo-go.</p>
</aside>
