...
Ably automatically [recovers connections](/docs/platform/architecture/idempotency#connection-recovery-and-exactly-once-delivery) when clients briefly disconnect, so members don't flicker in and out of the avatar stack during temporary network interruptions.
</Aside>
