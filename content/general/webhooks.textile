...
In order to prevent overloading your servers with requests, Ably batches WebHook data and POSTS data to your servers typically no more than once per second per configured WebHook.
