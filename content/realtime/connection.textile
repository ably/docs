...
bc[dotnet]. AblyRealtime ably = new AblyRealtime("{{API_KEY}}");
ably.Connection.On(ConnectionState.Connected, args => Console.WriteLine("Connected, that was easy"));
...
The @Connection@ object is an @EventEmitter@ and emits an event whose name is the new state whenever there is a connection state change. <span lang="default">An event listener function is passed a "ConnectionStateChange":#connection-state-change object as the first argument for state change events.</span>span lang="dotnet">An event listener function is passed a "ConnectionStateChangehEventArgs":#connection-state-change object as the first argument for state change events.</span><span lang="ruby">The event block is passed the new state and an optional "@ErrorInfo@":/realtime/types#error-info object</span>
...
blang[dotnet].
  ...
  ```[dotnet]
    realtime.Connection.On(args => Console.WriteLine("New state is " + args.Current));
  ```
...
h2(#properties).
  ...
  dotnet: IO.Ably.Realtime.Connection Properties
...
The current <span lang="java">"@io.ably.lib.realtime.ConnectionState@":#connection-state @state@</span><span lang="ruby">"@Ably::Realtime::Connection::STATE@":#connection-state @state@</span><span lang="objc,swift">"@ARTRealtimeConnectionState@":#connection-state @state@</span><span lang="default">@state String@</span> of this Connection. See the "@Connection@ states":#connection-states for more information.
...
When a connection failure occurs this <span lang="default,ruby">attribute</span><span lang="java">member</span><span lang="jsall,dotnet">property</span> contains the <span lang="jsall,dotnet">"@ErrorInfo@":/realtime/types#error-info</span><span lang="java,ruby">"@AblyException@":/realtime/types#ably-exception</span>.
...
bq(definition).
  ...
  dotnet:  public void Connect()

Explicitly calling @connect@ is unnecessary unless the "@ClientOptions@":#client-options <span lang="default">@autoConnect@</span><span lang="ruby">@auto_connect@</span> is disabled. Unless already @connected@ or @connecting@, this method causes the connection to open, entering the @connecting@ state.
...
bq(definition#on-state-listener).
  ...
  java:    public void on("ConnectionState":#connection-state state, "ConnectionStateListener":#connection-state-listener listener)
  ...
  dotnet:  public void On("ConnectionState":#connection-state @event, Action<"ConnectionStateChangehEventArgs":#connection-state-change> action)

Register the given listener <span lang="ruby">block</span><span lang="swift,objc">function</span><span lang="dotnet">action</span> for the specified "ConnectionState":#connection-state <span lang="default">@state@</span><span lang="ruby">@state(s)@</span><span lang="java">@state@</span><span lang="dotnet">@event@</span> changes on the @Connection@. The listener is passed a "ConnectionStateChange":#connection-state-change object that contains the current state, previous state, and an optional reason for the state change.</span>
...
- <div lang="dotnet">event</div> := the connection state to subscribe to<br>__Type: "@ConnectionState@":#connection-state__
...
- <div lang="dotnet">action</div> := action to be executed for matching state changes<br>__Type: "@ConnectionStateChangehEventArgs@":#connection-state-listener__
...
bq(definition#once-state-listener).
  ...
  java:    public void once("ConnectionState":#connection-state state, "ConnectionStateListener":#connection-state-listener listener)
  ...
  dotnet:  public void Once("ConnectionState":#connection-state @event, Action<"ConnectionStateChangehEventArgs":#connection-state-change> action)

Register the given listener <span lang="ruby">block</span><span lang="swift,objc">function</span><span lang="dotnet">action</span> for a single occurence of the specified "ConnectionState":#connection-state <span lang="default">@state@</span><span lang="ruby">@state(s)@</span><span lang="java">@state@</span> change on the @Connection@. Once the listener has been called, it is removed as a registered listener and will not be called again. The listener is passed a "ConnectionStateChange":#connection-state-change object that contains the current state, previous state, and an optional reason for the state change.
...
bq(definition#once-listener).
  ...
  java:    public void once("ConnectionStateListener":#connection-state-listener listener)
  objc,swift: once(call: ("ARTConnectionStateChange":#connection-state-change?) -> Void) -> ARTEventListener
  dotnet:  public void Once(Action<"ConnectionStateChangehEventArgs":#connection-state-change> action)

Register the given listener <span lang="ruby">block</span><span lang="dotnet">action</span> for a single occurence of any "ConnectionState":#connection-state change on the @Connection@. Once the listener has been called, it is removed as a registered listener and will not be called again. The listener is passed a "ConnectionStateChange":#connection-state-change object that contains the current state, previous state, and an optional reason for the state change.
...
bq(definition#off-state-listener).
  ...
  java:    public void off("ConnectionState":#connection-state state, "ConnectionStateListener":#connection-state-listener listener)
  objc,swift: off(event: "ARTRealtimeConnectionState":#connection-state, listener: ARTEventListener)
  dotnet:  public void Off("ConnectionState":#connection-state @event, Action<"ConnectionStateChangehEventArgs":#connection-state-change> action);

Remove the given listener <span lang="ruby">block</span><span lang="dotnet">action</span> for the "ConnectionState":#connection-state <span lang="default">@state@</span><span lang="ruby">@state(s)@</span><span lang="java">@state@</span>.

bq(definition#off-listener).
  default: off(listener)
  ruby:    off(&block)
  java:    public void off("ConnectionStateListener":#connection-state-listener listener)
  objc,swift: off(listener: ARTEventListener)
  dotnet:  public void Off(Action<"ConnectionStateChangehEventArgs":#connection-state-change> action);

Remove the given listener <span lang="ruby">block</span><span lang="dotnet">action</span> for all "ConnectionState":#connection-state states.
...
bq(definition).
  ...
  dotnet:   public void Ping(Action<TimeSpan?, ErrorInfo> callback)
...
h3(#connection-state).
  ...
  dotnet:  IO.Ably.Realtime.ConnectionState Enum
...
h3(#connection-state-change).
  ...
  dotnet:  IO.Ably.Realtime.ConnectionStateChangedEventArgs
