...
jump_to:
 Section:
   ...
   - 17. WebSocket libraries you can use right now#open-source-websocket-libraries-you-can-use-right-now
...
The very first token in the request is the HTTP method, which tells the server the type of operation that the client is attempting with respect to the referenced URL. The @GET@ method is used when the client is simply requesting that the server deliver it a copy of the resource that is referenced by the specified URL.
...
.minimize [View code sample]
  ...
  h4(#minimal-code-samples). Minimal code sample
...
.minimize [View code sample]
  ...
  h4(#minimal-code-samples-1). Minimal code sample
...
.minimize [View code sample]
  ...
  h4(#minimal-code-samples-2). Minimal code sample
...
.minimize [View code sample]
  ...
  h4(#minimal-code-samples-3). Minimal code sample
...
.minimize [View code sample]
  ...
  h4(#minimal-code-samples-4). Minimal code sample
