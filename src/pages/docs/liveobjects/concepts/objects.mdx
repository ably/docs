---
title: Objects
intro: "Objects provide specialized conflict-free data structures for realtime state synchronization across multiple clients. These eventually consistent types include LiveMap and LiveCounter, designed to converge to identical states despite concurrent modifications."
meta_description: "Ably LiveObjects objects: specialized conflict-free data structures like LiveMap and LiveCounter for realtime state synchronization with eventual consistency."
---
