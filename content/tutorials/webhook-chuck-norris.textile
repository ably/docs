...
And then run the demo locally by adding your "Ably API key":https://knowledge.ably.com/setting-up-and-managing-api-keys to @config/secrets.yml@, configuring the Webhook rules as described in this tutorial and running the demo @rails server@

h2. Next steps

1. "Find out more about Reactor Events":/general/events
