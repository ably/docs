...
Connections are used to establish and maintain realtime communication with channels but are separate from channels, see the "connection documentation":/connect for further information.
