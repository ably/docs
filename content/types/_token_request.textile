...
- <span lang="default">keyName</span><span lang="ruby">key_name</span> := The key name of the key against which this request is made. The key name is public, whereas the key secret is private<br>__Type: @String@__
...
- timestamp := The timestamp of this request in milliseconds<br>__Type: <span lang="default">@Integer@</span><span lang="java">@Long Integer@</span><span lang="ruby">@Time@</span>__
...
- <span lang="default">clientId</span><span lang="ruby">client_id</span> := The client ID to associate with this token. When provided, the token may only be used to perform operations on behalf of that client ID<br>__Type: @String@__
