...
let navigator = {userAgent: "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_2) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/79.0.3945.88 Safari/537.36"}
```
...
Now lets add the needed permissions to @package.json@. Open the file @package.json@ which is in the base folder and update the field @requestedPermissions@ with the following:
