...
<p class="definition"><span lang="javascript,nodejs">on(String[] events, listener(<a href="/realtime/channels/language/javascript,nodejs/#channel-state-change">ChannelStateChange</a> stateChange))</span></p>
</blockquote>
  ...
  it('Duplicates nested span language blocks with commas', () => {
    ...
    expect(loadedDom.html().replace(/\s+/g, '')).toEqual(
      `<html><head></head><body><div lang="nodejs">
        <blockquote id="on-state-array-listener" class="definition">
            <p class="definition">
                <span lang="nodejs">on(String[] events, listener(<a href="/realtime/channels/language/javascript,nodejs/#channel-state-change">ChannelStateChange</a> stateChange))</span>
                <span lang="javascript">on(String[] events, listener(<a href="/realtime/channels/language/javascript,nodejs/#channel-state-change">ChannelStateChange</a> stateChange))</span>
            </p>
        </blockquote>
        <p>Same as above, but registers multiple listeners, one for each event in the array.</p>
