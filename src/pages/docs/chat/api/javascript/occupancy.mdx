...
Returns a [`Subscription`](#subscription) object that can be used to unsubscribe the listener.
...
| Property | Description | Type |
| -------- | ----------- | ---- |
| `unsubscribe` | A method to unsubscribe from occupancy events. | `() => Promise<void>` |
