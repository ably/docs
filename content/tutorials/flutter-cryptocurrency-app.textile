...
"Simple Flutter app state management with ChangeNotifier": https://flutter.dev/docs/development/data-and-backend/state-mgmt/simple
"Using Flutter packages": https://flutter.dev/docs/development/packages-and-plugins/using-packages
"Dart Streams - Flutter Official YouTube": https://www.youtube.com/watch?v=nQBpOIHE4eE