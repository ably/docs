...
# Required @Adapter.js@ to iron out cross platform issues for WebRTC
# Required the Ably JavaScript library
# Required the simple peer JavaScript library.
# Required a JavaScript file named @ably-videocall.js@ (which we will create soon).
...
Let us move ahead by understanding the functions defined in the class:
...
Create a file named @ably-videocall.js@ and add:
...
Now, let’s go ahead to make, receive and ending the call. 
