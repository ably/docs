...
h2. View channel and presence history

You can perform the following actions related to channel and presence history:

- Channel history := View all past messages sent in the channel.
- Presence history := View a log of clients entering and leaving the channel.

For detailed instructions, refer to REST API "history":/api/rest-sdk/history.
