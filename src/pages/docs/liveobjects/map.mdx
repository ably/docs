...
// Create a map with initial data
myObject.set("user", LiveMapValue.of(LiveMap.create(Map.of(
    "name", LiveMapValue.of("Alice"),
    "score", LiveMapValue.of(42),
    "active", LiveMapValue.of(true))))).join();

// Create nested maps
myObject.set("config", LiveMapValue.of(LiveMap.create(Map.of(
    "theme", LiveMapValue.of(LiveMap.create(Map.of(
        "color", LiveMapValue.of("dark"),
        "fontSize", LiveMapValue.of(14)))))))).join();
```
</Code>
...
// Set a nested map
settings.set("advanced", LiveMapValue.of(LiveMap.create(Map.of(
    "debugMode", LiveMapValue.of(false),
    "logLevel", LiveMapValue.of("info"))))).join();
