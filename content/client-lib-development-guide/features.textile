...
*** @(RSC7d5)@ Clients should conform product names using a common function, before they are packed into the agent string. This common function should always succeed, dropping any characters not in the supported set as defined by "RSC7d5":#RSC7d5. This function should be unit tested.
