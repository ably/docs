...
h3(#prerequisites-create-project). Create a Flutter project
...
h3(#prerequisites-ably-pubsub). Install Ably Pub/Sub Flutter SDK
...
h3(#prerequisites-setup-ably-client). Set up Ably Realtime Client
...
<aside data-type='note'>
<p>Initialize the Ably service at the application level to prevent it from being recreated unnecessarily, which could result in reaching your Ably connection limit.</p>
</aside>
...
This ensures the connection is closed when your application terminates, freeing resources and removing listeners.
