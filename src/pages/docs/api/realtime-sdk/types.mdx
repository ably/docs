...
| <If lang="flutter">clientId</If><If lang="ruby">client_id</If> | optional trusted [client identifier](/docs/platform/auth/identified-clients) for the device | `String` |
...
| <If lang="javascript,nodejs">clientId</If><If lang="ruby">client_id</If> | Devices with this [client identifier](/docs/platform/auth/identified-clients) are included in this channel subscription. When present, <If lang="javascript,nodejs">`deviceId`</If><If lang="ruby">`device_id`</If> is never present | `String` |
...
|-----------|-------------|------|
| channel | Channel name linked to this push channel subscription | `String` |
| <If lang="flutter,java,csharp,objc,swift,go">clientId</If><If lang="ruby">client_id</If> | Devices with this [client identifier](/docs/platform/auth/identified-clients) are included in the new push channel subscription | `String` |
...
<If lang="swift,objc">`ART`</If>`AuthOptions` is used when making [authentication](/docs/platform/auth) requests. These options will supplement or override the corresponding options given when the library was instantiated.
