...
Activate push notifications with [`push.activate()`](/docs/api/realtime-sdk/push#activate). Requesting notification permission from the user is your app's responsibility and must happen before activation. Add the following inside `PushScreen`:
