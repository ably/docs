---
title: Connection
meta_description: "Before a client can publish or subscribe to messages it must connect to the Ably service."
meta_keywords: "Connection, Client SDK, Channels, Messages, Publish, Subscribe, Connection State."
section: realtime
index: 20
languages:
  - javascript
...
* See "Connection API Reference - Realtime":/realtime/realtime-api-reference#connection-api
* See "Connection API Reference - REST":/rest/rest-api-reference#connection-api
