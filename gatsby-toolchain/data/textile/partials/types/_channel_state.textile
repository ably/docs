...
blang[go].
  @ChannelState@ is a string representing all the "channel states":/realtime/channels#channel-states
...
blang[flutter].
  @ably.ChannelState@ is an enum representing all the "@Realtime Channel@ states":/realtime/channels#channel-states.
