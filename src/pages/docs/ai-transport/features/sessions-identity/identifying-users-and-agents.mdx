...
To build secure AI applications, agents need to trust who sent each message and understand what that sender is authorized to do. Ably's identity system provides cryptographically-verified identities and custom user attributes through token-based authentication.

This page shows you how to authenticate users and agents, assign verified identities, attach custom attributes, and access that identity information in your applications.
