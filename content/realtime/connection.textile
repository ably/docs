...
- <div lang="jsall">state</div> := the connection state to subscribe to<br>__Type: String__
...
- <div lang="jsall">state</div> := the connection state to unsubscribe from<br>__Type: String__
