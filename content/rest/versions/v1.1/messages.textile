...
Idempotency ensures that multiple publishes of the same message cannot result in duplicate messages. "Find out more about what idempotency is, and how we provide idempotency in our REST operations.":https://www.ably.io/topics/idempotency
