...
** @(RSA10l)@ Has an alias method @RestClient#authorize@ and @RealtimeClient#authorize@ that will log a deprecation warning stating that this alias method will be removed in @v1.0@ and the user should instead use @authorize@
