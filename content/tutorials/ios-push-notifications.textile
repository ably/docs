...
Now that we have the P12 certificate ready to be used, let's get set up with an Ably account. If you are not already signed up, you should "sign up now for a free Ably account":https://ably.com/signup. Once you have an Ably account, log into your Ably account, go to your "Apps Dashboard":https://faqs.ably.com/how-do-i-access-my-app-dashboard and choose an existing app or create a new one as shown below:
