...
* [Fetching objects](/docs/liveobjects/rest-api-usage#fetching-objects): You are billed per object returned in the response. The [list objects](/docs/liveobjects/rest-api-usage#fetching-objects-list) request is free if only object IDs are requested without their values.
