...
At present, REST "requests":/api/rest-sdk#request for lifecycle events will not count towards your message limit. If you are making use of "Integrations":/general/integrations however, then each message sent through Integrations *will* count towards your message limits.
