...
- <span lang="default">clientId</span><span lang="ruby">client_id</span> := The client ID of the publisher of this presence update<br>__Type: @String@__

- <span lang="default">connectionId</span><span lang="ruby">connection_id</span> := The connection ID of the publisher of this presence update<br>__Type: @String@__
