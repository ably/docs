...
jump_to:
  Help with:
    ...
    - Channel Options API#channel-options-api
...
This topic provides a detailed API Reference for the realtime interface of the Ably Client Library SDK. For general information about the realtime client library refer to the "overview":/realtime.
...
h2(#channel-options-api). Channel Options API Reference
