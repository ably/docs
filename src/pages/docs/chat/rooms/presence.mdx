...
Ably automatically recovers connections and prevents message loss or duplication when clients reconnect within two minutes, keeping your presence sets accurate. [Learn how connection recovery works](/docs/platform/architecture/idempotency#connection-recovery-and-exactly-once-delivery).
</Aside>
