...
Use these instructions to setup an Ably SDK. "About Pub/Sub":/basics#realtime outlines the differences between the realtime and REST interfaces in Ably SDKs and the other possible ways to use Ably.
