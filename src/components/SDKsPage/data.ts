  ...
  tabs: {
    ...
    chat: {
      ...
      cards: [
        ...
        {
          title: 'Kotlin (JVM)',
          text: 'Ably Chat SDK for Kotlin in the JVM.',
          image: { src: kotlin, isWide: false },
          setupLink: 'chat/getting-started/jvm',
        },
        {
          title: 'Kotlin (Android)',
          text: 'Ably Chat SDK for Kotlin on Android.',
          image: { src: android, isWide: false },
          setupLink: 'chat/getting-started/android',
        },
      ],
    },
    liveobjects: {
