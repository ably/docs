...
An "Ably API key":https://knowledge.ably.com/what-is-an-app-api-key-1 can have single set of permissions, applied to any number of channels or "queues":/general/queues. To create a key with certain permissions, simply go to create a new API key and "select the desired permissions":https://knowledge.ably.com/setting-up-and-managing-api-keys-1.
