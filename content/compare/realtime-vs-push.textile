...
<%= partial partial_version('compare/shared/ease/_push-technology') %>
...
<%= partial partial_version('compare/shared/security/_push-technology') %>
...
<%= partial partial_version('compare/shared/support/_push-technology') %>
...
<%= partial partial_version('compare/shared/pricing/_push-technology_value') %>
