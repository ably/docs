...
meta_keywords: "Ably Chat, AWS Lambda, custom moderation, content moderation, serverless moderation, before publish moderation"
---
...
| AWS authentication scheme | The authentication method to use. Either `AWS Credentials` or `ARN of an assumable role`. See the [Ably AWS authentication documentation](/docs/platform/integrations/webhooks/lambda#aws-authentication). |
