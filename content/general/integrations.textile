...
Data sent from Ably to an external service is in the form of Ably events. "Events":/general/events include "messages":/realtime/messages published to a channel, all types of "presence events":/realtime/presence emitted by a client's presence status changes, the "creation and closure":/realtime/channels#channel-lifecycle of channels and changes in "channel occupancy":/realtime/inband-occupancy#occupancy-events.
...
"Events":/general/events include "messages":/realtime/messages published to a channel, all types of "presence events":/realtime/presence emitted by a client's presence status changes, the "creation and closure":/realtime/channels#channel-lifecycle of channels and changes in "channel occupancy":/realtime/inband-occupancy#occupancy-events.
