...
We recommend using our REST client libraries over direct REST API access.  However, if you want to communicate directly over HTTP with Ably it's as simple as:
