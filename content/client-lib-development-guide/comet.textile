...
The Ably realtime service supports client connections over multiple transports. The Comet transport is a fallback transport for environments that are unable to support "WebSockets":https://www.ably.io/topic/websockets (eg older browser versions) or for environments for which intervening proxies do not support "WebSockets":https://www.ably.io/topic/websockets.
