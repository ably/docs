...
Once your "Reactor Queue":https://www.ably.io/reactor is provisioned, and your "Queue rules":https://knowledge.ably.com/how-can-i-set-up-a-queue-rule are configured, there are a number of ways we recommend customers can debug the configured rules and queues:
