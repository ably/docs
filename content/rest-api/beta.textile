...
For partially successful requests, @response.items.batchResponse@ will contain a list of the individual channel's results, be it an error or a success. You will know a partial success has occured by the @response.errorCode@, which will be @40020@.
