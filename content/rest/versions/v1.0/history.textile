...
Both the "@Channel@":/rest/channels and "@Presence@":/presence-occupancy/presence objects provide history. The "@Channel@":/rest/channels object provides the history of "@Message@":/api/rest-sdk/history#message objects published on the channel, whereas the "@Presence@":/presence-occupancy/presence object provides presence event history of that channel i.e. members entering, updating or leaving the channel as "@PresenceMessage@":/api/rest-sdk/history#presence-message objects.
