...
*** @(TO3k2)@ @restHost@ string - for development environments only; allows a non-default Ably REST host to be specified which overrides any non-default @environment@
*** @(TO3k3)@ @realtimeHost@ string - for development environments only; allows a non-default Ably Realtime host to be specified which overrides any non-default @environment@
