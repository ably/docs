...
- timestamp := Timestamp when the presence update was received by the Ably the realtime service<span lang="default">, as milliseconds since the epoch</span><span lang="ruby,objc,swift"></span>.<br>__Type: <span lang="default">@Integer@</span><span lang="java">@Long Integer@</span><span lang="ruby">@Time@</span><span lang="objc,swift">@NSDate@</span>__
