...
intro: Track where members are positioned within your application space to show contextual awareness and collaboration. Display visual indicators when users select form fields, edit spreadsheet cells, or navigate presentation slides.
