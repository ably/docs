...
<If lang="javascript,swift,kotlin">
Use the <If lang="javascript">[`presence.update()`](/docs/sdk/chat-js/v0/interfaces/chat-js.Presence.html#update)</If><If lang="swift">[`presence.update()`](/docs/sdk/chat-swift/v0/presence/update%28data%3A%29)</If><If lang="kotlin">[`presence.update()`](/docs/sdk/chat-kotlin/v0/chat-android/com.ably.chat/-presence/update.html)</If> method when a user wants to update their data, such as an update to their status, or to indicate that they're raising their hand. Updates will send a presence event to all users subscribed to presence:
</If>
...
<If lang="javascript,swift,kotlin">
Use the <If lang="javascript">[`presence.leave()`](/docs/sdk/chat-js/v0/interfaces/chat-js.Presence.html#leave)</If><If lang="swift">[`presence.leave()`](/docs/sdk/chat-swift/v0/presence/leave%28data%3A%29)</If><If lang="kotlin">[`presence.leave()`](/docs/sdk/chat-kotlin/v0/chat-android/com.ably.chat/-presence/leave.html)</If> method to explicitly remove a user from the presence set. This will send a presence event to all users subscribed to presence. You can also set an optional data field such as setting a status of 'Back later'.
</If>
...
Use the <If lang="javascript">[`presence.get()`](/docs/sdk/chat-js/v0/interfaces/chat-js.Presence.html#get)</If><If lang="swift">[`presence.get()`](/docs/sdk/chat-swift/v0/presence/get%28%29)</If><If lang="kotlin">[`presence.get()`](/docs/sdk/chat-kotlin/v0/chat-android/com.ably.chat/-presence/get.html)</If> method to retrieve an array of all users currently entered into the presence set, or individual users:
...
Alternatively, use the <If lang="javascript">[`presence.isUserPresent()`](/docs/sdk/chat-js/v0/interfaces/chat-js.Presence.html#isUserPresent)</If><If lang="swift">[`presence.isUserPresent()`](/docs/sdk/chat-swift/v0/presence/isuserpresent%28clientid%3A%29)</If><If lang="kotlin">[`presence.isUserPresent()`](/docs/sdk/chat-kotlin/v0/chat-android/com.ably.chat/-presence/is-user-present.html)</If> method and pass in a user's `clientId` to check whether they are online or not. This will return a boolean:
