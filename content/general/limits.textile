...
| "Peak connections":#peak-connections | 200 | 240 | 100,000 | 250,000 |\2. Millions (Custom) |
| "Peak channels":#peak-channels | 200 | 240 | 100,000 | 250,000 |\2. Millions (Custom) |
| "Total monthly messages":#messages | 6,000,000 | 7,200,000 | No limit | No limit |\2. No limit |
| "Messages":#messages (per hour) | 84,000 | 100,000 | 1,400,000 | 3,500,000 |\2. Bilions (Custom) |
| "Message rate":#messages (per second) | - | 70 | - | 2,400 |\2. 100's of thousands (Custom)  |
