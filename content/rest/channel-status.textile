...
You can also make use of the realtime library to subscribe to "channel lifecycle":#lifecycle-events and "occupancy":#occupancy events which are published onto "metachannels":#metachannels through the "channel metadata API":/realtime/channel-metadata.
