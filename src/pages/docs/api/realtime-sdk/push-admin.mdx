...
intro: "Manage server-side device registrations, channel subscriptions, and direct push message delivery using administrative controls. The Push Admin API provides programmatic control, notification infrastructure management, targeting capabilities, and bulk operations."
