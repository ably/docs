...
Full usage notes for the adapter are available separately in a support article: "Using the Ably Pusher Protocol Adapter":https://support.ably.io/support/solutions/articles/3000055086-using-the-ably-pusher-protocol-adaptor/.
...
blang[javascript].
  Here's some code that subscribes to a channel from the Psher client library, then publishes to it from the Ably client library:
