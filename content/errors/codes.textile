...
This error occurs when the maximum number of "objects":/docs/liveobjects on the channel has exceeded the allowed "limit":/docs/liveobjects/storage#limits for the account or application.
...
This error occurs when no objects are found that match the specified "path":/docs/liveobjects/rest-api-usage#updating-objects-by-path when using the "REST API":/docs/liveobjects/rest-api-usage .
...
This error occurs when the requested operation cannot be processed for the object located at the specified "path":/docs/liveobjects/rest-api-usage#updating-objects-by-path when using the "REST API":/docs/liveobjects/rest-api-usage .
