...
@@ -0,0 +1,612 @@
 ...
 blang[java].
   @Srushtika
Srushtika on Sep 23  Member
This link doesn't make any sense. The GitHub step linked does not show any retrieving Ably API key as described in the tutorial step. Please remove it as it's not relevant.
 @codeekage	Reply…
   "See setup in Github":https://github.com/ably/tutorials/commit/encryption-java-setup-step
 blang[javascript].
   "See setup in Github":https://github.com/ably/tutorials/commit/encryption-js-setup
...
This link is broken
 ...
 blang[javascript].
   ...
   **What is going on in the code block above?**
   ...
   "See this step in Github":https://github.com/ably/tutorials/commit/commit/encryption-js-step3
   @Srushtika
Srushtika on Sep 23  Member
This link is broken, please fix it.
 @codeekage	Reply…
...
This link is broken
 ...
 blang[java].
   The complete source code for each step of "this tutorial is available on [Github](https://github.com/ably/tutorials/commit/encryption-java)
