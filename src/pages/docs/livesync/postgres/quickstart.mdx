---
title: Quickstart
intro: "Get started with LiveSync using a complete example that demonstrates database synchronization with frontend clients. This guide walks through setup, configuration, and implementation of the outbox pattern for realtime data updates."
meta_description: "Ably LiveSync quickstart: complete example demonstrating database synchronization with frontend clients using the outbox pattern for realtime updates."
---
