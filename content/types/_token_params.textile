...
- <span lang="default">capability</span><span lang="csharp">Capability</span><span lang="ruby">:capability</span> := JSON stringified capability of the token. If the token request is successful, the capability of the returned token will be the intersection of this capability with the capability of the issuing key. "Find our more about how to use capabilities to manage access privileges for clients":/general/authentication#capabilities-explained. __Type: <span lang="default">@String@</span><span lang="csharp">@Capability@</span>__
