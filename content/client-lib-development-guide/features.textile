...
**** @(RTN15c1)@ This clause has been replaced by RTN16c6 as of the 2.0 spec.
**** @(RTN15c2)@ This clause has been replaced by RTN16c7 as of the 2.0 spec.
**** @(RTN15c3)@ This clause has been replaced by RTN16c7 as of the 2.0 spec.
...
** @(RTN16a)@ This clause has been replaced by RTN16i as of the 2.0 spec.
** @(RTN16i)@ Connection recovery closely follows the resume spec "RTN15c":#RTN15c. It differs only in that since the library has no state at the time of connection, the channels must be explicitly attached by the developer; continuity preservation is achieved by the @channelSerial@s for each channel being stored in the recovery key.
** @(RTN16b)@ This clause has been removed as of the 2.0 spec and replaced with @RTN16g@.
...
** @(RTN16c)@ This clause has been replaced by RTN16h as of the 2.0 spec.
...
** @(RTP17d)@ This clause has been replaced by @RTN17g@ as of the 2.0 spec.
...
class Connection: // RTN*
  ...
  id: String? // RTN8
  key: String? // RTN9
  getRecoveryKey(): String? // RTN16g, RTN16c
