...
redirect_from:
  ...
  - /realtime/versions/v1.1/channel-metadata
  - /realtime/versions/v1.0/channel-metadata
---
...
<p>Be aware that whilst metachannels publish app-level metadata, some of the events that they publish contain channel-level metadata. An example of this are @[meta]channel.lifecycle@ events, which include a "@ChannelDetails@":/api/realtime-sdk/channel-metadata#channel-details object.</p>
</aside>
...
"Integrations":/integrations/webhooks#sources can utilize channel occupancy events as a source.
