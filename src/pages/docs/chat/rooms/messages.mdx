---
title: Messages
intro: "Messages enable users to send, update, delete, and receive content within chat rooms through subscription listeners. All subscribed users receive real-time notifications when messages are created, modified, or removed."
