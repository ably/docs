...
intro: "Inband objects enable LiveObjects update subscriptions through Pub/Sub SDKs on platforms without native LiveObjects support. This compatibility layer provides realtime object updates using existing Pub/Sub infrastructure."
meta_description: "Ably Inband Objects: subscribe to LiveObjects updates via Pub/Sub SDKs on platforms without native LiveObjects client support."
---
