...
A connection key, which can optionally be included for a REST publish as part of the "publishing on behalf of a realtime client functionality":/pub-sub/advanced#publish-on-behalf.<br>__Type: @String@__
