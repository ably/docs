...
- [`channel.subscribe()`](/docs/channels#subscribe): subscribes to token messages from AI services by registering a listener for real-time streaming.
...
6. Run the server:
  ...
  ```sh
  yarn run ai-transport-token-streaming-javascript
  ```
