...
Both the "channel lifecycle":#lifecycle-events and the "occupancy":#occupancy-events events are published onto a special channel referred to as a "metachannel":#metachannels bearing the name @[meta]channel.lifecycle@, that can be subscribed to with our "realtime libraries":/realtime. This is often used in conjunction with "Ably Integrations":https://ably.com/integrations, which allows you to send this data to your "serverless endpoints":/general/events, "queues":/general/queues, and "streams":/general/firehose.
...
View "Realtime channel metadata":/api/realtime-sdk/channel-metadata for the associated Client Library SDK API reference.