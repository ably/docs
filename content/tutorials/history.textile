...
blang[java].
  ...
  After you add neccessary dependencies, you can import AblyRest class into your code and initialize it.
...
blang[android].
  ...
  After you add neccessary dependencies, you can import AblyRealtime class into your code and initialize it.
...
blang[android].
  ...
  public class ExampleActivity extends AppCompatActivity {
    ...
    private void initAbly() throws AblyException {
        ...
        channel = ablyReltime.channels.get("persisted:sounds");
    }
...
blang[swift].
  If you have not previously had a chance to build a basic user interface in Xcode, please refer to "Apple developer guide":https://developer.apple.com/library/content/referencelibrary/GettingStarted/DevelopiOSAppsSwift/Lesson2.html on how to build a simple UI and also learn more about "adding @IBOutlets@ and @IBActions@":https://developer.apple.com/library/content/referencelibrary/GettingStarted/DevelopiOSAppsSwift/Lesson3.html#//apple_ref/doc/uid/TP40015214-CH22-SW1.
