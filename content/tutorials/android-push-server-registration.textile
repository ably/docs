...
If you observe, we have made use of the @NetResponse@ class. Let's go ahead and define this next, in the same file, i.e, 'server'. Create a new file named @NetResponse.java@ and paste the following into it:
