...
meta_keywords: "codec architecture, AI Transport, encoder, decoder, TInput, TOutput, custom codec, well-known variants, Ably"
...
redirect_from:
  - /docs/ai-transport/concepts/codecs
---
...
## Header tiers <a id="header-tier-story"/>
