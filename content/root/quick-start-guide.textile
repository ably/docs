...
blang[flutter].
  The Ably Realtime and REST client library is available as a "pub package":https://pub.dev/packages/ably-flutter/. Update your @pubspec.yaml@ with appropriate package version
