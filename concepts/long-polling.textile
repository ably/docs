h1(#long-polling-concepts-and-considerations). Long Polling: Concepts and Considerations
...
** "Device support and fallbacks":#device-support-and-fallbacks
...
A decent library for implementing long polling in the _Go_ language.
...
As per the readme, _php-long-polling_ is "a very simple demonstration of long-polling with AJAX (jQuery) and PHP ... This is an improved, cleaned and documented fork of (php-ajax-long-polling)[https://github.com/lincolnbrito/php-ajax-long-polling]".

As the code for this one is extremely simple, rather than providing a code example, "take a look at implementation":https://github.com/panique/php-long-polling/blob/master/server/server.php directly - it's fairly self-explanatory.

"https://github.com/panique/php-long-polling":https://github.com/panique/php-long-polling
...
"https://github.com/jedisct1/Simple-Comet-Server":https://github.com/jedisct1/Simple-Comet-Server
...
* "HTML5 WebSocket: A Quantum Leap in Scalability for the Web _(Polling, Long-Polling, and Streaming -- Headache 2.0)_":http://websocket.org/quantum.html
...
At Ably we've implemented a robust suite of transports in the client libraries that we make available for communication with our servers. Long polling is a fully-supported as an automatic fallback transport when newer standards such as WebSockets are not available on the client side. Find out more on the "Ably home page":https://ably.io.
