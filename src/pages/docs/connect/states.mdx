...
### iOS connection errors <a id="iOS-errors"/>
...
If you want to explicitly <If lang="swift">[manage connections](/docs/connect/states?lang=swift)</If> [manage connections](/docs/connect/states?lang=swift) <If lang="objc">[manage connections](/docs/connect/states?lang=objc)</If> based on your app's lifecycle:

- Call <If lang="swift">[`close()`](/docs/api/realtime-sdk/connection?lang=swift#close)<If lang="objc">[`close()`](/docs/api/realtime-sdk/connection?lang=objc#close)</If> </If> when the app enters background if you don't need background connectivity.
- Call <If lang="swift">[`connect()`](/docs/api/realtime-sdk?lang=swift#connect)</If> <If lang="objc">[`connect()`](/docs/api/realtime-sdk?lang=objc#connect)</If> when the app returns to foreground to re-establish the connection.
