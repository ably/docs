...
![Diagram showing edit and regenerate forks branching the conversation tree from the anchored user prompt and assistant message](../../../../images/content/diagrams/ait-session-continuity.png)
