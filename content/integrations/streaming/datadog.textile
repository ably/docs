...
<p>DataDog is available to "Enterprise":/docs/platform/pricing/enterprise packages. A "DataDog Lite":#lite version is available to "Standard":/docs/platform/pricing/standard and "Pro":/docs/platform/pricing/pro packages.</p>
</aside>
