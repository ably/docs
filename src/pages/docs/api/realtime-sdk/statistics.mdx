---
title: Statistics
intro: "Retrieve usage metrics and operational data for your Ably application including message volumes and connection counts. The Statistics API provides time-series data, monitoring insights, and analytics information."
