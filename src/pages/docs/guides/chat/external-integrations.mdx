...
You can configure many different types of integrations with Ably Chat. The three methods commonly used, and covered in this guide, are:
...
## Understanding integrations <a id="understanding-integrations"/>
...
### Integration flow <a id="integration-flow"/>
...
### Setting up integration rules <a id="setting-up-integration-rules"/>
...
### Understanding channel names and room names <a id="understanding-channel-names-and-room-names"/>
...
### Understanding enveloped messages <a id="understanding-enveloped-messages"/>
...
### Extracting the room name <a id="extracting-room-name"/>
...
### Extracting message data <a id="extracting-message-data"/>
