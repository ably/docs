...
<span lang="jsall, csharp">**Note**: To release a channel, the "channel state":/docs/channels/states must be @initialized@, @detached@ or @failed@.</span>
...
The current <span lang="java">"@io.ably.lib.realtime.ChannelState@":#channel-state @state@</span><span lang="csharp">"@IO.Ably.Realtime.ChannelState@":#channel-state @state@</span><span lang="ruby">"@Ably::Realtime::Channel::STATE@":#channel-state @state@</span><span lang="objc,swift">"@ARTRealtimeChannelState@":#channel-state</span><span lang="default">"@ChannelState@":#channel-state</span> of this @Channel@. See the supported "channel states":/docs/channels/states for more information.
...
The type is <span lang="default">"@ErrorInfo@":/docs/api/realtime-sdk/types#error-info</span><span lang="java,ruby">"@AblyException@":/docs/api/realtime-sdk/types#ably-exception</span>.
...
bq(definition#publish-data).
  ...
  jsall: publish(String name, Object data): Promise <void>
...
blang[jsall].
  ...
  bq(definition#publish-msg).
    jsall: publish(Object message): Promise <void>
...
bq(definition#publish-msg-array).
  ...
  jsall: publish(Object[] messages): Promise <void>
  ...
  csharp:  void Publish(IEnumerable<"Message":#message> messages, Action<bool, "ErrorInfo":/docs/api/realtime-sdk/types#error-info> callback = null)
...
blang[default].
  ...
  Publish several messages on this channel. A <span lang="default">callback</span><span lang="java">listener</span><span lang="ruby">block</span> may optionally be passed in to this call to be notified of success <span lang="default">or failure</span><span lang="ruby"></span> of the operation.<span lang="ruby,swift"> When publish is called with this client library, it "won't attempt to implicitly attach to the channel":/docs/channels#transient-publish.</span><span lang="default"> If the channel is @initialized@ (i.e. no attempt to attach has yet been made for this channel), then calling @publish@ will implicitly attach the channel.</span>
...
bq(definition#subscribe-listener).
  ...
  jsall: subscribe(listener): Promise <null | "ChannelStateChange":#channel-state-change>
...
bq(definition#subscribe-event).
  ...
  jsall: subscribe(String event, listener?): Promise <null | "ChannelStateChange":#channel-state-change>
...
bq(definition#subscribe-event-array).
  ...
  jsall: subscribe(String[] events, listener?): Promise <null | "ChannelStateChange":#channel-state-change>
...
<div lang="default"></div>
<div lang="jsall">

bq(definition#subscribe-filtered).
  jsall: subscribe(filter, listener?): Promise <null | "ChannelStateChange":#channel-state-change>
...
- <span lang="default">name</span><span lang="jsall">event</span> := The event name to subscribe to<br>__Type: @String@__

<div lang="objc,swift,csharp,jsall"></div>
...
- <div lang="jsall"> events</div> := An array of event names to subscribe to<br>__Type: @String[]@__
...
- <div lang="jsall">filter</div> := a filter object that is used to provide server-side filtering of messages as part of "filtered subscriptions":/docs/pub-sub/advanced#subscription-filters<br>__Type: @Object@__

blang[jsall].
  h4. Returns

  Returns a promise. On successful channel attachment, the promise will be fulfilled with a "ChannelStateChange":#channel-state-change object. If the channel was already attached, then the promised will resolve with @null@. On failure, the promise is rejected with an "@ErrorInfo@":/docs/api/realtime-sdk/types#error-info object that details the reason why it was rejected.
...
There are <span lang="jsall">seven</span><span lang="default">three</span> overloaded versions of this method:
...
<div lang="flutter">@streamSubscription@ obtained from a subscription can be used to cancel a listener by calling @streamSubscription.cancel@.</div>
<div lang="default">
...
- <span lang="default">name</span><span lang="jsall">event</span> := The event name to unsubscribe from<br>__Type: @String@__
- <div lang="jsall">events</div> := An array of event names to unsubscribe from<br>__Type: @String[]@__
...
- <span lang="default">options</span><span lang="jsall">params</span><span lang="objc,swift">query</span><span lang="csharp">dataQuery</span> := <span lang="default">an optional object containing the query parameters</span><span lang="ruby">an optional set of key value pairs containing the query parameters</span>, as specified in the "message history API documentation":/docs/api/realtime-sdk/history#channel-history<br>__Type: <span lang="default">@Object@</span><span lang="objc,swift">@ARTRealtimeHistoryQuery@</span><span lang="csharp">@PaginatedRequestParams@</span><span lang="ruby">@Hash@</span><span lang="java">"@Param []@":#param</span>__
...
blang[jsall].
  ...
  Returns a promise. On success, the promise will be fulfilled with a "PaginatedResult":#paginated-result object containing an array of messages. On failure, the promise is rejected with an "@ErrorInfo@":/docs/api/realtime-sdk/types#error-info object that details the reason why it was rejected.
...
blang[jsall].
  ...
  bq(definition).
    jsall: setOptions(options): Promise<void>

  Set the "ChannelOptions":#channel-options for the channel.

  h4. Parameters

  - options := The options to set for the channel<br>__Type: @ChannelOptions@__
...
bq(definition).
  ...
  jsall: attach(): Promise <null | "ChannelStateChange":#channel-state-change>
  java:     void attach()
  csharp:   void Attach(Action<TimeSpan, "ErrorInfo":/docs/api/realtime-sdk/types#error-info?> callback = null)
  ruby:     "Deferrable":/docs/api/realtime-sdk/types#deferrable attach -> yields
  objc,swift: attach(callback: (("ARTErrorInfo":/docs/api/realtime-sdk/types#error-info?) -> Void)?)
...
blang[jsall].
  ...
  Returns a promise. On successful attachment, the promise will be fulfilled with a "ChannelStateChange":#channel-state-change object. If the channel was already attached, then the promised will be fulfilled with @null@. On failure, the promise is rejected with an "@ErrorInfo@":/docs/api/realtime-sdk/types#error-info object that details the reason why it was rejected.
...
bq(definition).
  ...
  objc,swift: detach(callback: (("ARTErrorInfo":/docs/api/realtime-sdk/types#error-info?) -> Void)?)
...
bq(definition#on-state-array-listener).
  default:  on(String[] events, listener("ChannelStateChange":#channel-state-change stateChange))
...
- <div lang="swift,objc">call</div> := called possibly with an "@ErrorInfo@":/docs/api/realtime-sdk/types#error-info
...
- <div lang="java">event</div> := the channel event to unsubscribe from<br>__Type: "@ChannelEvent@":#channelevent__
...
blang[jsall].
  ...
  bq(definition).
    jsall: whenState(targetState): Promise <null | "ChannelStateChange":#channel-state-change>

  Checks if a channel is in a given state and returns @null@ if it is, else calls "@once()@":#once for the given state.

  h4. Parameters

  - targetState := The "@ChannelState@":#channel-state to wait for<br>__Type: @ChannelState@__
...
- filter := The filter expression to use when creating or returning the derived channel. This is a "JMESPath":https://jmespath.org/ query<br>__Type: @String@__
