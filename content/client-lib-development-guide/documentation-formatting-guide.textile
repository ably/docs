...
p(tip). In order to publish code examples to JSBin, your "/config/jsbin_config.yaml":https://github.com/ably/docs/blob/source/config/jsbin_config.example.yaml must be set up with a valid JSBin API key.
