...
** @(RTN4f)@ Additionally, a @ConnectionStateChange@ can be emitted that contains an @reason@ which contains an @ErrorInfo@ object with details of the error that has occurred for the @Connection@.
