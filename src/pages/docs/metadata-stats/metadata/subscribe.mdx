...
[Capabilities](/docs/platform/auth/capabilities) for metachannels work almost identically to how they do for regular channels. The only difference is that the resource name in the capability must explicitly include the `[meta]` qualifier.
</Aside>
