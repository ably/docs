...
Batch publish uses the "request":/api/rest-sdk/index#request method to query the "batch REST API":/rest-api#batch-publish.
...
Batch presence uses the "request":/api/rest-sdk/index#request method to query the "batch REST API":/rest-api#batch-presence.
