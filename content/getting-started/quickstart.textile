...
Ably SDKs are available in multiple programming languages. Some SDKs have a realtime and a REST interface, while others only have a REST interface. The "SDK downloads":https://ably.com/download page lists availability. For further information on when it's best to use the realtime or REST interface, see "About Pub/Sub":/basics#realtime.
...
* Read more about "Pub/Sub":/basics.
