...
See the "queues documentation":/docs/general/queues and "Wikipedia":https://en.wikipedia.org/wiki/Advanced_Message_Queuing_Protocol for further information.
...
See the "batch request documentation":/channels#batch-publish for further information.
...
See the "dead letter queue documentation":/docs/general/queues#deadletter for further information.
...
See the "idempotent messages documentation":/channels#idempotency for further information.
...
See the "Kinesis rule documentation":/docs/general/firehose/kinesis-rule for more information.

h2(#lambda). Lambda

Lambda is an event-driven serverless service provided by Amazon Web Services that allows users to easily run code when specified conditions are met. You can set up Ably "Webhooks":/docs/general/webhooks to trigger Lambda functions when events occur.

See the "Lambda documentation":/docs/general/webhooks/aws-lambda for more information.
...
See the "queues documentation":/docs/general/queues for further information.
...
See the "SQS rule documentation":/docs/general/firehose/sqs-rule for more information.
...
See the "queues documentation":/docs/general/queues and "Wikipedia":https://en.wikipedia.org/wiki/Streaming_Text_Oriented_Messaging_Protocol for further information.
...
See the "incoming webhook documentation":/docs/general/incoming-webhooks and "outbound webhook documentation":/docs/general/webhooks for further information.
