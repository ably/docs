---
title: Organizations
intro: Organizations centralize user access and role management across multiple Ably accounts under a single organizational structure. Enable automated user provisioning through SSO and SCIM integration for streamlined access control.
