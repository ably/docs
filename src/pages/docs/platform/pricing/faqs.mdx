...
**Solution:** Configure the client library with the higher limit using the `maxMessageSize` client option when instantiating the client. For example, if your account has a 128kB message size limit:
