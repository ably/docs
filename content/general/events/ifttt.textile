...
For a "message data":/api/realtime-sdk/message#data or "presence message data":/realtime/presence#data of @{ "value1": "My first message", "value2": "My second message"}@, the following would be sent to your IFTTT endpoint:
