...
This topic provides a detailed API Reference for the REST interface of the Ably Client Library SDK. For general information about the REST client library refer to the "overview":/rest.
