...
Failed connections automatically try up to 5 alternative endpoints worldwide, maximizing reconnection success. [Learn how Ably provides protocol-level resilience](/docs/platform/architecture/edge-network#protocol-level-resilience).
</Aside>
