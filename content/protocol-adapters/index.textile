...
Ably Client Library SDKs are the recommended method for connecting to Ably because they offer support for a comprehensive set of Ably features, such as automatic "connection management":/connect, "authentication token renewal":/auth/token and "presence":/presence-occupancy/presence.
