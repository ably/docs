...
* If you want to consume realtime data from one or more of your servers, then we recommend you consider using our "Queues":/general/queues or "Firehose":/general/firehose. With the Integrations, you can consume realtime data in a robust, resilient and scalable way across multiple support protocols. Find out more about "Ably Integrations":https://ably.com/integrations.
