...
Ably enables easy migration from Pusher to Ably using its Pusher Adapter. The protocol adapter handles all background translation and only requires an API key change, allowing you to use existing Pusher client libraries directly with Ably.
