...
From the "tutorial repository":http://todo-repository-link, download the "pizza.js":http://todo-repository-link/deployment-package/pizza.js file, and place it in your project folder alongside @package.json@.
