...
redirect_from:
  - /api/versions/v1.1/rest-sdk/channels
  - /api/versions/v1.0/rest-sdk/channels
  - /api/versions/v0.8/rest-sdk/channels
---
...
Provides access to the "PushChannel":/push/publish#sub-channels object for this channel which can be used to access members present on the channel, or participate in presence.
...
It is also possible to publish a message to multiple channels at once using our "batch publish feature":/messages/batch#batch-publish.
