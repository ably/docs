...
![Installed SDK build tools](@content/screenshots/asset-tracking/android/sdk-build-tools.png)
...
![Select the publishing app](@content/screenshots/asset-tracking/android/select-app.png)
...
![How to select location source](@content/screenshots/asset-tracking/android/location-source.png)
...
![Extended controls](@content/screenshots/asset-tracking/android/extended-controls.png)
...
![Example apps running](@content/screenshots/asset-tracking/android/example-apps-running.png)
</If>
...
![Provide a tracking ID](@content/screenshots/asset-tracking/swift/publisher-enter-tracking-id.png)
...
![Starting the Publisher Example app](@content/screenshots/asset-tracking/swift/publisher-running.png)
...
![Publisher and subscriber apps running together](@content/screenshots/asset-tracking/swift/publisher-and-subscriber-apps-running.png)
</If>
...
![Select map provider](@content/screenshots/asset-tracking/javascript/example-app-select-map-provider.png)
...
![Select trackable ID](@content/screenshots/asset-tracking/javascript/example-app-select-trackable.png)

9. The example app receives updates from the publisher and shows the current location of the asset on the map:

![Example app running](@content/screenshots/asset-tracking/javascript/example-app-running.png)
</If>
