...
// Glyph components keyed by icon name. `satisfies` keeps the keys as a literal union so
// IconName can be checked against them, while still enforcing the value type.
export const glyphs = {
