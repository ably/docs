...
The Ably REST client library provides a straightforward API for "publishing":/rest/messages#publish messages and retrieving "message history":/api/rest-sdk/channels#history from a channel.
...
View the "REST Channels object":/api/rest-sdk/channels for the associated Client Library SDK API Reference.
