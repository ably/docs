...
| `Suspended` | The connection is suspended and will not attempt to reconnect automatically. The connection will remain in this state until explicitly reconnected. |
