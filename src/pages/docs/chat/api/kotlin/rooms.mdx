...
meta_keywords: "Ably Chat SDK, Kotlin, Rooms API, get, release, RoomOptions"
---
...
Create or retrieve a [`Room`](/docs/chat/api/kotlin/room) instance. Optionally provide custom configuration to the room using a DSL builder.
