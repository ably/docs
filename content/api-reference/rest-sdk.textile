...
jump_to:
  Objects:
    - Auth#auth-object
    - Channel Status#channel-status-object
    - Channels#channels-object-toc
...
This page provides a detailed API Reference for the REST interface of the Ably Client Library SDK. 

For information on how to use the REST client library, and key concepts, refer to the "overview":/rest.
...
h2(#channel-status-object). Channel Status Object
...
h2(#channels-object-toc). Channels Object
