...
And then run the app locally by adding your "Ably API key":https://support.ably.com/support/solutions/articles/3000030502-setting-up-and-managing-api-keys and Google Map API key to @companion/index.js@ and run
