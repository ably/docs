...
* Understand how to effectively [manage connections](/docs/connect?lang=react#close).
* Explore more [advanced](/docs/pub-sub/advanced?lang=react) Pub/Sub concepts.

You can also explore the [Ably CLI](https://www.npmjs.com/package/&#64;ably/cli) further, or visit the Pub/Sub [API references](/docs/pub-sub/api/javascript/realtime/realtime-client).
