---
title: About Spaces
intro: "Spaces enables collaborative application features like live cursors, avatar stacks, and component locking. This SDK manages participant state and application state separately for efficient realtime collaboration."
meta_description: "Ably Spaces: build collaborative apps with live cursors, avatar stacks, and component locking through efficient participant and application state management."
redirect_from:
