...
- data.channelId := name of the channel that the presence event belongs to
- data.status := a "@ChannelStatus@":/api/realtime-sdk/channel-meta#channel-details object
