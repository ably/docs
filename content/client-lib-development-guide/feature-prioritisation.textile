...
* Simple realtime connection over "WebSockets":https://www.ably.io/topic/websockets with JSON & MessagePack support - see "#initialization, #connect and #close within connection spec":https://github.com/ably/ably-ruby/blob/master/SPEC.md#ablyrealtimeconnection and "ProtocolMessage object spec":https://github.com/ably/ably-ruby/blob/master/SPEC.md#ablymodelsprotocolmessage
