...
Use the "@create tables@":#create command to automatically create the required tables in your database. This requires the application to use a PostgreSQL user that has been granted @CREATE@ permissions on the desired schemas.
