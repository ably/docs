  ...
  sections: [
    {
      ...
      features: [],
      releaseStage: '',
      callToAction: { text: 'View setup instructions', href: '/docs/chat/setup', type: 'link' },
    },
    {
      title: 'Demo',
      ...
      cards: [
        {
          ...
          image: 'demo.svg',
          links: [{ text: 'View demo', href: 'https://ably-livestream-chat-demo.vercel.app/' }],
        },
      ],
    },
    {
      ...
      cards: [
        {
          ...
          image: 'rooms.svg',
          links: [{ text: 'Read docs', href: '/docs/chat/rooms' }],
        },
        {
          ...
          image: 'reactions.svg',
          links: [{ text: 'Read docs', href: '/docs/chat/rooms/reactions' }],
        },
        {
          title: 'Online status',
          type: 'feature',
          ...
          image: 'presence.svg',
          links: [{ text: 'Read docs', href: '/docs/chat/rooms/presence' }],
        },
        {
          ...
          image: 'typing.svg',
          links: [{ text: 'Read docs', href: '/docs/chat/rooms/typing' }],
        },
      ],
    },
  ],
