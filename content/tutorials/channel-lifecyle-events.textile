...
TODO - ADD SCREENSHOT FROM THE DASHBOARD AFTER PRIVILEGES LIST IS UPDATED

Under normal circumstances, you won't be granted permission to publish to or be present in meta-channels.
...
var apiKey = 'TODO-REPLACE-LIVE-DEMO-EMBED';
var myId = "id-" + Math.random().toString(36).substr(2, 16)
var ably = new Ably.Realtime({ 
    key: apiKey,
    clientId: myId 
