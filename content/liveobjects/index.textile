...
Ably LiveObjects allows you to synchronize application state in realtime across multiple users and devices at any scale. It automatically resolves conflicts in the background, ensuring seamless synchronization. LiveObjects are managed and persisted on a per-channel basis, allowing you to maintain different states across multiple "realtime channels":/docs/channels within your application.

LiveObjects provides a set of purpose-built APIs and data structures that abstract away the complexity of persisting and synchronizing application state across devices. It is built on top of Ably "Channels":/docs/channels and offers the same performance guarantees and scaling potential.
