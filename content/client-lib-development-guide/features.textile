...
** @(RSH8e)@ If the @LocalDevice@ @clientId@ becomes set as a result of @(RSH8d)@, and the @LocalDevice@ is already registered (ie the @deviceIdentityToken@ is set), and the ActivationStateMachine is in any state other than @NotActivated@, then a @GotPushDeviceDetails@ event is sent to "the state machine":#RSH3 once the effects of @(RSH8d)@ are visible, ie. once @LocalDevice@ @clientId@ is set.
