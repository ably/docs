...
blang[android].
  ...
  Then run the demo locally by adding your "Ably API key":https://knowledge.ably.com/setting-up-and-managing-api-keys-1 to @server.js@ and running the demo @node server.js@
...
blang[java].
  ...
  And then run the demo locally by adding your "Ably API key":https://knowledge.ably.com/setting-up-and-managing-api-keys-1 to @Example.java@ and running the demo:
...
blang[nodejs].
  ...
  And then run the demo locally by adding your "Ably API key":https://knowledge.ably.com/setting-up-and-managing-api-keys-1 to @server.js@ and running the demo @node server.js@
...
blang[ruby].
  ...
  And then run the demo locally by adding your "Ably API key":https://knowledge.ably.com/setting-up-and-managing-api-keys-1 to @server.rb@ and running the demo @bundle exec ruby server.rb@
