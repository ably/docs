...
```
// We need to figure out which classes are meant to have constructors
...
// RSA8c3 implies these should be in ClientOptions too (which, if you accept that ClientOptions inherits from AuthOptions, is the case, but see above that this isn’t made explicit)
