...
Ably delivers location updates with a [global median latency of 37ms](/docs/platform/architecture/latency), ensuring members see each other's location changes nearly instantaneously for a seamless collaborative experience.
</Aside>
