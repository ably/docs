...
// `colorClass` is a Tailwind text-colour utility applied to a default `Badge`
// (neutral background, coloured uppercase label). These mirror the per-product
// colours used on the Examples grid (see ExamplesGrid `badgeColorForProduct`)
