...
export const interactiveButtonClassName = cn(
  ...
  'text-neutral-900 dark:text-neutral-400 hover:text-neutral-1300 dark:hover:text-neutral-000 disabled:text-gui-disabled-light dark:disabled:text-gui-disabled-dark disabled:pointer-events-none',
