...
intro: "Message batching groups messages before delivery or publishes to multiple channels in a single request. This reduces costs in high-throughput scenarios and enables atomic publishing."
