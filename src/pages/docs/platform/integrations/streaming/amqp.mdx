...
intro: "Stream Realtime events directly to AMQP compatible message brokers for reliable message processing and routing. Forward messages, presence events, and channel lifecycle data automatically with configurable encoding and envelope options."
