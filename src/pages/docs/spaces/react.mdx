---
title: React Hooks
intro: Build collaborative React applications with dedicated Spaces hooks for avatar stacks, member locations, live cursors, and component locking. Integrate Realtime collaboration features using familiar React patterns and state management.
