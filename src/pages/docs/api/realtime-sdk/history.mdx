...
|-----------|-------------|------|
| <If lang="javascript,nodejs">params</If><If lang="java">option</If> | <If lang="javascript,nodejs">an optional object containing the query parameters</If><If lang="java">an optional array containing the query parameters</If> | <If lang="javascript,nodejs">`Object`</If><If lang="java">[`Param[]`](#param)</If> |
...
| Parameter | Description | Type |
|-----------|-------------|------|
| <If lang="ruby">option</If><If lang="swift,objc">query</If><If lang="csharp">query</If> | <If lang="ruby">an optional set of key value pairs containing the query parameters</If><If lang="swift,objc">an optional object containing the query parameters</If><If lang="csharp">an optional object containing the query parameters</If> | <If lang="ruby">`Hash`</If><If lang="swift,objc">`ARTRealtimeHistoryQuery`</If><If lang="csharp">[`PaginatedRequestParams`](#paginated-request-params)</If> |
| <If lang="ruby">&block</If><If lang="swift,objc">callback</If><If lang="csharp">untilAttach</If> | <If lang="ruby">yields a `PaginatedResult<Message>` object</If><If lang="swift,objc">called with a [ARTPaginatedResult](#paginated-result)&lt;[ARTMessage](#message)&gt; object or an error</If><If lang="csharp">when true, ensures message history is up until the point of the channel being attached. <br />_Default: `false`_</If> | <If lang="ruby">`Block`</If><If lang="swift,objc">`Callback`</If><If lang="csharp">`Boolean`</If> |
...
| <If lang="javascript,nodejs">limit</If><If lang="ruby">:limit</If><If lang="java,swift,objc">limit</If> | Maximum number of messages to retrieve up to 1,000. <br />_Default: `100`_ | <If lang="javascript,nodejs">`Number`</If><If lang="ruby,java,swift,objc">`Integer`</If> |
...
| Limit | Maximum number of messages to retrieve up to 1,000. <br />_Default: `100`_ | `Integer` |
