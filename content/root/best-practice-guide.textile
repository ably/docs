...
You can publish data to named "channels":/realtime/channels/overview within Ably's platform and the platform will make sure that all clients subscribed to these channels will receive the data in realtime.
