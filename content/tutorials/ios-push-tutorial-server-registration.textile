...
<a href="https://github.com/ably/tutorials/pull/56/commits/0914d0c368efebedf0a04271a559693ca0661b97">See this step in git.<a/>

h2(#step5). Step 5 - Setting up a Node.js server for authentication

<%= partial 'shared/tutorials/_setup_node_push_auth' %>

<a href="https://github.com/ably/tutorials/pull/56/commits/8b26c839ada99ae20f98840ae1e36dd352910b8b">See this step in git.<a/>

h2(#step6). Step 6 - Setting up device registration via the server

<%= partial 'shared/tutorials/_setup_node_push_registration' %>

<a href="https://github.com/ably/tutorials/pull/56/commits/d44db117ab56e071d5fc858694253fadde98640d">See this step in git.<a/>
...
<a href="https://github.com/ably/tutorials/pull/56/commits/974d278c64707a258cbda7f0ebf833c39e8dcc78"> See this step in git.<a/>

h2(#further-reading). Further Reading

* The source code for this tutorial can be found <a href="https://github.com/ably/tutorials/pull/56">here.<a/>
