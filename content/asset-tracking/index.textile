...
The Ably Asset Tracking solution provides two "SDKs":using-the-sdks:
...
The following diagram illustrates the dynamic resolution policy logic:

<a href="/images/diagrams/asset-tracking/default-resolution-policy.png" target="_blank">
  <img src="/images/diagrams/asset-tracking/default-resolution-policy.png" style="width: 100%" alt="Default resolution policy">
</a>
