...
blang[java,csharp].
  <%= partial 'types/versions/v0.8/_ably_exception', indent: 2, skip_first_indent: true %>

blang[ruby].
  <%= partial 'types/versions/v0.8/_base_ably_exception', indent: 2, skip_first_indent: true %>
...
<%= partial 'types/versions/v0.8/_error_info' %>
...
<%= partial 'types/versions/v0.8/_message' %>
...
blang[objc,swift].
  <%= partial 'types/versions/v0.8/_channel_event', indent: 2, skip_first_indent: true %>
...
<%= partial 'types/versions/v0.8/_channel_options' %>
...
<%= partial 'types/versions/v0.8/_channel_state' %>

h3(#channel-state-listener).
  java:   io.ably.lib.realtime.ChannelStateListener

blang[java].
  <%= partial 'types/versions/v0.8/_channel_state_listener', indent: 2, skip_first_indent: true %>
...
<%= partial 'types/versions/v0.8/_cipher_params' %>
...
blang[java].
  <%= partial 'types/versions/v0.8/_message_listener', indent: 2, skip_first_indent: true %>
...
blang[ruby].
  ...
  <%= partial 'types/versions/v0.8/_deferrable', indent: 2, skip_first_indent: true %>

h3(#stats-data-request-query).
  csharp: IO.Ably.StatsDataRequestQuery

blang[csharp].
  <%= partial 'types/versions/v0.8/_stats_data_request_query', indent: 2, skip_first_indent: true %>
