...
From the "tutorial repository":http://todo-repository-link, download the "pizza.js":http://todo-repository-link/azure-files/pizza.js file.
...
<a href="/images/tutorials/reactor-event-azure-function-4.png" target="_blank">
  <img src="/images/tutorials/reactor-event-azure-function-4.png" style="width: 100%" alt="Authorization level should be 'Anonymous'">
</a>

h2. Step 3: Configure an Ably Reactor event
...
Just as in step 1-b of this tutorial, go to the dashboard for the Ably app you're using. From there, click the "Reactor" tab, followed by "New Reactor Rule":
