...
- @previous@ := the previous state<br>__Type: "Channel::STATE":/realtime/types#channel-state>__
- @current@ := the new state<br>__Type: "Channel::STATE":/realtime/types#channel-state>__
