...
Use channel namespaces to apply operations to all channels within that group, such as "capabilities":/auth/capabilities, "channel rules":#rules and "integrations":/integrations.
