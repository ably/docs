...
blang[flutter].
  The Ably library is "hosted on Github":https://github.com/ably/ably-flutter and is available as a "Flutter plugin":https://pub.dev/packages/ably_flutter_plugin. Update your @pubspec.yaml@ with appropriate package version:
