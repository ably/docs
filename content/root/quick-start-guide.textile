...
blang[flutter].
  The Ably library is "hosted on Github":https://github.com/ably/ably-flutter and is available as a "Flutter plugin":https://pub.dev/packages/ably-flutter/. Update your @pubspec.yaml@ with appropriate package version:
...
Publishing a message to a channel is straightforward and is supported by both our Realtime and REST libraries. "When should I use a Realtime library vs a REST library?":https://knowledge.ably.com/should-i-use-the-rest-or-realtime-library-2.
