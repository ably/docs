...
intro: "Activate mobile devices to receive push messages through platform-specific services like FCM and APNs. The Push API manages device registration, subscription, notification delivery, and mobile engagement features."
