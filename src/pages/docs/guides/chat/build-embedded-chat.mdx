...
meta_keywords: "embedded chat, contextual chat, 1:1 chat, small group chat, realtime messaging, support tickets, delivery tracking, gaming chat, Ably Chat, chat SDK, dependability, cost optimization"
---
...
Using [server-side batching](/docs/messages/batch#server-side), Ably effortlessly handles thousands of presence participants per room without impacting performance.

Presence is especially valuable for scenarios where task completion depends on participant availability, or when showing who is online can directly enhance the user experience:
