...
Queues rules are setup in the "Reactor tab":https://knowledge.ably.com/how-can-i-set-up-a-queue-rule found "within your app dashboard":https://knowledge.ably.com/how-do-i-access-my-app-dashboard. For internal queue rules you set up you will need to configure:
