...
- <div lang="javascript,nodejs">String state</div> := the connection state to subscribe to
...
- <div lang="javascript,nodejs">listener</div> := is a function of the form @listener(stateChange)@ to be notified for matching state changes
...
- <div lang="javascript,nodejs">listener</div> := is a function of the form @listener(stateChange)@ to be notified for a single occurence of a matching state change
...
- <div lang="javascript,nodejs">String state</div> := the connection state to unsubscribe from
...
- <div lang="javascript,nodejs">listener</div> := is the listener function to be removed
