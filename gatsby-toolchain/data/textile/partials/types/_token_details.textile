...
- <span lang="default">token</span><span lang="csharp,go">Token</span> := The "Ably Token":/core-features/authentication#ably-tokens itself. A typical "Ably Token":/core-features/authentication#ably-tokens string may appear like @{{TOKEN}}@<br>__Type: @String@__
