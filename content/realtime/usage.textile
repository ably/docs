...
The Ably Realtime library constructor is overloaded allowing it to be instanced using a "@ClientOptions@":#client-options object, or more simply using a string containing an "API key":/general/authentication/#basic-authentication or "Token":/general/authentication/#token-authentication, as shown below:
