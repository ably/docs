---
title: Encryption
intro: "Encrypt message payloads at the channel level using AES encryption before transmission to Ably. The Crypto API manages encryption keys, cipher parameters, automated encrypt/decrypt operations, and secure messaging protocols."
