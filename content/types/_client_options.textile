...
- <span lang="default">useTokenAuth</span><span lang="ruby">:use_token_auth</span> := When true, forces "Token authentication":/general/authentication#token-authentication to be used by the libary.<br>__Type: @Boolean@__
