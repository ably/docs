...
Due to this, we do not support "enveloping":/docs/general/webhooks#envelope, "batching":/docs/general/webhooks#batching, or MsgPack encoding for IFTTT. In addition, any communication which requires decoding on the other end, such as messages sent via "MQTT":/protocols/mqtt will not be able to pass data on to IFTTT.
