...
Account-level and app-level statistics can also be retrieved from the "Control API.":/docs/account/control-api
...
App-level statistics are available as graphs, as tabular data, and for download from your "application dashboard":https://ably.com/accounts/any/apps/any for each application in your account. They can also be subscribed to using the "@[meta]stats:minute@ metachannel":/docs/metadata-stats/metadata/subscribe#stats.
