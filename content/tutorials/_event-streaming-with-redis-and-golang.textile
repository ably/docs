...
excerpt: Combining Go, Redis, and Ably to build an easily scalable infrastructure
  for streaming large amounts of traffic to clients
external: true
group: sdk
index: 116
languages:
...
meta_description: "Combining Go, Redis, and Ably to build an easily scalable infrastructure for streaming large amounts of traffic to clients."
meta_keywords: "Go, Redis, Ably realtime, streaming"
