---
title: MQTT
intro: Connect any MQTT enabled device to Ably's Realtime infrastructure through Ably's lightweight protocol adapter. This is ideal for IoT devices, Arduino platforms, and constrained environments where bandwidth optimization is critical.
