...
- AWS Authentication Scheme := the "authentication scheme":https://knowledge.ably.com/authentication-for-reactor-rules-for-aws-reactor-events-for-lambda-functions-reactor-firehose-for-aws-sqs-and-kinesis-1 you wish to use for your function. Either @AWS Credentials@ or @ARN of an assumable role@
...
- AWS Credentials := a key:value pair which match your "AWS credentials":https://knowledge.ably.com/authentication-for-reactor-rules-for-aws-reactor-events-for-lambda-functions-reactor-firehose-for-aws-sqs-and-kinesis-1

<br/>

If the Rule is using *ARN of an assumable role* to authenticate, it will also have the following options:

- Assume Role ARN := your "ARN":https://knowledge.ably.com/authentication-for-reactor-rules-for-aws-reactor-events-for-lambda-functions-reactor-firehose-for-aws-sqs-and-kinesis-1 which will work for this AWS Lambda function
