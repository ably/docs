...
**Important:** Do not use token authentication to authenticate your server with Ably, as this results in unnecessary overhead - the server will periodically need to reauthenticate with Ably. Simply use basic authentication to authenticate your server with Ably.
