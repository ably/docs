...
Comet operations are performed over HTTP or HTTPS to the Ably REST host (rest.ably.io or one of the "fallback hosts":/client-lib-development-guide#realtime-transports).
