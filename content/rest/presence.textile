...
bc[ruby]. presence = channel.presence
...
- <span lang="default">option</span><span lang="java">"Param":#param[] option</span> := <span lang="default">an optional object containing query parameters</span><span lang="ruby">an optional set of key value pairs containing query parameters</span>, as specified in the "presence history API documentation":/rest/history#presence-history.
...
Further details of the supported @option@ params, see "presence history API documentation":/rest/history#presence-history.
