...
This step is optional. If you prefer not to use the Ably CLI to interact with your Pub/Sub React Native application, you can still
follow along by using multiple browser windows, mobile devices or emulators.
