...
- <span lang="default">timestamp</span><span lang="csharp,go">Timestamp</span> := Timestamp when the message was received by the Ably service, as <span lang="default">milliseconds since the epoch</span><span lang="ruby">a @Time@ object</span><br>__Type: <span lang="default">@Integer@</span><span lang="java">@Long Integer@</span><span lang="csharp">@DateTimeOffset@</span><span lang="ruby">@Time@</span><span lang="objc,swift">@NSDate@</span>__
