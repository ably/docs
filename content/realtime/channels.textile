...
final channelMessageSubscription = channel.on().listen((ably.ChannelStateChange state){
  switch (state.current) {
...
bc[flutter]. final stateChangeListener = channel.on(ably.ChannelEvent.attached)
...
bc[flutter]. final stateChangeListener = channel.on()
