...
Subscribe to receive messages in a room by registering a listener. Use the <If lang="javascript">[`messages.subscribe()`](/docs/sdk/chat-js/v0/interfaces/chat-js.Messages.html#subscribe)</If><If lang="swift">[`messages.subscribe()`](/docs/sdk/chat-swift/v0/messages/subscribe%28%29-360z1)</If><If lang="kotlin">[`messages.subscribe()`](/docs/sdk/chat-kotlin/v0/chat-android/com.ably.chat/-messages/subscribe.html)</If> method in a room to receive all messages that are sent to it:
</If>

<If lang="react">
Subscribe to messages with the [`useMessages`](/docs/sdk/chat-react/v0/functions/chat-react.useMessages.html) hook. Supply a listener and the hook will automatically subscribe to message events sent to the room. As long as a defined value is provided, the subscription will persist across renders. If the listener value is undefined, the subscription will be removed until it becomes defined again.
...
<If lang="javascript,swift,kotlin">
Use the <If lang="javascript">[`messages.send()`](/docs/sdk/chat-js/v0/interfaces/chat-js.Messages.html#send)</If><If lang="swift">[`messages.send()`](/docs/sdk/chat-swift/v0/messages/send%28params%3A%29)</If><If lang="kotlin">[`messages.send()`](/docs/sdk/chat-kotlin/v0/chat-android/com.ably.chat/-messages/send.html)</If> method to send a message in a chat room. All users that are [subscribed](#subscribe) to messages on that room will receive it:
</If>

<If lang="react">
Use the [`send()`](/docs/sdk/chat-react/v0/interfaces/chat-react.UseMessagesResponse.html#send) method available from the response of the `useMessages` hook to send a message to the room:
</If>
...
<If lang="javascript,swift,kotlin">
Use the <If lang="javascript">[`messages.update()`](/docs/sdk/chat-js/v0/interfaces/chat-js.Messages.html#update)</If><If lang="swift">[`messages.update()`](/docs/sdk/chat-swift/v0/messages/update%28newmessage:description:metadata:%29)</If><If lang="kotlin">[`messages.update()`](/docs/sdk/chat-kotlin/v0/chat-android/com.ably.chat/-messages/update.html)</If> method to update a message in a chat room. All users that are [subscribed](#subscribe) to messages on that room will receive the update:
</If>

<If lang="react">
Use the [`update()`](/docs/sdk/chat-react/v0/interfaces/chat_react.UseMessagesResponse.html#update) method available from the response of the `useMessages` hook to update a message in the room:
</If>
...
<If lang="javascript,swift,kotlin">
Use the <If lang="javascript">[`messages.subscribe()`](/docs/sdk/chat-js/v0/interfaces/chat-js.Messages.html#subscribe)</If><If lang="swift">[`messages.subscribe()`](/docs/sdk/chat-swift/v0/messages/subscribe%28%29-8jolq)</If><If lang="kotlin">[`messages.subscribe()`](/docs/sdk/chat-kotlin/v0/chat-android/com.ably.chat/-messages/subscribe.html)</If> method to receive messages in a room. To filter for updated messages, provide a listener that checks the <If lang="javascript,kotlin">`type`</If><If lang="swift">`action`</If> property of the message event:
</If>

<If lang="react">
Use the [`useMessages`](/docs/sdk/chat-react/v0/functions/chat_react.useMessages.html) hook to subscribe to messages in a room. To filter for updated messages, provide a listener that checks the `type` property of the message event:
</If>
...
<If lang="javascript,swift,kotlin">
Use the <If lang="javascript">[`messages.delete()`](/docs/sdk/chat-js/v0/interfaces/chat-js.Messages.html#delete)</If><If lang="swift">[`messages.delete()`](/docs/sdk/chat-swift/v0/messages/delete%28message:params:%29)</If><If lang="kotlin">[`messages.delete()`](/docs/sdk/chat-kotlin/v0/chat-android/com.ably.chat/-messages/delete.html)</If> method to delete a message in a chat room. All users that are [subscribed](#subscribe) to messages on that room will receive the deletion:
</If>

<If lang="react">
Use the [`deleteMessage()`](/docs/sdk/chat-react/v0/interfaces/chat_react.UseMessagesResponse.html#deleteMessage) method available from the response of the `useMessages` hook to delete a message from the room:
</If>
...
<If lang="javascript,swift,kotlin">
Use the <If lang="javascript">[`messages.subscribe()`](/docs/sdk/chat-js/v0/interfaces/chat-js.Messages.html#subscribe)</If><If lang="swift">[`messages.subscribe()`](/docs/sdk/chat-swift/v0/messages/subscribe%28%29-8jolq)</If><If lang="kotlin">[`messages.subscribe()`](/docs/sdk/chat-kotlin/v0/chat-android/com.ably.chat/-messages/subscribe.html)</If> method to receive messages in a room. To filter for deleted messages, provide a listener that checks the <If lang="javascript,kotlin">`type`</If><If lang="swift">`action`</If> property of the message event:
</If>

<If lang="react">
Use the [`useMessages`](/docs/sdk/chat-react/v0/functions/chat_react.useMessages.html) hook to subscribe to messages in a room. To filter for deleted messages, provide a listener that checks the `type` property of the message event:
</If>
...
The `Message` object also has convenience methods [`before`](/docs/sdk/chat-js/v0/interfaces/chat-js.Message.html#before), [`after`](/docs/sdk/chat-js/v0/interfaces/chat-js.Message.html#after) and [`equal`](/docs/sdk/chat-js/v0/interfaces/chat-js.Message.html#equal) which provide the same comparison.
...
The `Message` object also has convenience methods [`isOlderVersionOf`](/docs/sdk/chat-js/v0/interfaces/chat-js.Message.html#isolderversionof), [`isNewerVersionOf`](/docs/sdk/chat-js/v0/interfaces/chat-js.Message.html#isnewerversionof) and [`isSameVersionAs`](/docs/sdk/chat-js/v0/interfaces/chat-js.Message.html#issameversionas) which provide the same comparison.

Update and Delete events provide the message payload without message reactions. To correctly use message reactions, always use the [`with()`](/docs/sdk/chat-js/v0/interfaces/chat-js.Message.html#with) method to apply the event to the message instance.

## Keep messages updated using with() <a id="keep-messages-updated"/>

The [`Message`](/docs/sdk/chat-js/v0/interfaces/chat-js.Message.html) object has a method [`with`](/docs/sdk/chat-js/v0/interfaces/chat-js.Message.html#with) that takes a [`MessageEvent`](/docs/sdk/chat-js/v0/interfaces/chat-js.MessageEvent.html), automatically compares versions, and returns the newest `Message` instance. For updates and deletes, if `with` is called with an event that is older than the message, the message is returned. If it is called with a newer event, the message from the event is returned. For message reaction events, the reactions will be correctly applied to the returned message.
...
```react
import { ChatMessageEventType, useMessages, Message } from '@ably/chat';
