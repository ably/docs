...
<Aside data-type='important'>
While using an API key is fine for this guide, you should never embed your API key in a mobile app in production. Use [token authentication](/docs/platform/auth/token) in production to keep your API key secure on your server.
</Aside>
