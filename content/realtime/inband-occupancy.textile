...
meta_description: "Inband occupancy events are events on a user-defined channel that contains occupancy data for the channel."
...
In this case only occupancy metrics for @subscribers@ will be contained in occupancy messages.
