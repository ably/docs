...
Use the <If lang="javascript">[`messages.history()`](/docs/sdk/chat-js/v0/interfaces/chat-js.Messages.html#history)</If><If lang="swift">[`messages.get()`](https://sdk.ably.com/builds/ably/ably-chat-swift/main/AblyChat/documentation/ablychat/messages/get%28options%3A%29)</If><If lang="kotlin">[`messages.get()`](/docs/sdk/chat-kotlin/v0/-messages/get.html)</If> method to retrieve messages that have been previously sent to a room. This returns a paginated response, which can be queried further to retrieve the next set of messages.
</If>
