...
h2(#jwt-claims). Using JWT for per connection publish rate limits
...
To set rate limits for individual connections, include @ably.limits.<resource-name>@ in your JWT authentication payload, for example:
