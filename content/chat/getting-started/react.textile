...
h2(#providers-setup). 1: Setting up the Ably and Chat client providers
...
h3(#imports). Required imports

You will also need the following imports in your @src/App.tsx@ file, these will be used at various points in the guide:
