...
{/* Swift example test harness: func exampleOS1_userEnterPresence(ably: ARTRealtime) { */}
```swift
// Client code
let channel = ably.channels.get("{{RANDOM_CHANNEL_NAME}}")

// Enter presence with metadata about the user's device
channel.presence.enter(["device": "mobile", "platform": "ios"]) { error in
    if let error = error {
        print("Error entering presence: \(error.message)")
        return
    }
    print("Entered presence successfully")
}
```
{/* --- end example code --- */}
</Code>
...
{/* Swift example test harness: func exampleOS2_agentEnterPresence(ably: ARTRealtime) { */}
```swift
// Agent code
let channel = ably.channels.get("{{RANDOM_CHANNEL_NAME}}")

// Enter presence with metadata about the agent
channel.presence.enter(["model": "gpt-4"]) { error in
    if let error = error {
        print("Error entering presence: \(error.message)")
        return
    }
    print("Agent entered presence successfully")
}
```
{/* --- end example code --- */}
</Code>
...
{/* Swift example test harness: func exampleOS3_desktopEnterPresence(ably: ARTRealtime) { */}
```swift
// Client code (device 1: desktop browser)
let channel = ably.channels.get("{{RANDOM_CHANNEL_NAME}}")
channel.presence.enter(["device": "desktop"]) { error in
    if let error = error {
        print("Error entering presence: \(error.message)")
    }
}
...
{/* Swift example test harness: func exampleOS4_mobileEnterPresence(ably: ARTRealtime) { */}
```swift
// Client code (device 2: mobile app)
let channel = ably.channels.get("{{RANDOM_CHANNEL_NAME}}")
channel.presence.enter(["device": "mobile"]) { error in
    if let error = error {
        print("Error entering presence: \(error.message)")
    }
}
...
{/* Swift example test harness: func exampleOS5_queryPresence(channel: ARTRealtimeChannel) { */}
```swift
// Query presence to see both devices
channel.presence.get { members, error in
    if let error = error {
        print("Error getting presence: \(error.message)")
        return
    }
...
{/* Swift example test harness: func exampleOS6_userLeavePresence(ably: ARTRealtime) { */}
```swift
// Client code
let channel = ably.channels.get("{{RANDOM_CHANNEL_NAME}}")
...
channel.presence.leave(nil) { error in
    if let error = error {
        print("Error leaving presence: \(error.message)")
    }
}
```
{/* --- end example code --- */}
...
{/* Swift example test harness: func exampleOS7_agentLeavePresence(ably: ARTRealtime) { */}
```swift
// Agent code
let channel = ably.channels.get("{{RANDOM_CHANNEL_NAME}}")
...
{/* Swift example test harness: func exampleOS8_leaveWithReason(channel: ARTRealtimeChannel) { */}
```swift
// Leave with a reason
...
{/* Swift example test harness: func exampleOS9_subscribeToLeave(channel: ARTRealtimeChannel) { */}
```swift
// Subscribe to leave events to see why members left
channel.presence.subscribe(.leave) { presenceMessage in
    print("\(presenceMessage.clientId ?? "") left")
    if let data = presenceMessage.data as? [String: Any],
...
{/* Swift example test harness: func exampleOS10_configureTransportParams() { */}
```swift
// Agent code
...
options.transportParams = [
    "remainPresentFor": ARTStringifiable.withNumber(30000)
]
...
{/* Swift example test harness: func exampleOS11_getMembers(channel: ARTRealtimeChannel) { */}
```swift
// Get all currently present members
channel.presence.get { members, error in
    if let error = error {
...
{/* Swift example test harness: func exampleOS12_subscribeToChanges(ably: ARTRealtime) { */}
```swift
// Client code
let channel = ably.channels.get("{{RANDOM_CHANNEL_NAME}}")
...
{/* Swift example test harness: func exampleOS13_subscribeSpecificEvents(channel: ARTRealtimeChannel) { */}
```swift
// Subscribe only to enter events
...
{/* Swift example test harness: func exampleOS14_detectOfflineAllDevices(ably: ARTRealtime, targetUserId: String) { */}
```swift
// Agent code
let channel = ably.channels.get("{{RANDOM_CHANNEL_NAME}}")
...
channel.presence.subscribe { presenceMessage in
    ...
    channel.presence.get { members, error in
        ...
        // Check if a specific client is offline
        let clientIds = members.compactMap { $0.clientId }
        if !clientIds.contains(targetUserId) {
