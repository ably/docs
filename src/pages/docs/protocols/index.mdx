---
title: Protocols
intro: "Protocol adapters enable Ably connectivity using MQTT, SSE, and Pusher when SDKs aren't available or resources are constrained. These lightweight alternatives support core messaging and facilitate platform migration with minimal overhead."
meta_description: "Ably protocol adapters: connect via MQTT, SSE, and Pusher protocols when SDKs aren't available, with lightweight messaging and migration support."
redirect_from:
