...
| userClaim | The user claim attached to this presence event by the server. Only present if the user's [JWT](/docs/platform/auth/token#jwt) contained a claim for the room. | String or Undefined |
