...
intro: Single sign-on enables user authentication through your existing SAML-compatible identity provider, streamlining access management. Configure strict mode to enforce identity provider authentication and maintain centralized access control.
