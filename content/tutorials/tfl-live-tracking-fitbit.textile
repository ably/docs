...
And then run the app locally by adding your "Ably API key":https://knowledge.ably.com/setting-up-and-managing-api-keys-1 and Google Map API key to @companion/index.js@ and run
