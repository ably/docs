...
The Auth object is available as the <span lang="java">"@auth@ field":/api/rest-sdk/index#auth</span><span lang="default">"@auth@ property":/api/rest-sdk/index#auth</span><span lang="csharp">"@Auth@ property":/api/rest-sdk/index#auth</span><span lang="ruby">"@auth@ attribute":/api/rest-sdk/index#auth</span> of an "Ably REST client instance":/api/rest-sdk/index#constructor.
