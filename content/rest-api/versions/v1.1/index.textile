...
Using one of the application keys created via the "application dashboard":https://knowledge.ably.com/how-do-i-access-my-app-dashboard, basic authentication provides the simplest method to authenticate with Ably, but has two important limitations:
...
If you wish to publish a message to multiple channels at once, you should consider using our "batch publish functionality":/rest-api/batch.
