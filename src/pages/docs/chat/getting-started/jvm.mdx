...
Create a `Main.kt` file in your `src/main/kotlin/com/example` directory and add the following code to set up the Ably client.
...
Add the following code after sending the first message to demonstrate message editing:
