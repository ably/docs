...
The following example demonstrates how to set up the Ably Realtime client using an "Ably subdomain:":/platform-customization/#option-1
...
The following example demonstrates how to set up the Ably Realtime client using "your own subdomain:":/platform-customization/#option-2
...
restHost: 'rest.example.com', // Your custom REST endpoint
  fallbackHosts: [
    'a-fallback.yourdomain.com',
    'b-fallback.yourdomain.com'
  ]
});
```
 ...
 <aside data-type='note'>
  <p>
    Although the provided example code is in JavaScript, the options demonstrated are common across all client library SDKs.
  </p>
  </aside>
