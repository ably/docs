...
bq(definition#on-state-listener).
  ...
  csharp:  void On("ConnectionState":#connection-state @event, Action<"ConnectionStateChangehEventArgs":#connection-state-change> action)
...
bq(definition#on-listener).
  ...
  csharp:  void On(Action<"ConnectionStateChangehEventArgs":#connection-state-change> action)
...
bq(definition#once-state-listener).
  ...
  csharp:  void Once("ConnectionState":#connection-state @event, Action<"ConnectionStateChangehEventArgs":#connection-state-change> action)
...
bq(definition#once-listener).
  ...
  csharp:  void Once(Action<"ConnectionStateChangehEventArgs":#connection-state-change> action)
...
bq(definition#off-state-listener).
  ...
  csharp:  void Off("ConnectionState":#connection-state @event, Action<"ConnectionStateChangehEventArgs":#connection-state-change> action);
...
bq(definition#off-listener).
  ...
  csharp:  void Off(Action<"ConnectionStateChangehEventArgs":#connection-state-change> action);
