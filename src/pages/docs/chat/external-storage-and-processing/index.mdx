...
Extract and process messages through external systems, then respond back to the chat in realtime. See the [processing guide](/docs/chat/external-storage-and-processing/data-processing) for implementation details.
...
Export chat messages to your own database for long-term storage and additional capabilities. See the [storage guide](/docs/chat/external-storage-and-processing/data-storage) for implementation details.
