...
For token authentication you'll be required to "create a token from your own servers":https://www.ably.io/documentation/general/authentication#token-authentication. Once you have the token, you can simply pass it through when trying to connect to Ably as the connection's @username@, leaving the @password@ empty. In the future we will be adding "JWT":https://jwt.io/ (JSON Web Tokens) as a form of authentication.
...
If you would like to see an example of using the MQTT tutorial, we recommend you take a look at our "MQTT snake tutorial":https://www.ably.io/tutorials/mqtt-snake.
