...
By default, channels will only store messages in memory for up to two minutes. However, using "channel rules":https://knowledge.ably.com/what-are-channel-rules-and-how-can-i-use-them-in-my-app-1, you can configure messages published on matching channels to be persisted to disk for "typically 24 - 72 hours":https://knowledge.ably.com/how-long-are-messages-stored-for-1. Those messages will then be immediately available for retrieval via our Realtime and REST API clients for as long as the message is stored on disk.
...
# Visit your "account dashboard":https://knowledge.ably.com/how-do-i-access-my-account-dashboard-1, navigate to the same app you chose in Step 1 when obtaining your API key earlier
...
blang[java].
  ...
  Don't forget to replace your @ExampleActivity#API_KEY@ field with "Ably API key":https://knowledge.ably.com/setting-up-and-managing-api-keys-1.
...
blang[javascript].
  ...
  And then run the demo locally by adding your "Ably API key":https://knowledge.ably.com/setting-up-and-managing-api-keys-1 to @example.html@ and opening the page in your browser.
...
blang[ruby].
  ...
  And then run the demo locally by adding your "Ably API key":https://knowledge.ably.com/setting-up-and-managing-api-keys-1 to @example.rb@ and running the demo @bundle exec ruby example.rb@
...
blang[php].
  ...
  And then run the demo locally by adding your "Ably API key":https://knowledge.ably.com/setting-up-and-managing-api-keys-1 to @history.php@, install the composer dependencies with:
...
blang[python].
  ...
  And then run the demo locally by adding your "Ably API key":https://knowledge.ably.com/setting-up-and-managing-api-keys-1 to @history.py@, install the required libraries with:
...
blang[swift].
  ...
  Open @example.xcworkspace@ and build the demo on your preferred iPhone simulator or device. Don't forget to replace your @ExampleViewController#API_KEY@ field by adding your "Ably API key":https://knowledge.ably.com/setting-up-and-managing-api-keys-1 to @ExampleViewController.swift@.
