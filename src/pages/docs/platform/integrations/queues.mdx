...
This includes limits like TTL and max length. Even after [upgrading](/docs/platform/pricing/billing) an Ably account, existing queues retain the limits they were created with. Replacement is required to get the higher limits from a new plan.
