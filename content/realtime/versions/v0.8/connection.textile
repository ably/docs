...
<%= partial 'types/versions/v0.8/_connection_state' %>

h3(#connection-state-listener).
  java: io.ably.lib.realtime.ConnectionStateListener

blang[java].
  <%= partial 'types/versions/v0.8/_connection_state_listener', indent: 2, skip_first_indent: true %>
...
blang[javascript].
  <%= partial 'types/versions/v0.8/_last_connection_details', indent: 2, skip_first_indent: true %>
