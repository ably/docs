...
The session exposes the default view as a property. Iterate the visible messages on the selected branch through `getMessages()`:

<Code>
```javascript
const view = session.view;

for (const message of view.getMessages()) {
