...
intro: "Ably offers flexible usage-based pricing with per-minute billing or Monthly Active User models across four package tiers. Each model provides transparent costs for messages, channels, connections, and bandwidth to match your application's needs."
