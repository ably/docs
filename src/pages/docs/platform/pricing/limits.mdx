---
title: Limits
intro: "Limits protect service stability by preventing accidental or deliberate abuse while ensuring cost predictability. These package-based restrictions cover message rates, storage duration, connections, and channels based on your subscription tier."
