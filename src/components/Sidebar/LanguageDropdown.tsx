...
const LanguageDropdownOption = (props: LanguageDropdownOptionProps, showLabel = true) => (
  <div className={cn('flex gap-8 items-center', { 'p-8 pr-16': showLabel })}>
    <div className={cn('flex items-center gap-8', { 'flex-1': showLabel })}>
      <Icon size="20px" name={`icon-tech-${props.data.label}` as IconName} />
      {showLabel ? (
        <a
          className="ui-text-menu3 w-full text-neutral-1100 dark:text-neutral-200 hover:text-neutral-1200 dark:hover:text-neutral-300 transition-colors"
    ...
    <span className="bg-neutral-200 dark:bg-neutral-1100 neutral-800 dark:neutral-500 font-bold px-4 py-2 rounded-md ui-text-menu4 text-[11px] h-20">
