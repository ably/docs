...
- <div lang="php">Object data</div> := data payload for the message. The supported payload types are Strings, Associative Array or Array objects that can be serialised to JSON, binary data as byte arrays, and null.
