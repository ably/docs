...
Ably offers the "Push Notifications":/general/push feature which enables you to send notifications to your clients even when they are not currently using your application and are therefore not connected to Ably. This can be implemented on both mobile devices and browsers. Ably also offers "Smart Notifications":/general/smart-notifications to take into account your user's connection state, their active device and even their current context within your application.
