...
** @(RTN12d)@ If the connection state is @DISCONNECTED@, aborts the retry process described in "RTN14d":#RTN14d and moves the connection immediately to the @CLOSED@ state
** @(RTN12e)@ If the connection state is @SUSPENDED@, aborts the retry process described in "RTN14e":#RTN14e and moves the connection immediately to the @CLOSED@ state
...
** @(RTL4h)@ If the connection state is @CONNECTING@ or @DISCONNECTED@, do the operation once the connection state is @CONNECTED@
...
<tr>
  ...
  <td>"RTL4h":#RTL4h</td>
  <!-- When CONNECTED -->
  <td>"See channel table":#channel-states-operations</td>
  <!-- When DISCONNECTED -->
  <td>"RTL4h":#RTL4h</td>
  <!-- When SUSPENDED -->
  <td>"RTL4b":#RTL4b</td>
