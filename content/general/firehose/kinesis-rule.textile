...
You can use a Kinesis rule to send "data":/docs/general/firehose#data-sources such as messages, occupancy, lifecycle and presence events from Ably to Kinesis.
...
* "Firehose overview":/docs/general/firehose
