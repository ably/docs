...
- <span lang="default">environment</span><span lang="csharp">Environment</span><span lang="ruby">:environment</span> := _''_ Allows a custom environment, region or cluster to be used with the Ably service. Please "contact us":https://www.ably.io/contact if you require a custom environment. Note that once a custom environment is specified, the "fallback host functionality":https://support.ably.io/solution/articles/3000044636-routing-around-network-and-dns-issues is disabled by default.<br>__Type: @String@__
