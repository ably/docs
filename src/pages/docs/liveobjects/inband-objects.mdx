...
If you're using LiveObjects from JavaScript/TypeScript, use the LiveObjects [plugin](/docs/liveobjects/quickstart/javascript) which has dedicated support for all LiveObjects features.
</Aside>
