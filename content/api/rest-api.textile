...
h3(#push-publish). Publish directly to specific recipients
...
h3(#push-publish-batch). Batch publish directly to specific recipients
...
The maximum size of each request body must be less than 2MiB and the total size of all messages in a @messages@ array must be less than the "message size limit":/docs/pricing/limits#message (64kiB by default for paid accounts, 16kiB for free accounts).
