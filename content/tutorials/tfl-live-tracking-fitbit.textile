...
In this tutorial, we will see how to use the "Ably Realtime client library":/basics/use-ably to build a realtime London Tube schedule clockface app for Fitbit. Ably enables realtime data sharing using Pub/Sub messaging architecture via a concept called "channels":/channels.
