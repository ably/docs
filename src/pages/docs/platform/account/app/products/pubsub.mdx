...
The rules section shows the channel's configuration including storage rules (message persistence and history retention), channel rules (security requirements like identification and TLS), and feature rules (push notifications, message annotations).
