...
<If lang="javascript,swift,kotlin">
Use the <If lang="javascript">[`typing.keystroke()`](/docs/sdk/chat-js/v0/interfaces/chat-js.Typing.html#keystroke)</If><If lang="swift">[`typing.keystroke()`](/docs/sdk/chat-swift/v0/documentation/ablychat/typing/keystroke%28%29)</If><If lang="kotlin">[`typing.keystroke()`](/docs/sdk/chat-kotlin/v0/-typing/keystroke.html)</If> method to emit a typing event with `type` set to `typing.started`.
</If>
...
<If lang="javascript,swift,kotlin">
Use the <If lang="javascript">[`stop()`](/docs/sdk/chat-js/v0/interfaces/chat-js.Typing.html#stop)</If><If lang="swift">[`stop()`](/docs/sdk/chat-swift/v0/documentation/ablychat/typing/stop%28%29)</If><If lang="kotlin">[`stop()`](/docs/sdk/chat-kotlin/v0/-typing/stop.html)</If> method to emit a typing event with `isTyping` set to `false`.
</If>
...
<If lang="javascript,swift,kotlin">
Use the <If lang="javascript">[`typing.current()`](/docs/sdk/chat-js/v0/interfaces/chat-js.Typing.html#get)</If><If lang="swift">[`typing.get()`](/docs/sdk/chat-swift/v0/documentation/ablychat/typing/get%28%29)</If><If lang="kotlin">[`typing.get()`](/docs/sdk/chat-kotlin/v0/-typing/get.html)</If> method to retrieve a set of `clientId`s for all users that are currently typing in the room:
</If>
