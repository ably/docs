  ...
  sections: [
    {
      ...
      features: [],
      releaseStage: '',
      callToAction: { text: 'Read more about Asset Tracking', href: '/docs/asset-tracking', type: 'link' },
    },
    {
      ...
      cards: [
        {
          ...
          type: 'feature',
          content:
            'Use the publishing SDK on the assets you want to track, and the subscribing SDK to observe the location of the assets.',
          image: 'trackable-location.svg',
          links: [{ text: 'Read docs', href: '/docs/asset-tracking/using-the-sdks' }],
        },
        {
          ...
          links: [{ text: 'Read docs', href: '/docs/asset-tracking/example-apps' }],
        },
      ],
    },
  ],
