...
All client libraries share API documentation within this repository so that where possible, the documentation is "DRY":http://en.wikipedia.org/wiki/Don%27t_repeat_yourself.  Where client libraries differ in regards to their API or usage, the language specific variations are documented in this repository, which in turn are replicated in the primary "Ably documentation":https://ably.com/documentation.
