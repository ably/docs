---
title: "Getting started: Pub/Sub and Kotlin"
meta_description: "A getting started guide for Ably Pub/Sub that steps through some of the key features using Kotlin."
...
* Install the Ably Pub/Sub Kotlin SDK in your project. If using Gradle:
...
fun getStarted() {
  ...
  realtimeClient.connection.once(ConnectionState.connected) {
