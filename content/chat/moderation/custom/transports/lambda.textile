...
Below are the rule fields specific to the Lambda transport. You can also configure the "general fields":/docs/chat/moderation/custom#configuration. All moderation rules can be set up in the integration rules section of your Ably dashboard and in the control API.
