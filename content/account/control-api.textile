...
* "Integration rules":/integrations
...
You can use the Control API to manage "Ably queues":/integrations/queues. The main operations are:
...
You can use the Control API to manage Ably "integration rules":/integrations. The main operations are:
...
| @enveloped@ | true | Wrap packet in "metadata":/integrations/webhooks#envelope |
