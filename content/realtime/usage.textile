...
<pre><code lang="javascript"><script lang="text/javascript" src="http://cdn.ably.io/ably-min.js">
</code></pre>

The script contains both Realtime library and all its dependencies. To instance the Realtime library:

<pre><code lang="javascript">var realtime = new Ably.Realtime(options);
</code></pre>
</div>
...
<pre><code lang="sh">npm install ably-js
</code></pre>
...
<pre><code lang="javascript">var Ably = require('ably-js');
...
<pre><code lang="java">import io.ably.rest.AblyRealtime;
...
<div lang="java">
The @Options@ argument is an instance of @io.ably.types.Options@, constructed either with the default no-argument constructor or with a key string. The following options may be specified.
</div>
...
h6[javascript]. connection

h6[nodejs]. connection

h6[ruby]. connection

h6[java]. public final Connection connection

A reference to the "connection":/realtime/connection object for this library instance.

h6[javascript]. channels

h6[nodejs]. channels

h6[ruby]. channels

h6[java]. public final Channels channels

The collection of channels instanced, indexed by channel name. See "channels and messages":/realtime/channels-messages/ for more information.
