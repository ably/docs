...
A set of "channel options":#channel-options may also be passed to configure a channel for encryption. Find out more about "symmetrical message encryption":/realtime/encryption.
...
[channel subscribe:@"action" cb:^(ARTMessage *message) {
...
bc[objc]. [channel subscribe:@"myEvent" cb:^(ARTMessage *message) {
    NSLog(@"message received for event %@", message.name);
    NSLog(@"message data: %@", message.data);
}];
...
bc[objc]. [channel publish:@"event" data:@"This is my payload" cb:^(ARTErrorInfo *error) {
    if (error) {
...
bc[objc]. [channel attach:^(ARTErrorInfo *error) {
    ...
    [channel history:query callback:^(ARTPaginatedResult<ARTMessage *> *resultPage, NSError *error) {
        NSLog(@"%lu messages received in first page", (unsigned long)[resultPage.items count]);
        if (resultPage.hasNext) {
            [resultPage next:^(ARTPaginatedResult<ARTMessage *> *nextPage, NSError *error) {
                // ...
            }];
        }
    } error:nil];
...
When a channel failure occurs this <span lang="default,ruby">attribute</span><span lang="java">member</span><span lang="jsall,objc,swift">property</span> contains the <span lang="java,ruby">"@AblyException@":/realtime/types#ably-exception</span><span lang="default">"@ErrorInfo@":/realtime/types#error-info</span>.
...
bq(definition#publish-data).
  ...
  objc,swift: publish(name: String?, data: AnyObject?, cb: (("ARTErrorInfo":/realtime/types#error-info?) -> Void)?)
...
bq(definition#publish-msg-array).
  ...
  objc,swift: publish(messages: [ "ARTMessage":#message ], cb callback: (("ARTErrorInfo":/realtime/types#error-info?) -> Void)?)
...
- <div lang="objc,swift">Object data</div> := data payload for the message. The supported payload types are <span lang="objc">@NS@</span>@String@, <span lang="objc">@NS@</span>@Dictionary@ or <span lang="objc">@NS@</span>@Array@ objects that can be serialised to JSON, binary data as @NSData@, and @nil@.
...
bq(definition#subscribe-listener).
  ...
  objc,swift: subscribe(cb: ("ARTMessage":#message) -> Void) -> ARTEventListener?
...
bq(definition#subscribe-event).
  ...
  objc,swift: subscribe(name: String, cb: ("ARTMessage":#message) -> Void) -> ARTEventListener?
...
<div lang="objc,swift"></div>
<div lang="default">
- <span lang="default">String[] </span><span lang="ruby">*</span>names := An <span lang="ruby">argument</span> array of event names to subscribe to
</div>
...
bq(definition).
  ...
  objc,swift: history(query: ARTRealtimeHistoryQuery?, callback: ("ARTPaginatedResult":#paginated-result<"ARTMessage":#message>?, NSError?) -> Void) throws
...
- <span lang="default">options</span><span lang="objc,swift">query</span><span lang="java">"Param":#param[] options</span> := <span lang="default">an optional object containing the query parameters</span><span lang="ruby">an optional set of key value pairs containing the query parameters</span>, as specified in the "message history API documentation":/realtime/history#channel-history.
...
Further details of the supported @option@ params, see "message history API documentation":/realtime/history#channel-history.
...
bq(definition).
  ...
  objc,swift: attach(cb: (("ARTErrorInfo":/realtime/types#error-info?) -> Void)?)
...
- <div lang="swift,objc">cb</div> := called once the channel becomes attached or if an error occurs
...
bq(definition).
  ...
  objc,swift: detach(cb: (("ARTErrorInfo":/realtime/types#error-info?) -> Void)?)
...
- <div lang="swift,objc">cb</div> := called once the channel becomes detached or if an error occurs
...
Register the given listener <span lang="ruby">block</span><span lang="swift,objc">function</span> for all "ChannelState":#channel-state changes on the @Channel@, plus when an error happens when attaching, detaching, or encoding or decoding a message.
...
- <div lang="swift,objc">event: "@ARTChannelEvent@":#channel-event</div> := either a channel state to subscribe to, or "@ARTChannelEventError@":#channel-event to subscribe to errors not related to state changes
...
Register the given listener <span lang="ruby">block</span><span lang="swift,objc">function</span> for a single occurence of the specified "ChannelState":#channel-state <span lang="default">@state@</span><span lang="ruby">@state(s)@</span><span lang="java">@state@</span> change on the @Channel@. Once the listener has been called, it is removed as a registered listener and will not be called again.
<span class="default">The listener is passed the current state<span lang="jsall"> as the @event@ property of @this@</span>.</span><span lang="ruby">The listener is passed a "ChannelState":#channel-state object that contains the current state, previous state, and an optional reason for the state change</span><span lang="objc,swift">The listener is passed an optional reason for the state change</span>.
...
Register the given listener <span lang="ruby">block</span><span lang="swift,objc">function</span> for a single occurence of any "ChannelState":#channel-state change on the @Channel@. Once the listener has been called, it is removed as a registered listener and will not be called again.
<span class="default">The listener is passed the current state<span lang="jsall"> as the @event@ property of @this@</span>.</span><span lang="ruby">The listener is passed a "ChannelState":#channel-state object that contains the current state, previous state, and an optional reason for the state change</span><span lang="objc,swift">The callback is passed an optional reason for the state change or error</span>.
...
- <div lang="swift,objc">event</div> := either a channel to unsubscribe from, or "@ARTChannelEventError@":#channel-event to unsubscribe from errors not related to state changes
