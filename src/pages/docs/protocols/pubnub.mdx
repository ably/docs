...
PubNub doesn't have the concept of a <If lang="javascript,nodejs">[message name](/docs/pub-sub/api/javascript/realtime/message#properties)</If><If lang="ruby">[message name](/docs/api/realtime-sdk/messages#name)</If>. PubNub message content maps to Ably's <If lang="javascript,nodejs">[message data](/docs/pub-sub/api/javascript/realtime/message#properties)</If><If lang="ruby">[message data](/docs/api/realtime-sdk/messages#data)</If> property. A publish using the PubNub Adapter will leave the Ably message name blank, and message name is not visible to PubNub Adapter subscribers.
