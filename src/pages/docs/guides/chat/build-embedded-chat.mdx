...
- When will the room be joined by users and how will it be linked to the rest of your application (delivery, support ticket, game session and so on)? Examples:
