---
title: Ably CLI
intro: "The Ably CLI manages Ably resources and interacts with product APIs directly from your terminal. This tool enables account management, message publishing/subscribing, and testing with additional client simulations."
