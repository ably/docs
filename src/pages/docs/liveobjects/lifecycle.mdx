...
<Aside data-type='usp'>
Seamless connection recovery

Ably's platform provides [automatic connection recovery](/docs/platform/architecture/connection-recovery) after brief network disruptions, transparently replaying missed operations and resynchronizing channel object state without any manual intervention.
</Aside>
