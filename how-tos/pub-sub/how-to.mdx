...
Add the following parameters to `footballChannel.subscribe()` on L22 of `footballSubscriber.js`:
...
<button onClick={props.showSolution} className="ui-btn">Show solution</button>
