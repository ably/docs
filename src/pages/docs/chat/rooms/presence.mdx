...
<If lang="react">
<Aside data-type='important'>
When using the `usePresence` hook, always memoize the params object passed to the hook. Without memoization, the params object is recreated on every render, causing unnecessary re-renders and unintended side-effects.
</Aside>
</If>
