...
<%= partial 'types/versions/v0.8/_presence_message' %>
...
<%= partial 'types/versions/v0.8/_presence_action' %>

h3(#data-request-query).
  csharp: DataRequestQuery

blang[csharp].
  <%= partial 'types/versions/v0.8/_data_request_query', indent: 2, skip_first_indent: true %>

h3(#completion-listener).
  java:   io.ably.lib.realtime.CompletionListener

blang[java].
  <%= partial 'types/versions/v0.8/_completion_listener', indent: 2, skip_first_indent: true %>
...
<%= partial 'types/versions/v0.8/_paginated_result' %>
...
blang[java].
  <%= partial 'types/versions/v0.8/_presence_listener', indent: 2, skip_first_indent: true %>
