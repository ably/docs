...
A globally distributed data stream network providing an "all-encompassing platform":https://www.ably.io/api-streamer?utm_source={{companyid0}}_v_{{companyid1}}&utm_medium=compare_pages with everything you need to build the realtime experiences is the future. Just something to think about.