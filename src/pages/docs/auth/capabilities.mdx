...
| **privileged-headers** | Can set data in the privileged section of the <If lang="javascript,nodejs">[message extras](/docs/pub-sub/api/javascript/realtime/message#properties)</If><If lang="csharp,flutter,go,java,php,python,ruby">[message extras](/docs/api/realtime-sdk/messages#extras)</If> |
...
An [Ably API key](/docs/auth#api-keys) can have a single set of permissions, applied to any number of [channels](/docs/channels) or [queues](/docs/platform/integrations/queues).
