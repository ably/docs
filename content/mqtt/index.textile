...
For example, in NodeJS "mqtt package":https://www.npmjs.com/package/mqtt, you'd need to specify the following:
...
* It doesn’t support any MQTT features that aren’t normally supported by Ably, such as @RETAIN@ messages or wildcard channel subscriptions
