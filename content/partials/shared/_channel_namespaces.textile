...
* **Message references enabled** - If enabled, messages received on a channel will contain a unique @timeSerial@ that can be referenced by later messages. "Find out more":/realtime/messages#message-interactions.
