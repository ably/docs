...
Install the Ably SDK and the Objects plugin in your Xcode project:
...
3. Paste `https://github.com/ably/ably-cocoa-liveobject-plugin` in the Swift Packages search box.
