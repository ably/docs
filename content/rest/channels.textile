...
The @Channels@ object, accessed from the "rest library client constructor":/api/rest-sdk/index#channels, is used to create and destroy @Channel@ objects. It exposes the following public methods:
