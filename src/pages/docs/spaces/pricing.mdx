...
Each space maps to an underlying Pub/Sub [channel](/docs/channels). Live cursors use a [separate channel](/docs/spaces/cursors#foundations) from other space features due to their high update frequency. Both channels contribute to your [channel count](/docs/platform/pricing#channels).
