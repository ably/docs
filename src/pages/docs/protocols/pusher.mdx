...
Ably automatically connects clients to the closest datacenter using latency-based DNS routing, compensating for any protocol adapter overhead with optimal network proximity. [Learn how Ably's edge network optimizes routing](/docs/platform/architecture/edge-network#dns-organization-and-latency-based-routing).
</Aside>
