...
bq. You can now persist the last realtime message on a channel for 365 days. *State Persistence* allows you to instantly retrieve realtime messages sent in the past, helping with  long-term state synchronization. "Read how to enable State Persistence":https://www.ably.io/documentation/realtime/channels/channel-parameters/rewind#persist-last-message.
