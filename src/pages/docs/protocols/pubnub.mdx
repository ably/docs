...
Ably automatically recovers connections and delivers all missed messages when clients reconnect within two minutes, ensuring no data is lost during brief disconnections. [Learn how Ably ensures connection recovery](/docs/platform/architecture/connection-recovery).
</Aside>
