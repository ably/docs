...
Use the <If lang="javascript">[`status`](/docs/sdk/chat-js/v0/interfaces/chat-js.Connection.html#status)</If><If lang="swift">[`status`](/docs/sdk/chat-swift/v0/documentation/ablychat/connectionstatus)</If><If lang="kotlin">[`status`](/docs/sdk/chat-kotlin/v0/-connection/status.html)</If> property to check which status a connection is currently in:
</If>
...
<If lang="javascript,swift,kotlin">
Use the <If lang="javascript">[`connection.onStatusChange()`](/docs/sdk/chat-js/v0/interfaces/chat-js.Connection.html#onStatusChange)</If><If lang="swift">[`connection.onStatusChange()`](/docs/sdk/chat-swift/v0/documentation/ablychat/connection/onstatuschange%28%29-76t7)</If><If lang="kotlin">[`connection.onStatusChange()`](/docs/sdk/chat-kotlin/v0/-connection/on-status-change.html)</If> method to register a listener for status change updates:
</If>
...
<If lang="javascript,swift,kotlin">
The discontinuity handler is accessible via the <If lang="javascript">[Room](/docs/sdk/chat-js/v0/interfaces/chat-js.Room.html#onDiscontinuity)</If><If lang="swift">[Room](/docs/sdk/chat-swift/v0/documentation/ablychat/room)</If><If lang="kotlin">[Room](/docs/sdk/chat-kotlin/v0/-room/index.html)</If> object.
</If>
