...
4. Configure the Kinesis [settings](#settings).
5. Click **Create**.

</Tab>
<Tab value="control-api" label="Control API">

Create a Kinesis rule using the Control API by sending a `POST` request to [`/apps/{app_id}/rules`](/docs/api/control-api):
  ...
  -d '{
    ...
    "target": {
      ...
      "authentication": {
        ...
        "assumeRoleArn": "arn:aws:iam::123456789012:role/my-ably-role"
      },
      "enveloped": true
    }
  }'
