...
h3(#status). Development status

The Spaces SDK is currently in beta.

The APIs that it introduces have been validated against a set of use cases, however breaking changes may be introduced in subsequent releases. The SDK has been tested against real load, however you should use caution when deciding under what conditions to use it.
