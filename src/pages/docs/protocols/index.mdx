...
<Aside data-type='usp'>
Protocol adapters in every datacenter.

Protocol adapters run alongside Ably's core service in every datacenter, ensuring clients using any protocol connect to the closest point of presence with minimal added latency. [Learn how Ably's edge network is organized](/docs/platform/architecture/edge-network#dns-organization-and-latency-based-routing).
</Aside>
