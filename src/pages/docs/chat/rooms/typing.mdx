...
<Aside data-type="usp">
Instant typing indicator updates.

Ably achieves a global median message delivery latency of 37ms, ensuring typing indicators appear instantly as users type. [Learn how Ably measures and maintains low latency](/docs/platform/architecture/latency#how-latency-is-measured).
</Aside>
