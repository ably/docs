...
<a href="/images/concepts/idempotency/Idempotency-1.gif" target="_blank">
  <img src="/images/concepts/idempotency/Idempotency-1.gif" style="width: 100%" alt="Example of duplicate messages being sent">
</a>
...
<a href="/images/concepts/idempotency/Idempotency-3.gif" target="_blank">
  <img src="/images/concepts/idempotency/Idempotency-3.gif" style="width: 100%" alt="Example of duplicate message being discarded even when received by two separate servers">
</a>
...
When our client libraries "automatically retry requests that fail":https://support.ably.com/a/solutions/articles/3000044636, if idempotency is now enabled, an ID is assigned to each message client side before publishing.
