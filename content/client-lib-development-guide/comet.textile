...
The client library must allow the client to specify a non-default host, at least to be able to connect to the staging environment at staging-rest.ably.io.
