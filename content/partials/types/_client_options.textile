...
blang[jsall].
  ...
  - transports := An optional array of transports to use, in descending order of preference. <span lang="javascript">In the browser environment the available transports are: @web_socket@, @xhr_polling@.</span><span lang="nodejs">The transports available in the Node.js client library are: @web_socket@, @xhr_polling@, @comet@.</span><br>__Type: @String []@__
