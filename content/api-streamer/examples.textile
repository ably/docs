...
"CoinDesk":https://www.coindesk.com/price/bitcoin provides current pricing for Bitcoin. This data is available for free on their website. Using API Streamer, it's easy to access this data as a realtime stream. "View the documentation for this product on Ably Hub":https://www.ably.io/hub/products/20 to learn how to implement this yourself.
...
"OpenWeatherMap":https://openweathermap.org/ provides live weather data for almost any location over the world. This data is available for free on their website. Using API Streamer, it's easy to access this data as a realtime stream. "View the documentation for this product on Ably Hub":https://www.ably.io/hub/products/19 to learn how to implement this yourself.
...
"Bitflyer":https://bitflyer.com/en-jp/ provides current pricing for Bitcoin. This data is available for free on their website. Using API Streamer, it's easy to access this data as a realtime stream. "View the documentation for this product on Ably Hub":https://www.ably.io/hub/products/14 to learn how to implement this yourself.
...
"The BBC":https://www.bbc.co.uk/ is a British public service broadcaster. Their latest news is available for free on their website. Using API Streamer, it's easy to access this data as a realtime stream. "View the documentation for this product on Ably Hub":https://www.ably.io/hub/products/13 to learn how to implement this yourself.
...
h2(#tfl). Transport for London (TfL)

TfL publishes information such as arrivals at stations and existing disruptions. Using the Ably API Streamer, you can trivially subscribe to this data for free. See the example below:
