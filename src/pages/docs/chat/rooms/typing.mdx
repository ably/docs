...
<If lang="javascript,swift,kotlin">
Use the <If lang="javascript">[`typing.current`](https://sdk.ably.com/builds/ably/ably-chat-js/main/typedoc/interfaces/chat-js.Typing.html#current)</If><If lang="swift">[`typing.current`](https://sdk.ably.com/builds/ably/ably-chat-swift/main/AblyChat/documentation/ablychat/typing/current)</If><If lang="kotlin">[`typing.get()`](https://sdk.ably.com/builds/ably/ably-chat-kotlin/main/dokka/chat-android/com.ably.chat/-typing/get.html)</If> property to retrieve a set of `clientId`s for all users that are currently typing in the room:
</If>
