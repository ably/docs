...
With [50% capacity headroom](/docs/platform/architecture/infrastructure-operations#resource-implications) built in, Ably instantly absorbs traffic spikes without degradation or pre-provisioning.
</Aside>
...
* Understand [JWT authentication](/docs/platform/auth/token/jwt) before going to production.
