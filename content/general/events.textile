...
For @channel.lifecycle@ and @channel.occupancy@ metadata in particular, for scalability reasons it is recommended that your rules use these sources, rather than creating @channel.message@ rules on the corresponding metachannels.
