...
See the "token revocation documentation":/auth/revocation for further details.
...
"Batch mode":/messages/batch#batch-publish enables you to submit multiple API requests for certain operations in a single API call. The API processes all the requests in parallel.
