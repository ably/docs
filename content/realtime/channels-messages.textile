...
```[dotnet]
  AblyRealtime realtime = new AblyRealtime("{{API_KEY}}");
  var channel = realtime.Channels.Get("{{RANDOM_CHANNEL_NAME}}");
  channel.Subscribe(message => Console.WriteLine($"Message: {message.name}:{message.data} received"));
  channel.Publish("example", "message data");
```
...
bc[dotnet]. var channel = realtime.Channels.Get("channelName");
...
bc[dotnet]. byte[] key = Crypto.GetRandomKey();
...
bc[dotnet]. var channel = realtime.Channels.Get("chatroom");
...
bc[dotnet]. channel.On(args => Console.WriteLine("channel state is " + channel.State));
...
bc[dotnet]. var privateChannel = realtime.Channels.Get("private:chatroom");
...
bc[dotnet]. channel.Subscribe(message =>
{
...
bc[dotnet]. channel.Subscribe("myEvent", message =>
{
    Console.WriteLine($"message received for event {message.name}");
    Console.WriteLine($"message data: {message.data}");
});
...
Channels expose a @publish@ method whereby a client can publish either a single message or an array of messages to a channel. A listener optionally passed in to the @publish@ method enables the client to know whether or not the operation succeeded. <span lang="dotnet">
...
bc[dotnet]. channel.Publish("event", "payload", (success, error) =>
{
    if (error != null)
...
bc[dotnet]. var history = await channel.HistoryAsync(untilAttached: true);
...
h2(#properties).
  ...
  dotnet: IO.Ably.Realtime.RealtimeChannel Properties
...
The current <span lang="java">"@io.ably.lib.realtime.ChannelState@":#channel-state @state@</span><span lang="ruby">"@Ably::Realtime::Channel::STATE@":#channel-state @state@</span><span lang="objc,swift">"@ARTRealtimeChannelState@":#channel-state</span><span lang="default">"@ChannelState@":#channel-state</span> of this @Channel@. See the supported "channel states":#channel-states for more information.
...
When a channel failure occurs this <span lang="default,ruby">attribute</span><span lang="java">member</span><span lang="jsall,objc,swift,dotnet">property</span> contains the <span lang="java,ruby">"@AblyException@":/realtime/types#ably-exception</span><span lang="default">"@ErrorInfo@":/realtime/types#error-info</span>.
...
bq(definition#publish-data).
  ...
  dotnet:   public void Publish(string name, object data, Action<bool, ErrorInfo> callback = null, string clientId = null)
...
bq(definition#publish-msg-array).
  ...
  dotnet:  public void Publish(IEnumerable<"Message":#message> messages, Action<bool, "ErrorInfo":/realtime/types#error-info> callback = null)
...
- <div lang="dotnet">data</div> := data payload for the message. The supported payload types are Strings, binary data as byte arrays, any plain c# class that can be serialised to Json, and null.<br>__Type: @Object@__
...
- <div lang="dotnet">callback</div> := is an action of the form @Action<bool, ErrorInfo>@ which is called upon completion
...
bq(definition#subscribe-event).
  ...
  dotnet:   public void Subscribe(string name, Action<"Message":#message> handler)
...
<div lang="objc,swift,dotnet"></div>
<div lang="default">
...
bq(definition#unsubscribe-event).
  ...
  dotnet:  public bool Unsubscribe(string eventName, Action<"Message":#message> handler)
...
bq(definition#unsubscribe-listener).
  ...
  dotnet:  public bool Unsubscribe(Action<"Message":#message> handler)
...
bq(definition#unsubscribe-all).
  ...
  dotnet:  public void Unsubscribe()
...
- <div lang="swift,objc">handler</div> := is the lambda expression that was previously subscribed
...
bq(definition).
  ...
  java:    public "PaginatedResult":#paginated-result<"Message":#message> history("Param []":#param options)
  dotnet:  public Task<"PaginatedResult<Message>":#paginated-result> HistoryAsync(DataRequestQuery dataQuery, bool untilAttached = false)
...
bq(definition).
  ...
  dotnet:   public void Attach(Action<TimeSpan, "ErrorInfo":/realtime/types#error-info?> callback = null)
...
- <div lang="dotnet">callback</div> := is a lambda expression of the form @Action<TimeSpan, ErrorInfo>@ and is called once the channel attach succeds or fails
...
bq(definition).
  ...
  dotnet:  public void Detach(Action<TimeSpan, ErrorInfo> callback = null)
...
- <div lang="dotnet">callback</div> := is a lambda expression in the form @Action<TimeSpan, ErrorInfo>@ and is called once the channel detach succeeds or fails
...
bq(definition#on-state-listener).
  ...
  dotnet:  public void On("ChannelState":#channel-state @event, Action<ChannelStateChangedEventArgs> action)
  objc,swift: on(event: "ARTChannelEvent":#channel-event, call: ("ARTErrorInfo":#error-info?) -> Void) -> ARTEventListener

Register the given listener <span lang="ruby">block</span><span lang="swift,objc">function</span> for the specified "ChannelState":#channel-state <span lang="default">@state@</span><span lang="ruby">@state(s)@</span><span lang="java">@state@</span> changes on the @Channel@.
<span class="default">The listener is passed the current state<span lang="jsall"> as the @event@ property of @this@</span>.</span><span lang="ruby">The listener is passed a "ChannelState":#channel-state object that contains the current state, previous state, and an optional reason for the state change</span><span lang="objc,swift">The listener is passed an optional reason for the state change</span>.<span lang="ruby">The listener is passed a "ChannelStateChangedEventArgs":#channel-state object that contains the current state, previous state, and an optional reason for the state change</span>

bq(definition#on-listener).
  default: on(listener())
  ruby:    on -> yields "ChannelStateChange":#channel-state-change
  dotnet:  public void On(Action<ChannelStateChangedEventArgs> listener)
...
Register the given listener <span lang="ruby">block</span><span lang="swift,objc">function</span><span lang="dotnet">lambda expression</span> for all "ChannelState":#channel-state changes on the @Channel@, plus when an error happens when attaching, detaching, or encoding or decoding a message.
...
- <div lang="dotnet">event</div> := the channel state to subscribe to<br>__Type: "@ChannelState@":#channel-state__
...
- <div lang="dotnet">action</div> := lambda expression to be notified for matching state changes<br>__Type: "@ChannelStateChangedEventArgs@":#channel-state-listener__
...
bq(definition#once-state-listener).
  ...
  dotnet:  public void Once("ChannelState":#channel-state @event, Action<ChannelStateChangedEventArgs> action)
  objc,swift: once(event: "ARTChannelEvent":#channel-event, call: ("ARTErrorInfo":#error-info?) -> Void) -> ARTEventListener

Register the given listener <span lang="ruby">block</span><span lang="swift,objc">function</span><span lang="dotnet">lambda expression</span> for a single occurence of the specified "ChannelState":#channel-state <span lang="default">@state@</span><span lang="ruby">@state(s)@</span><span lang="java">@state@</span> change on the @Channel@. Once the listener has been called, it is removed as a registered listener and will not be called again.
...
bq(definition#once-listener).
  ...
  dotnet:  public void Once(Action<ChannelStateChangedEventArgs> listener)
  objc,swift: once(call: (ARTErrorInfo?) -> Void) -> ARTEventListener

Register the given listener <span lang="ruby">block</span><span lang="swift,objc">function</span><span lang="dotnet">lambda expression</span> for a single occurence of any "ChannelState":#channel-state change on the @Channel@. Once the listener has been called, it is removed as a registered listener and will not be called again.
<span class="default">The listener is passed the current state<span lang="jsall"> as the @event@ property of @this@</span>.</span><span lang="ruby">The listener is passed a "ChannelState":#channel-state object that contains the current state, previous state, and an optional reason for the state change</span><span lang="objc,swift">The callback is passed an optional reason for the state change or error</span><span lang="dotnet">The callback is passed a "ChannelStateChangedEventArgs":#channel-state object that contains the current state and an optional reason for the state change</span>..
...
- <div lang="dotnet">listener</div> := listener lambda expression that is notified only once for a matching state change
- <div lang="swift,objc">call</div> := called possibly with an "@ErrorInfo@":#error-info
...
bq(definition#off-listener).
  ...
  dotnet:  public void Off(Action<ChannelStateChangedEventArgs> listener)
...
- <div lang="dotnet">event</div> := the channel state to unsubscribe from<br>__Type: "@ChannelState@":#channel-state__
...
- <div lang="dotnet">listener</div> := is the listener function to be removed
...
h3(#channel-state).
  ...
  dotnet:    IO.Ably.Realtime.ChannelState Enum
...
h3(#channel-options).
  ...
  dotnet:  IO.Ably.Rest.ChannelOptions
...
h3(#paginated-result).
  ...
  dotnet:  IO.Ably.PaginatedResult
