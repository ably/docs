...
It is worth noting that @channel.occupancy@ events are currently only available to our "enterprise":https://ably.com/pricing#enterprise customers. However, you can still access "occupancy":#occupancy data within channel lifecycle events on a free account.
