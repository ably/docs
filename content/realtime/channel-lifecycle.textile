...
Through a realtime connection you can subscribe to both "channel lifecycle":#lifecycle-events and "occupancy":#occupancy events. This is done through a channel's "metachannel":#metachannels.
...
It is worth noting that "occupancy":#occupancy is presently only available to "enterprise":https://www.ably.io/pricing/enterprise accounts and for testing. "Contact us":https://www.ably.io/contact to discuss your requirements if this is relevant to you.

h3(#occupancy-realtime). Occupancy with realtime
