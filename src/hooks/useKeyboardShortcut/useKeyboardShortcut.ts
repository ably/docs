// This hook was stolen from https://github.com/arthurtyukayev/use-keyboard-shortcut
// because installing it as a module didn't sit well with Jest
...
const useKeyboardShortcut = (
  ...
  const keydownListener = useCallback(
    (keydownEvent) => {
      ...
      if (keydownEvent.repeat && !options.repeatOnHold) {
        return;
      }
      ...
      const isHeldKeyCombinationValid = checkHeldKeysRecursive(loweredKey, 0, shortcutArray, heldKeys.current);
