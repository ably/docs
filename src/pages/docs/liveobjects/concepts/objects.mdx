...
myObject.set("settings", LiveMapValue.of(LiveMap.create(Map.of(
...
myObject.set("config", LiveMapValue.of(LiveMap.create(Map.of(
    "apiUrl", LiveMapValue.of("https://api.example.com"))))).join();
```
</Code>
...
myObject.set("profile", LiveMapValue.of(LiveMap.create(Map.of(
    ...
    "preferences", LiveMapValue.of(LiveMap.create(Map.of(
        "theme", LiveMapValue.of("dark"),
        "fontSize", LiveMapValue.of(14)))),
    "activity", LiveMapValue.of(LiveCounter.create(0)))))).join();
