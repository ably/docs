...
There isn't currently a chat-specific bring your own moderator API for after publish moderation.

However, you can still use standard Ably "integration rules"/docs/integrations to send chat messages to your infrastructure and then remove any offending content with the REST API. Please reach out to us if you're interested in after publish moderation for chat, we'd love to hear from you!
