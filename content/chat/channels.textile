...
Channels are the core functionality for any chat application or any application with chat features. Channels enable you to separate chats and their messages into categories. For example, a channel for direct messages between two people, or a channel for a specific live streaming event with many members.
