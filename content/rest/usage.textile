...
The REST client library is available in a "most popular languages":https://ably.io/download/rest-client-libraries with a consistent API.  You can choose your preferred language above.

_Note: that since the REST client library is a direct subset of the Realtime client library, all "Realtime client libraries":/realtime also provide access to methods within this REST client library._
...
Then the REST constructor is at @Ably.Rest@; the Real-time constructor is at @Ably.Realtime@ and is documented in the "Realtime client library documentation":/realtime.
