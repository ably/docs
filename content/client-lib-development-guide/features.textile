...
*** @(RSA17b1)@ @Array<TokenRevocationTarget>@ is an array of @TokenRevocationTarget@s to revoke. This array of token revocation targets must be used to construct the individual @TokenRevocationTarget@s in the form of "@TokenRevocationTarget#key@:@TokenRevocationTarget#value@" for the "targets" array in the request body.
