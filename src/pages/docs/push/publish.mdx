...
You need to enable the push setting using a [rule](/docs/channels#rules) on the channel or channel [namespace](/docs/channels#namespaces), and clients require the [`push-subscribe`](/docs/api/realtime-sdk/push-admin#methods) capability.
</Aside>
