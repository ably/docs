...
You can also make use of the "REST API":/rest-api, to "enumerate all active channels":/rest/channel-lifecycle#enumeration-rest, or obtain the status of an "individual channel":#metadata-rest. At present, REST "requests":/rest/usage#request for lifecycle events will not count towards your message limit. If you are making use of "Reactor":/reactor however, then each message sent over Reactor *will* count towards your message limits.
...
If you need to be able to query channel metadata at any point, you can make use of the "channel metadata REST APIs":/rest/channel-lifecycle#metadata-rest to inspect the state of individual channels, or "enumerate":/rest/channel-lifecycle#enumeration-rest all active channels in the system.

h2(#tutorials). Tutorials

If you wish to see an example of how to use channel metadata, you can check out our "Channel Lifecycle Events":/tutorials/channel-lifecyle-events tutorial, "Channel Occupancy Events":/tutorials/channel-occupancy-events tutorial, and the "Channel Enumeration":tutorials/channel-enumeration-rest tutorial.
