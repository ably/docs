---
title: Statistics
meta_description: "The Ably service retains usage statistics per application and per account at 1 minute intervals."
meta_keywords: "Statistics, stats, account statistics"
section: rest
index: 100
languages:
  - javascript
...
Your application and account statistics are also available as graphs, tabular data or downloads in your "application dashboard":https://faqs.ably.com/how-do-i-access-my-app-dashboard.
...
* See "Statistics API Reference - Realtime":/realtime/realtime-api-reference#statistics-api
* See "Statistics API Reference - REST":/rest/rest-api-reference#statistics-api
