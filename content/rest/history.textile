...
- <span lang="ruby">:</span>start := _beginning of time_ earliest <span lang="ruby">@Time@ or </span>time in milliseconds since the epoch for any message retrieved<br><br>__Type: <span lang="default">@Integer@</span><span lang="java">@Long Integer@</span><span lang="ruby">@Time@</span><span lang="objc,swift">@NSDate@</span>__
- <span lang="ruby">:</span>end := _current time_ latest <span lang="ruby">@Time@ or </span>time in milliseconds since the epoch for any messages retrieved<br>__Type: <span lang="default">@Integer@</span><span lang="java">@Long Integer@</span><span lang="ruby">@Time@</span><span lang="objc,swift">@NSDate@</span>__
...
- <span lang="ruby">:</span>start := _beginning of time_ earliest <span lang="ruby">@Time@ or </span>time in milliseconds since the epoch for any presence event retrieved<br>__Type: <span lang="default">@Integer@</span><span lang="java">@Long Integer@</span><span lang="ruby">@Time@</span><span lang="objc,swift">@NSDate@</span>__
- <span lang="ruby">:</span>end := _current time_ latest <span lang="ruby">@Time@ or </span>time in milliseconds since the epoch for any presence events retrieved<br>__Type: <span lang="default">@Integer@</span><span lang="java">@Long Integer@</span><span lang="ruby">@Time@</span><span lang="objc,swift">@NSDate@</span>__
- <span lang="ruby">:</span>direction := _backwards_ <span lang="ruby">@:@</span>@forwards@ or <span lang="ruby">@:@</span>@backwards@<br>__Type: <span lang="default">@String@</span><span lang="ruby">@Symbol@</span>__
