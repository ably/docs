...
At present, REST "requests":/rest/usage#request for lifecycle events will not count towards your message limit. If you are making use of "Integrations":https://ably.com/integrations however, then each message sent through Integrations *will* count towards your message limits.
