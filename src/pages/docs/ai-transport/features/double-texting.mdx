...
To cancel the current turn before sending the new message, use the [barge-in](/docs/ai-transport/features/barge-in) pattern:
...
- [Barge-in](/docs/ai-transport/features/barge-in): the cancel-then-send pattern in detail.
