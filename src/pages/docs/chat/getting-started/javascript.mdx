...
import { ChatClient, AllFeaturesEnabled, ChatMessageEvent, Message } from '@ably/chat';
...
* Find out more regarding [online status](/docs/chat/rooms/presence?lang=javascript).
