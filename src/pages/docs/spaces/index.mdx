...
Collaborative features generate frequent updates from many participants simultaneously. Ably's platform [delivers over 500 billion messages monthly](/docs/platform/architecture/scalability), ensuring your collaborative experiences remain responsive as your user base grows.
</Aside>
...
| Feature  | Description |
| -------- | ----------- |
| [Space](/docs/spaces/space) | virtual area of your application in which realtime collaboration between users can take place. |
...
### Enhance collaborative applications with other Ably products

Ably provides purpose-built SDKs for common realtime features that complement the Spaces SDK:

* **[Ably Chat](/docs/chat)**: Add chat, typing indicators, reactions, and message history with the Chat SDK.
...
See the [product guidance](/docs/platform/products) page for help choosing the right Ably product for each feature.
