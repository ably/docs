...
<Aside data-type='note'>
  Users do not automatically enter presence when they attach to a room. [Attachment](/docs/chat/rooms#attach) is a prerequisite for receiving any messages and events from a room. Users must explicitly enter presence to be added to the presence set.
</Aside>
