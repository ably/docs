...
blang[react].
  ...
  h4(#react-native-option-1). Option 1: Enable Package Exports

  React Native has started to support the `exports` field of `package.json`. To use Chat with React Native in this way:
  ...
  * Include the @unstable_enablePackageExports@ field in your @metro.config.cjs@
  ...
  h4(#react-native-option-2). Option 2: Use Pseudo-package
