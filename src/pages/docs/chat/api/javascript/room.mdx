...
| error | The error information if the room is in a failed state. | Ably.ErrorInfo or Undefined |
...
| error | An error that provides a reason why the room has entered the new status, if applicable. | Ably.ErrorInfo or Undefined |
...
| --- | --- | --- |
| error | An error providing context about why the discontinuity occurred. | Ably.ErrorInfo |
