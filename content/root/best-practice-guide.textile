...
* If you want to set up realtime communication with IoT devices on platforms for which there's no available Ably client library, you can use the "MQTT protocol adapter":/mqtt.
* If you wish to migrate from PubNub/Pusher to Ably, you can use the relevant "protocol adapter":/adapters to "easily":https://knowledge.ably.com/can-you-help-ease-the-pain-of-migration-from-another-data-stream-network switch to Ably right away and gradually migrate to using Ably client SDKs.
