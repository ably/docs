...
* Variable and method names are lowercase
...
* Functions are denoted as @(Type, argName: Type, argName: Type) -> ReturnType@ (@ReturnType@ may be omitted)
* Enums are denoted as @.A | .B | .C@
* @Type?@ denotes an optional type, ie. a type that can be null plus all values of type Type
* @Type default value@ denotes that the thing being anotated with @Type@ has @value@ as default. @Type api-default value@ denotes that the Ably server API uses those defaults and therefore it is unnecessary for the client library to send these values by default
...
class Rest:
  ...
  time: () -> io Time // RSC16
  channels: Channels<Channel> // RSN1
...
class ClientOptions:
  ...
  restHost: String? // RSC12, TO3k2
  realtimeHost: String? // RTC1d, TO3k3
  port: Int // TO3k4
  tlsPort: Int // TO3k5
  host: String? // RSC15b
  ttl: Duration default 1 hour // RSA5
  capability: String? // RSA6
...
class AuthOptions: // RSA8e
  ...
  defaultTokenParams: TokenParams? // RSA7a2, TO3j11
  force: Bool default false // RSA10d, AO2h

class TokenParams: // RSAA8e
  ttl: Duration default 60min // RSA9e, TK2a
  capability: String default '{"*":["*"]}' // RSA9f, TK2b
...
class Channel:
  ...
  history: (
    ...
    direction: .Backwards | .Forwards defaut .Backwards, // RSL2b2
    limit: int default 100, // RSL2b3
  ) -> io PaginatedResult<Message> // RSL2a
  presence: Presence // RSL3
  encoding: String? // RSL4b
...
class RealtimeChannel extends Channel:
  ...
  unsubscribe: ((Message) ->) -> io // RTL8a
  unsubscribe: (String, (Message) ->) -> io // RTL8a
  history: (
    start: Time, // RTL10a
    end: Time, // RTL10a
    direction: .Backwards | .Forwards defaut .Backwards, // RTL10a
    limit: int default 100, // RTL10a
...
class Presence:
  ...
  history: (
    ...
    direction: .Backwards | .Forwards defaut .Backwards, // RSP4b2
    limit: int default 100, // RSP4b3
...
class RealtimePresence:
  ...
  ) -> io PaginatedResult<PresenceMessage> // RTP11
  history: (
    start: Time, // RTP12a
    end: Time, // RTP12a
    direction: .Backwards | .Forwards defaut .Backwards, // RTP12a
    limit: int default 100, // RTP12a
  ...
  unsubscribe: ((PresenceMessage) ->) -> io // RTP7a
  unsubscribe: (PresenceAction, (PresenceMessage) ->) -> io // RTP7b
  enter: (Data?) -> io ErrorInfo? // RTP8
  update: (Data?) -> io ErrorInfo? // RTP9
  leave: (Data?) -> io ErrorInfo? // RTP10
  syncComplete: Bool // RTP13
  enterClient: (String, Data?) -> io ErrorInfo? // RTP4, RTP14, RTP15
  updateClient: (String, Data?) -> io ErrorInfo? // RTP15
  leaveClient: (String, Data?) -> io ErrorInfo? // RTP15
...
class ProtocolMessage:
  ...
  action: ProtocolAction // TR2, TR4a
  id: String // TR4b
  channel: String // TR4b
...
class Stats:
  // http://www.rubydoc.info/gems/ably/Ably/Models/Stats
