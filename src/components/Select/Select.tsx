...
const CustomOption = ({ innerProps, innerRef, isSelected, label }: OptionProps<ReactSelectOption, false>) => {
  return (
    <div
      ref={innerRef}
      {...innerProps}
      className="text-cool-black rounded w-full hover:bg-light-grey cursor-pointer hover:text-gui-active p-8 flex items-center justify-between font-manrope text-btn2"
    >
      {label}
