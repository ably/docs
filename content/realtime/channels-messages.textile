...
Channels expose a @publish@ method whereby a client can publish either a single message or an array of messages to a channel. A listener optionally passed in to the @publish@ method enables the client to know whether or not the operation succeeded. <span lang="csharp">
...
bq(definition#publish-data).
  ...
  csharp:   public void Publish(string name, object data, Action<bool, ErrorInfo> callback = null, string clientId = null)
...
bq(definition#publish-msg-array).
  ...
  csharp:  public void Publish(IEnumerable<"Message":#message> messages, Action<bool, "ErrorInfo":/realtime/types#error-info> callback = null)
...
bq(definition#subscribe-listener).
  ...
  csharp:   public void Subscribe(Action<"Message":#message> handler)
...
bq(definition#subscribe-event).
  ...
  csharp:   public void Subscribe(string name, Action<"Message":#message> handler)
...
bq(definition#unsubscribe-event).
  ...
  csharp:  public bool Unsubscribe(string eventName, Action<"Message":#message> handler)
...
bq(definition#unsubscribe-listener).
  ...
  csharp:  public bool Unsubscribe(Action<"Message":#message> handler)
...
bq(definition#unsubscribe-all).
  ...
  csharp:  public void Unsubscribe()
...
bq(definition).
  ...
  csharp:  public Task<"PaginatedResult<Message>":#paginated-result> HistoryAsync(DataRequestQuery dataQuery, bool untilAttached = false)
...
bq(definition).
  ...
  csharp:   public void Attach(Action<TimeSpan, "ErrorInfo":/realtime/types#error-info?> callback = null)
...
bq(definition).
  ...
  csharp:  public void Detach(Action<TimeSpan, ErrorInfo> callback = null)
...
bq(definition#on-state-listener).
  ...
  csharp:  public void On("ChannelState":#channel-state @event, Action<ChannelStateChangedEventArgs> action)
...
bq(definition#on-listener).
  ...
  csharp:  public void On(Action<ChannelStateChangedEventArgs> listener)
...
bq(definition#once-state-listener).
  ...
  csharp:  public void Once("ChannelState":#channel-state @event, Action<ChannelStateChangedEventArgs> action)
...
bq(definition#once-listener).
  ...
  csharp:  public void Once(Action<ChannelStateChangedEventArgs> listener)
...
<span class="default">The listener is passed the current state<span lang="jsall"> as the @event@ property of @this@</span>.</span><span lang="ruby">The listener is passed a "ChannelState":#channel-state object that contains the current state, previous state, and an optional reason for the state change</span><span lang="objc,swift">The callback is passed an optional reason for the state change or error</span><span lang="csharp">The callback is passed a "ChannelStateChangedEventArgs":#channel-state object that contains the current state and an optional reason for the state change</span>..
...
bq(definition#off-listener).
  ...
  csharp:  public void Off(Action<ChannelStateChangedEventArgs> listener)
