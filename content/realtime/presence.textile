...
Sometimes the presence of multiple channels will be needed. With a realtime connection, you can effectively obtain the presence of multiple channels at once by allowing multiple concurrent presence operations. If you wish to obtain the presence of multiple channels within a single operation, you can make use of the "REST batch API":/rest-api/beta#batch.
