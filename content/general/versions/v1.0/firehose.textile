...
Please note that if you want to consume realtime data from a queue, you should take a look at our "Message Queues":/general/queues. They provide a straightforward and robust way to consume realtime from your worker servers without having to worry about queueing infrastructure.
