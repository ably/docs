...
And then run the demo locally by adding your "Ably API key":https://support.ably.com/support/solutions/articles/3000030502-setting-up-and-managing-api-keys to @config/secrets.yml@, configuring the Webhook rules as described in this tutorial and running the demo @rails server@
