...
If we restart the server and then go to http://localhost:3000/push/device you should receive a notification on your device.
...
If we restart the server and then go to http://localhost:3000/push/client you should receive a notification on your device.
