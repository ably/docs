...
The supported Authentication Mechanisms are are: 
...
* "SASL/SCRAM-SHA-257":https://docs.confluent.io/platform/current/kafka/authentication_sasl/authentication_sasl_scram.html#kafka-sasl-auth-scram
