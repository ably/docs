...
* You choose to retrieve historical messages "only up to the point at which a client attaches to a channel":/storage-history/history#until-attach. You would typically use this approach to bring a subscriber up to date as part of "connection state recovery":/connect/states#connection-state-recovery.
