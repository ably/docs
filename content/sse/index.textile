...
Typically token authentication should be used, using a "token issued from your server":/core-features/authentication#token-request-process using an Ably SDK and an API key. This can then be passed to Ably using @token@ or an @Authorization: Bearer <base64-encoded token>@ header. 
...
⏎
event: error
data:{"message":"Token expired. (See https://help.ably.io/error/40142 for help.)","code":40142,"statusCode":401,"href":"https://help.ably.io/error/40142"}
```

h5. Example using a library
...
url = 'https://realtime.ably.io/sse?v=1.1&key={{API_KEY}}&channels=yourChannel'
...
bc[sh](code-editor:sse/eventstream). curl "https://rest.ably.io/event-stream?key={{API_KEY}}&channel=example&v=1.1"
  ...
  {"event":"error","data":{"message":"Token expired. (See https://help.ably.io/error/40142 for help.)","code":40142,"statusCode":401,"href":"https://help.ably.io/error/40142"}}

h5. Code example

```[javascript](code-editor:sse/eventstream)
xhttp.onreadystatechange = function() {
  console.log(xhttp.responseText);
};
xhttp.open("GET", "https://realtime.ably.io/event-stream?v=1.1&key={{API_KEY}}&channels=yourChannel");
xhttp.send();
```
