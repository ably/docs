...
- <span lang="default">untilAttach</span><span lang="ruby">:until_attach</span> := _false_ when true, ensures message history is up until the point of the channel being attached. See "continuous history":/storage-history/history#continuous-history for more info. If the @Channel@ is not attached, enabling this option will result in error<br>__Type: @Boolean@__
...
- <span lang="default">untilAttach</span><span lang="ruby">:until_attach</span> := _false_ when true, ensures presence event history is up until the point of the channel being attached. See "continuous history":/storage-history/history#continuous-history for more info. If the @Channel@ is not attached, enabling this option will result in error<br>__Type: @Boolean@__
