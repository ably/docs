...
# Follow "these instructions for setting up an API key":https://knowledge.ably.com/setting-up-and-managing-api-keys-1 if you haven't done so before.
# In your "application dashboard":https://knowledge.ably.com/how-do-i-access-my-app-dashboard-1, go to the &quot;Settings&quot; tab and scroll down to the &quot;Channel rules&quot; section.
...
# Hit &quot;Save&quot; and you're done. Further details about setting up channel rules "can be found here":https://knowledge.ably.com/what-are-channel-rules-and-how-can-i-use-them-in-my-app-1.
...
And then run the demo locally by adding your "Ably API key":https://knowledge.ably.com/setting-up-and-managing-api-keys-1 to @server/index.js@, and building and running the client and server as described at the start of the tutorial.
