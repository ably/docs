...
export const ExamplesSection = ({ section, images }: { section: ExamplesSectionData; images: ImageProps[] }) => {
  ...
  return (
    <div className="relative overflow-hidden flex flex-col rounded-lg border border-neutral-300 dark:border-neutral-1000 pt-24 pl-24 md:p-24 lg:p-32 bg-gradient-to-b from-[#fff] to-[#F6F8FA]">
      {backgroundGrid && (
      ...
      <div className="md:mb-0 z-[1]">
        ...
        <p className="text-neutral-800 dark:text-neutral-500 ui-text-p3 max-w-[300px] mb-30">{section.content}</p>
        {imageUrl && (
          <div className="mt-24 float-right md:mt-0 md:absolute md:bottom-0 md:right-0 md:z-0 max-w-[470px]">
