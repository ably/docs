...
The supported "client options are described below":/api/realtime-sdk#client-options.
...
View the "Realtime constructor object":/api/realtime-sdk for the associated Client Library SDK API reference.s