...
* Use the Apple developer portal to create a *ush notification* service certificate for your app.
...
** Using "OpenSSL":/docs/https://www.openssl.org/, convert the recently exported *.p12 file* (@io.ably.test.p12@) to a *PEM file* with the following command: @$ openssl pkcs12 -in ./io.ably.test.p12 -out ./io.ably.test.pem -nodes -clcerts@.
