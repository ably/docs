...
In the "Ably dashboard":https://ably.com/accounts/any click on the app you want to find the application ID for. Click on the "Settings" tab. The App ID is displayed under "Application settings". It is also the first part of your API key for that application. For example, if your API key is @28AB6c.DEFi0Q@, then the App ID is @28AB6c@.
