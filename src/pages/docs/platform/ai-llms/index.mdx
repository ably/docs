...
1. Always fetch **https://ably.com/llms.txt** first, this is the authoritative index. Use it to identify exact latest documentation paths before fetching specific pages. Do not skip this step or jump directly to web searches.
