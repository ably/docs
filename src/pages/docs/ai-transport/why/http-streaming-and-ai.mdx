...
AI Transport implements durable [sessions](/docs/ai-transport/concepts/sessions) on Ably channels. Read [how a durable session solves each of these problems](/docs/ai-transport), or [get started with the Vercel AI SDK](/docs/ai-transport/getting-started/vercel-ai-sdk).
