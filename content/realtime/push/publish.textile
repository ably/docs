...
See the "raw push publish REST API":/rest-api#push-publish documentation for more information on the underlying direct publishing endpoint used by the client libraries.
...
realtime.push.publish(recipient, data) do
