...
Every message is redundantly stored across multiple isolated datacenters before acknowledgment, ensuring your chat history is always available when you need it. [Learn about Ably's fault tolerance](/docs/platform/architecture/fault-tolerance).
</Aside>
