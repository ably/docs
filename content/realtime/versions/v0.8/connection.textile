...
The recovery key @String@ can be used by another client to recover this connection's state in the <span lang="default">@recover@</span><span lang="csharp">@Recover@</span> "client options":/api/realtime-sdk#client-options <span lang="default">property</span><span lang="java">member</span><span lang="ruby">attribute</span>. See "connection state recover options":#connection-state-recover-options for more information.
