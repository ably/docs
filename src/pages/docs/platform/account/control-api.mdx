...
![Provision and Test](../../../../images/content/screenshots/control-api/provision-and-test.png)
...
## Account ID and app ID <a id="ids"/>

Operations that affect your entire account, such as [listing the apps](/docs/platform/account/control-api/#operation/listApps) associated with that account, require an account ID. Those that affect individual apps, such as [creating an API key](/docs/platform/account/control-api/#tag/keys/paths/~1apps~1{app_id}~1keys/post), require an app ID.

### How to find your account ID <a id="account-id"/>
...
![Application Settings](../../../../images/content/screenshots/control-api/application-settings.png)
...
### Account <a id="examples-accounts"/>
...
See the [API reference](/docs/platform/account/control-api#tag/accounts/paths/~1accounts~1{account_id}~1stats/get) for information on the request body.
...
#### Create an app <a id="examples-create-app"/>
...
See the [API reference](/docs/platform/account/control-api/#tag/apps/paths/~1accounts~1{account_id}~1apps/post) for information on the request body.
...
#### List apps <a id="examples-list-apps"/>
...
#### Retrieve app statistics <a id="examples-app-stats"/>
...
See the [API reference](/docs/platform/account/control-api#tag/apps/paths/~1apps~1{app_id}~1stats/get) for information on the request body.
...
#### List queues <a id="examples-queues-list"/>
...
#### Create a queue <a id="examples-queues-create"/>
...
See the [API reference](/docs/platform/account/control-api/#tag/queues/paths/~1apps~1{app_id}~1queues/post) for information on the request body.
...
#### List API keys <a id="examples-keys-list"/>
...
#### Create a key <a id="examples-keys-create"/>
...
#### Update a key <a id="examples-keys-update"/>
...
#### Revoke a key <a id="examples-keys-revoke"/>
...
#### List rules <a id="examples-rules-list"/>
...
#### List a rule by rule ID <a id="examples-rules-list-id"/>
...
#### Create a rule <a id="examples-rules-create"/>
...
| `enveloped` | true | Wrap packet in [metadata](/docs/platform/integrations/webhooks#envelope) |
...
#### Update a rule <a id="examples-rules-update"/>
...
#### Delete a rule <a id="examples-rules-delete"/>
...
## Testing with Postman <a id="postman"/>
...
### Importing the OpenAPI document into Postman <a id="importing"/>
...
![Postman import default](../../../../images/content/screenshots/control-api/postman-import-default.png)

5. The imported document now appears in your Postman collections:

![Postman imported collection](../../../../images/content/screenshots/control-api/imported-collection.png)

You have now imported the OpenAPI document into Postman.

### Sending a request <a id="send-request"/>
...
![App list request](../../../../images/content/screenshots/control-api/app-list-request.png)
...
![Bearer token](../../../../images/content/screenshots/control-api/bearer-token.png)
...
![Send request](../../../../images/content/screenshots/control-api/send-request.png)

5. The server returns a response, listing your Ably apps:

![Response](../../../../images/content/screenshots/control-api/list-apps-response.png)

You can now try out other requests. You need to set the necessary parameters and authentication token as required by that specific request. Consult the [API Reference](/docs/platform/account/control-api) for further information.
