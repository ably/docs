...
| `change.userClaim` | A server-signed [user claim](/docs/chat/setup#user-claims) attached to this typing event, derived from the user's [JWT](/docs/chat/setup#set-user-claims). | `String` (optional) |
...
<If lang="javascript">
Use the [`typing.currentTypers`](https://sdk.ably.com/builds/ably/ably-chat-js/main/typedoc/interfaces/chat-js.Typing.html#currentTypers) property to retrieve the users that are currently typing in the room:
</If>
