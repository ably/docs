...
* "Download an Ably client library":/download - client libraries for every popular platform provided as both Realtime and REST versions
* "Sign up for a free account":/signup - our generous free packages give you a healthy quota of messages and connections allowing you to build a production ready app now
* "Considering another solution?":/compare - see how we compare and why developers are moving to Ably
