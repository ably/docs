...
The connection-level <If lang="javascript,nodejs">[`echoMessages`](/docs/pub-sub/api/javascript/realtime/realtime-client#constructor-params)</If><If lang="flutter,go,java">[`echoMessages`](/docs/api/realtime-sdk/types#client-options)</If> option disables echo across all channels on a connection. The `echo` channel param provides finer control, disabling echo on specific channels while leaving others unaffected.
...
The channel-level `echo` param works alongside the connection-level <If lang="javascript,nodejs">[`echoMessages`](/docs/pub-sub/api/javascript/realtime/realtime-client#constructor-params)</If><If lang="flutter,go,java">[`echoMessages`](/docs/api/realtime-sdk/types#client-options)</If> setting:
