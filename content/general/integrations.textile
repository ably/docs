...
"Incoming webhooks":/docs/general/incoming-webhooks enable you to publish data from an external web service into an Ably channel by registering a new webhook endpoint in Ably and configuring it within an external service.
...
The "Kafka Connector":/docs/general/kafka-connector extends Kafka's streaming capabilities beyond your private network by enabling you to distribute messages to client devices.
...
* "AMQP":/docs/general/firehose/amqp-rule
* "Amazon Kinesis":/docs/general/firehose/kinesis-rule
* "Amazon SQS":/docs/general/firehose/sqs-rule
* "Kafka":/docs/general/firehose/kafka-rule
* "Pulsar":/docs/general/firehose/pulsar-rule
