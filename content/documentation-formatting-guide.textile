...
Note that if you don't include a full set of languages, or at least provide a @default@ language, then a language selector will appear.  In the example below, no language has been specified for @javascript@.
