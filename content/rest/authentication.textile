...
p(tip). Look at the "general authentication documentation":/general/authentication#token-authentication for more in-depth information on Token Authentication.
