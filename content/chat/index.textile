...
- "Participant activity":/chat/participant-activity := display the status of chat participants such as whether they are online or offline, by monitoring when they enter and leave the conversation. If the user is online, display when they were last seen as active within the chat application.
