...
Keys in a map can contain <If lang="javascript">numbers, strings, booleans and buffers</If>numbers, strings, booleans, `Data`, JSON objects and JSON arrays<If lang="swift"></If>, as well as other `LiveMap` and `LiveCounter` objects.
