...
5. Set the "Endpoint URL" field to `https://main.realtime.ably.net/chat/v4/moderation/hive/delete?clientId=<base64Id>` (if you have a [dedicated cluster](/docs/platform/account/enterprise-customization#setting-up-a-custom-environment) the domain should be your custom REST domain)
