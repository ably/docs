...
<Aside data-type='note'>
Using an API key directly is safe for server-side Node.js applications. If you're building a client-side application that runs in a browser or mobile app, use [token authentication](/docs/platform/auth/token) instead to keep your API key secure.
</Aside>
...
Explore the [Ably CLI](https://www.npmjs.com/package/@ably/cli) further, or visit the Chat [API references](https://sdk.ably.com/builds/ably/ably-chat-js/main/typedoc/modules/chat-js.html).
