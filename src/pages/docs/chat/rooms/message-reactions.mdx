...
Reaction additions and removals are delivered to all users in the same order, maintaining consistent reaction counts and state across disruptions. [See evidence](/docs/platform/architecture/connection-recovery#message-identification-with-timeserial).
</Aside>
