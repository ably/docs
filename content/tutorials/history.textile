...
blang[php].
  ...
  And then run the demo locally by adding your "Ably API key":https://support.ably.io/support/solutions/articles/3000030502-setting-up-and-managing-api-keys to @history.php@, install composer dependencies with:

  bc[sh]. composer install

  and running this script with @php history.php@.
