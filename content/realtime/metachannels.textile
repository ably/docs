...
If you are using an API key, you can set the key's capabilities in the "Ably dashboard":https://ably.com/dashboard. If you are using "tokens":/core-features/authentication#token-authentication, you specify capabilities within the token.
