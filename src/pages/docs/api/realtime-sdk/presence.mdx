---
title: Presence
intro: "Presence tracking shows which clients are currently active on a channel and enables real-time awareness features. The Realtime SDK presence API manages member states, occupancy counts, and presence event notifications."
