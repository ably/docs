...
| userClaim | The user claim attached to this message by the server. Only present if the publishing user's [JWT](/docs/platform/auth/token#jwt) contained a claim for the room in which this message was published. | String or Undefined |
