...
blang[javascript,nodejs].
  ...
  <a href="@content/docs/realtime/message-interactions.png" target="_blank">
    <img src="@content/docs/realtime/message-interactions.png" style="max-width:80%" alt="Message interactions in dashboard">
  </a>
  ...
  * Passing the filter object to "@unsubscribe()@":/docs/api/realtime-sdk/channels#unsubscribe and, or
  * Passing the filter function to "@unsubscribe()@":/docs/api/realtime-sdk/channels#unsubscribe
