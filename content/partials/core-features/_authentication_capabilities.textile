...
- object-subscribe := can get the root object for LiveObjects on a channel and subscribe to updates on those objects
- object-publish := can perform mutation operations on LiveObjects on a channel
