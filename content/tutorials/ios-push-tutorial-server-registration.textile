...
The default for AblyRealtime.push.activate is to register the device with Ably directly from the device, but you can instead delegate that to your server. For this tutorial we are going to use our server to register the device.
