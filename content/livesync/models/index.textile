...
<a href="/images/diagrams/models-SDK-optimistic-update.png" target="_blank">
  <img src="/images/diagrams/models-SDK-optimistic-update.png" style="width: 100%" alt="Models SDK optimistic update">
</a>
...
Create a simple sync function which loads the post and its comments.
