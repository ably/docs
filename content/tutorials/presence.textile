...
<%= partial 'tutorials/_install_ablyrealtime', vars(use_client_id: true, why_realtime: "be present and subscribe to presence messages", languages: [:js, :ruby]) %>
...
<div>
  <div>
    <p>
      ...
      <button id="connect-to-ably">Connect to Ably</button>
    </p>
