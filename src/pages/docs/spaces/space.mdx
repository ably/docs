---
title: Space
intro: Create virtual collaboration areas within your application where users can interact in Realtime. Spaces enable avatar stacks, member locations, live cursors, and component locking for rich collaborative experiences.
