...
meta_description: "Version 0.2.0 of the Ably AI Transport JS SDK has been released."
date: "2026-06-08"
products:
  - ai-transport
---
...
For the full changelog, please visit the [GitHub release page](https://github.com/ably/ably-ai-transport-js/releases/tag/0.2.0).
