...
* Reattach all channels you have created. If a channel is already attached, and you call the "<span lang="default">@channel#attach@</span><span lang="csharp">@channel#Attach@</span>":/realtime/channels-messages/#attach method, the channel will simply remain attached. It is therefore safe to simply attach all channels every time the connection becomes @connected@
