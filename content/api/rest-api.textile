...
* "Authentication":/api/rest-api#authentication of the server with Ably, and creation of tokens for use by clients.
* "Publication of messages":/api/rest-api#publish
* "Retrieval of message history":/api/rest-api#message-history
* "Retrieval of presence state and presence":/api/rest-api#presence
* "Retrieval of statistics for application usage":/api/rest-api#stats

More details on these operations can be found in the "Ably REST API Reference documentation":/api/rest-api.
