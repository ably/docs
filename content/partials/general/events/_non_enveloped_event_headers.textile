...
- x-ably-version := the version of the Event. At present this should be @1.2@
- x-ably-envelope-appid := the "app ID":https://faqs.ably.com/how-do-i-find-my-app-id which the message came from
