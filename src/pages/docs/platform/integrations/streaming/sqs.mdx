...
intro: "Forward Realtime events to AWS SQS queues for reliable message processing and application decoupling. Stream messages, presence updates, and channel events automatically with secure IAM authentication and configurable encoding options."
...
| [Source](/docs/platform/integrations/streaming#sources) | Specifies the event types being sent to SQS. |
