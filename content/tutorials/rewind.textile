...
Next, we'll instantiate the Ably library and attach to the channels with the rewind param enabled. Add the following after the ending @<body>@ tag of the HTML file above:
