...
This is a suspend function. It completes when the room is attached, or throws a [`ChatException`](/docs/chat/api/kotlin/chat-client#chatexception) on failure.
...
This is a suspend function. It completes when the room is detached, or throws a [`ChatException`](/docs/chat/api/kotlin/chat-client#chatexception) on failure.
...
| error | An error that provides a reason why the room has entered the new status, if applicable. | [ErrorInfo?](/docs/chat/api/kotlin/chat-client#errorinfo) |
