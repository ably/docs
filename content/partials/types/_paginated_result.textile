...
bq(definition).
  ...
  flutter:  Future<"PaginatedResult":/realtime/types#paginated-result> first()
...
bq(definition).
  ...
  flutter:  Future<"PaginatedResult":/realtime/types#paginated-result> next()
