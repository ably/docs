...
- "Source":/general/events#sources := Choose which of @channel.message@, @channel.presence@, @channel.lifecycle@, or @channel.occupancy@ events on channels should activate this event rule.
- "Request Mode":/general/events#batching := This will either be in @Single Request@ mode or @Batch Request@ mode. "Single Request":/general/events#single-request will send each event separately to the endpoint specified by the rule. "Batch Request":/general/events#batch-request will send events triggered concurrently in the same request
