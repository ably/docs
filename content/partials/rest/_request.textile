...
bq(definition).
  ...
  csharp: Task<"HttpPaginatedResponse":/api/rest-sdk/types#http-paginated-response> Request(string method, string path, Dictionary<string, string> requestParams, JToken body, Dictionary<string, string> headers)
  ...
  go: "HTTPPaginatedResponse":/api/rest-sdk/types#http-paginated-response Request(method string, path string, params PaginateParams, body interface, headers http.Header)
