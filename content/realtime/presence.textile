...
A single <span lang="default">"@clientId@":/realtime/usage#client-id</span><span lang="ruby">"@client_id@":/realtime/usage#client-id</span><span lang="csharp">"@ClientId@":/realtime/usage#client-id</span> may be present multiple times on the same channel via different client connections. As far as Ably is concerned, these are different members of the presence set for the channel, however they will be differentiated by their unique <span lang="default">"@connectionId@":/realtime/connection#id</span><span lang="ruby">"@connection_id@":/realtime/connection/#id</span>. For example, if a client with ID "Sarah" is connected to a chat channel on both a desktop and a mobile device simultaneously, "Sarah" will be present twice in the presence member set with the same client ID, yet will have two unique connection IDs. A member of the presence set is therefore unique by the combination of the <span lang="default">"@clientId@":/realtime/usage#client-id</span><span lang="ruby">"@client_id@":/realtime/usage#client-id</span><span lang="csharp">"@ClientId@":/realtime/usage#client-id</span> and <span lang="default">"@connectionId@":/realtime/connection#id</span><span lang="ruby">"@connection_id@":/realtime/connection/#id</span> strings.
...
p(tip). Each unique <span lang="default">"@clientId@":/realtime/usage#client-id</span><span lang="ruby">"@client_id@":/realtime/usage#client-id</span><span lang="csharp">"@ClientId@":/realtime/usage#client-id</span> may only be present once when entering on behalf of another client as the unique identifier for each member in a presence set is the combined <span lang="default">"@clientId@":/realtime/usage#client-id</span><span lang="ruby">"@client_id@":/realtime/usage#client-id</span><span lang="csharp">"@ClientId@":/realtime/usage#client-id</span> and shared <span lang="default">"@connectionId@":/realtime/connection#id</span><span lang="ruby">"@connection_id@":/realtime/connection/#id</span>
...
bq(definition#enter-none).
  ...
  csharp:   public Task EnterAsync(object clientData)
...
bq(definition#leave-data).
  ...
  csharp:  public Task LeaveAsync(object clientData)
...
bq(definition#update-data).
  ...
  csharp:  public Task UpdateAsync(object clientData)
...
bq(definition).
  ...
  csharp:  public Task<IEnumerable<PresenceMessage>> GetAsync(bool waitForSync = true, string clientId = "", string connectionId = "")
...
h4. <span lang="default">@options@ parameters</span><span lang="objc,swift">@ARTRealtimePresenceQuery@ properties</span><span lang="csharp">method parameters</span>
...
bq(definition).
  ...
  csharp:  public Task<PaginatedResult<PresenceMessage>> HistoryAsync(DataRequestQuery query, bool untilAttached = false)
...
bq(definition#subscribe-listener).
  ...
  csharp:   public void Subscribe(Action<PresenceMessage> handler)
...
bq(definition#subscribe-event).
  ...
  csharp:  public void Subscribe("PresenceAction":#presence-action action, Action<PresenceMessage> handler)
...
bq(definition#unsubscribe-event).
  ...
  csharp:  public bool Unsubscribe("PresenceAction":#presence-action presenceAction, Action<PresenceMessage> handler)
...
bq(definition#unsubscribe-listener).
  ...
  csharp:  public bool Unsubscribe(Action<PresenceMessage> handler)
...
bq(definition#unsubscribe-all).
  ...
  csharp: public bool Unsubscribe()
...
bq(definition#enter-client-none).
  ...
  csharp:   public Task EnterClientAsync(string clientId, object clientData)
...
There are two overloaded versions of this method. With both versions, a <span lang="default">callback</span><span lang="ruby">block</span><span lang="java">completion listener</span><span lang="csharp">handler</span> can optionally be passed in to be notified of success or failure to leave.
...
bq(definition#leave-client-none).
  ...
  csharp:   public Task LeaveClientAsync(string clientId, object data)
...
bq(definition#update-client-data).
  ...
  csharp: public Task UpdateClientAsync(string clientId, object data)
