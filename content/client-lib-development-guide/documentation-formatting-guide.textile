...
h2(#minimisable). Minimisable/expandable sections

Sections of documentation are able to be minimised/expanded through one of two methods.

h3(#minimisable-title)(minimise=Click to see how to minimise by title). Minimise on the title
...
h3(#minimisable-block). Minimise as a block
