...
### How to find your account ID <a id="find-account-id"/>

In the [Ably dashboard](https://ably.com/accounts/any) click the dropdown from the top right, then select 'Account settings':

![Account settings](../../../images/content/screenshots/ids-keys/account-settings.png)
...
![Account ID](../../../images/content/screenshots/ids-keys/account-id.png)

## App ID <a id="app-id"/>

App IDs are used by operations that affect individual apps, such as creating an API key.

### How to find your app ID <a id="find-app-id"/>
...
![App settings](../../../images/content/screenshots/ids-keys/app-settings.png)

The "App ID" is displayed under 'Application settings':

![App ID](../../../images/content/screenshots/ids-keys/app-id.png)
...
### How to find your API Key <a id="find-api-key"/>
...
![API keys](../../../images/content/screenshots/ids-keys/api-keys.png)
...
![API key](../../../images/content/screenshots/ids-keys/api-key.png)
