...
In an asset tracking scenario the key participants are:
...
- @farWithoutSubscriber@ := The resolution to select if above the @proximityThreshold@ (see "@DefaultResolutionConstraints@":#default-resolution-constraints), with no subscribers.
- @farWithSubscriber@ := The resolution to select if above the @proximityThreshold@ (see "@DefaultResolutionConstraints@":#default-resolution-constraints), with one or more subscribers.
- @nearWithoutSubscriber@ := The resolution to select if below the @proximityThreshold@ (see "@DefaultResolutionConstraints@":#default-resolution-constraints), with no subscribers.
- @nearWithSubscriber@ := The resolution to select if below the @proximityThreshold@ (see "@DefaultResolutionConstraints@":#default-resolution-constraints), with one or more subscribers.
...
The following example shows how a trackable is added to a publisher, and how the default resolution constraints are populated:
