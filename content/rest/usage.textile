...
The REST client library is available in "most popular languages":https://ably.io/download/rest-client-libraries with a consistent API regardless of language.  You can view this documentation in the language of your preference using the language selector navigation.
...
<div lang="java">
The REST library for Java is downloadable as a JAR from <https://github.com/ably/ably-java/bin>

Ensure this JAR is included in your class path.

</div>

_Note: Since the REST client library is a direct subset of the Realtime client library, all "Realtime client libraries":/realtime also provide access to methods within this REST client library._
...
h6[java]. new Ably.Rest(options)

Operations are performed after first constructing the library:

bc[nodejs]. var Ably = require('ably-js'),
