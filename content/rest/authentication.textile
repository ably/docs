...
The REST client library provides the ability to issue tokens using the "@requestToken@ API endpoint":/rest-api#requesttoken, and also provides a number of helper functions to simplify the use of the authentication API.
