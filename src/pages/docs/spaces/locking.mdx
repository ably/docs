...
Ably automatically [recovers connections](/docs/platform/architecture/idempotency#connection-recovery-and-exactly-once-delivery) when clients briefly disconnect, so members retain their locks without requiring re-acquisition.
</Aside>
