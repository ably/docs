...
Note that if you want to consume realtime data from a queue, you should take a look at "Ably Queues":/docs/general/queues. They provide a simple and robust way to consume realtime data from your worker servers without having to worry about queueing infrastructure.
...
* "Apache Kafka":/docs/general/firehose/kafka-rule
* "Apache Pulsar":/docs/general/firehose/pulsar-rule
