...
blang[flutter].
  @ably.ChannelEvent@ is an enum representing all the events that can be emitted be the @Channel@; either a "@ChannelState@":/realtime/channels#channel-states or an @update@ event.
