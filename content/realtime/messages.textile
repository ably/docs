...
blang[jsall].
  ...
  *Note:* If you want to limit the ability of users to use message interactions you can use "JWT authenticated user claims":/auth/token#jwt-claims.
  ...
  To read more on applying rules to channels read our "channel rules documentation":/general/channel-rules-namespaces/.
