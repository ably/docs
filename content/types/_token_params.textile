...
- <span lang="default">@timestamp@</span><span lang="ruby">@:timestamp@</span> := <span lang="default">The timestamp (in milliseconds since the epoch)</span><span lang="ruby">The timestamp</span> of this request. @timestamp@, in conjunction with the @nonce@, is used to prevent token requests from being replayed.<br>__Type: <span lang="default">Integer</span><span lang="java">Long Integer</span><span lang="ruby">Time</span>__
