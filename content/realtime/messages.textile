...
```[flutter]
  ...
  final channelMessageSubscription = channel.subscribe().listen((ably.Message message){
...
bc[flutter]. final channelMessageSubscription = channel.subscribe().listen((ably.Message message){
 print('message received for event ${message.name}');
 print('message data: ${message.data}');
});
...
bc[flutter]. final channelMessageSubscription = channel.subscribe(name: "myEvent").listen((ably.Message message){
 print('message received for event ${message.name}');
 print('message data: ${message.data}');
});
