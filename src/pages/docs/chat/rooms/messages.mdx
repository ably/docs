...
Messages are delivered to all subscribers in the same order, with each message assigned a unique serial that enables consistent ordering. [Learn how Ably guarantees message ordering](/docs/platform/architecture/message-ordering#message-ordering-guarantees).
</Aside>
