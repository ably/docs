...
bc[csharp]. var channel = realtime.Channels.Get("chatroom");
channel.On(ChannelState.Attached, stateChange => {
...
bc[objc]. [channel on:ARTChannelEventAttached call:^(ARTConnectionStateChange *stateChange) {
...
bq(definition#on-state-listener).
  ...
  csharp:  void On("ChannelState":#channel-state event, Action<"ChannelStateChange":#channel-state-change> action)
...
bq(definition#once-state-listener).
  ...
  csharp:  void Once("ChannelState":#channel-state event, Action<"ChannelStateChange":#channel-state-change> action)
...
bq(definition#off-state-listener).
  ...
  csharp:  void Off("ChannelState":#channel-state event, Action<"ChannelStateChange":#channel-state-change> listener)
