...
```[objc]
[channel.presence history:^(ARTPaginatedResult<ARTPresenceMessage *> *resultPage, NSError *error) {
...
```[swift]
channel.presence.history { resultPage, error in
