...
Ably batches high-frequency room reactions to minimize message costs while ensuring all participants see reactions in real time. [Learn about room reactions](/docs/chat/rooms/reactions).
</Aside>
