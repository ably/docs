...
bq(definition).
  default:  first(callback("ErrorInfo":/api/realtime-sdk/types#error-info err, "PaginatedResult":#paginated-result resultPage))
...
bq(definition).
  default:  next(callback("ErrorInfo":/api/realtime-sdk/types#error-info err, "PaginatedResult":#paginated-result resultPage))
