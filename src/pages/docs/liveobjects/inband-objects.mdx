...
| Property | Description |
| -------- | ----------- |
| `link`   | A relative URL path to fetch the current state of the channel object on the channel via the [REST API](/docs/liveobjects/rest-api-usage#fetch-channel-object). This can be used directly with the Ably REST client's <If lang="javascript,nodejs">[request](/docs/pub-sub/api/javascript/rest/rest-client#request)</If><If lang="java">[request](/docs/api/rest-sdk#request)</If> method. |
