...
bq(definition).
  default: new Ably.Realtime(keyOrTokenIdString)
  ruby: Ably::Realtime.new(key_or_token_id_string)
  java: new io.ably.AblyRealtime(String keyOrTokenIdString)

This will instance the Realtime library with the provided API key or Token ID string.

bq(definition).
  default: new Ably.Realtime(clientOptions)
  ruby: Ably::Realtime.new(client_options)
  java: new io.ably.AblyRealtime(ClientOptions clientOptions)
...
The realtime client exposes the following public <span lang="default">attributes</span><span lang="java">members</span><span lang="javascript,nodejs">properties</span>.
...
bq(definition).
  ...
  ruby:    stats(Hash options) -> "EventMachine::Deferrable":/realtime/types#deferrable -> yields "PaginatedResult":/realtime/types#paginated-result<"Stats":/realtime/types#stats>
...
The following <span lang="default">params</span><span lang="ruby">options</span>, as defined in the "REST @/stats@ API":/rest-api#stats endpoint, are permitted:
...
bq(definition).
  ...
  ruby:   time → "EventMachine::Deferrable":/realtime/types#deferrable → yields Time
