...
p(tip). There are also various Beta features for the REST API. Where a feature is Beta it is labelled as such in the documentation.
...
Using one of the application keys created via the "application dashboard":https://faqs.ably.com/how-do-i-access-my-app-dashboard, basic authentication provides the simplest method to authenticate with Ably, but has two important limitations:
