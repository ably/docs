...
blang[swift].
  ...
  And install with @pod install@. Then, import the library in your code:
...
To connect a client to Ably, you will first need an API key. In this example we have provided a temporary API key, however if you have registered and visit your "application dashboard":https://ably.com/dashboard, you will be able to use your own API key. If you do not have an API key yet, you can "sign up now for a free account with Ably":https://ably.com/signup.
...
channel.subscribe { message in
  print("\(message.name ?? ""):\(message.data as! String)")
}
...
Publishing a message to a channel is straightforward and is supported by both our Realtime and REST libraries. "When should I use a Realtime library vs a REST library?":https://knowledge.ably.com/should-i-use-the-rest-or-realtime-library.
...
* "Control API":/control-api - provision your Ably app programmatically using Control API
