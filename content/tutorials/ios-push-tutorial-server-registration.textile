...
To enable Push Notifications on your device, it must be registered with Ably first. This can be done in two ways; you can either have the device register itself directly with Ably or delegate the registration work to your app server, which would then register the device with Ably on its behalf. In this tutorial, we'll implement the device registration via an app server. You can jump to "another tutorial":/tutorials/ios-push-tutorial-direct-registration if you'd rather like to have the device directly register itself with Ably.
...
<a href="https://github.com/ably/tutorials/pull/61/commits/0914d0c368efebedf0a04271a559693ca0661b97">See this step in GitHub.<a/>

h2(#step5). Step 5 - Setting up a Node.js server for authentication

<%= partial 'shared/tutorials/_setup_node_push_auth' %>

<a href="https://github.com/ably/tutorials/pull/61/commits/8b26c839ada99ae20f98840ae1e36dd352910b8b">See this step in GitHub.<a/>

h2(#step6). Step 6 - Setting up device registration via the server

<%= partial 'shared/tutorials/_setup_node_push_registration' %>

<a href="https://github.com/ably/tutorials/pull/61/commits/d44db117ab56e071d5fc858694253fadde98640d">See this step in GitHub.<a/>
...
<a href="https://github.com/ably/tutorials/pull/61/commits/974d278c64707a258cbda7f0ebf833c39e8dcc78">See this step in GitHub.<a/>

h2(#further-reading). Further Reading

* The source code for this tutorial can be found <a href="https://github.com/ably/tutorials/pull/61">here.<a/>
...
* You may also wish to deregister devices, information on that may be found in Ably's <a href="https://www.ably.io/documentation/rest-api#delete-device-registration">Push Notifications docs.</a>

* Using the "Push Admin API":/general/push/admin, you can get all of the stats related to your application implementing Push Notifications, such as the number and type of device registrations, etc.
