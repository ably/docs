...
myObject.set("user", LiveMapValue.of(LiveMap.create(Map.of(
    ...
    "status", LiveMapValue.of("online"))))).join();

// Create and assign a counter with initial value
myObject.set("score", LiveMapValue.of(LiveCounter.create(100))).join();

// Create nested structures
myObject.set("profile", LiveMapValue.of(LiveMap.create(Map.of(
    "name", LiveMapValue.of("Alice"),
    "score", LiveMapValue.of(LiveCounter.create(0)),
    "settings", LiveMapValue.of(LiveMap.create(Map.of(
        "theme", LiveMapValue.of("dark"),
        "notifications", LiveMapValue.of(true)))))))).join();
```
</Code>
