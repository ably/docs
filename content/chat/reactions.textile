...
To use message reactions, you'll need to enable this feature as a new "channel rule" within your application in the dashboard. When creating a chat application, your conversations will be defined by a common namespace.

Namespaces enable your conversations to be grouped together based on a prefix that is included as part of the channel name. Defining namespaces helps with management of channels such as defining the speed at which users can post messages, or whether users can react to messages.
...
// Join or create the reaction channel for the conversation "general" in the "public" namespace
