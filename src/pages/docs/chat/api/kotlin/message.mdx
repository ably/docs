...
| Property | Description | Type |
| --- | --- | --- |
| | Metadata supplied to a message update or deletion request, or `null`. Do not use metadata for authoritative information. There is no server-side validation. When reading the metadata, treat it like user input. | `Map<String, String>` |
