...
Every message is redundantly stored across multiple isolated datacenters within your region before acknowledgment, preventing data loss. [Learn how Ably's fault-tolerant architecture protects your data](/docs/platform/architecture/fault-tolerance#core-layer).
</Aside>
