...
<a href="/images/tutorials/queue-amqp-wolfram-alpha.png" target="_blank">
  <img src="/images/tutorials/queue-amqp-wolfram-alpha.png" style="width: 100%" alt="Reactor Queues and Wolfram Alpha diagram">
</a>
...
<a href="/images/tutorials/queue-amqp-wolfram-setup.png" target="_blank">
  <img src="/images/tutorials/queue-amqp-wolfram-setup.png" style="max-width: 100%" alt="Provision a Wolfram queue">
</a>
...
<a href="/images/tutorials/queue-amqp-wolfram-rule.png" target="_blank">
  <img src="/images/tutorials/queue-amqp-wolfram-rule.png" style="max-width: 100%" alt="Create a queue rule">
</a>
...
<a href="/images/tutorials/queue-amqp-wolfram-provisioned-test.png" target="_blank">
  <img src="/images/tutorials/queue-amqp-wolfram-provisioned-test.png" style="max-width: 100%" alt="Check that queue has updated">
</a>
...
<a href="/images/tutorials/wolfram-signup.png" target="_blank">
  <img src="/images/tutorials/wolfram-signup.png" style="max-width: 100%" alt="Wolfram sign up">
</a>

Once you have created an account, visit your developer portal "My Apps" section and click "Sign up to get your first AppID":

<a href="/images/tutorials/wolfram-get-app-id.png" target="_blank">
  <img src="/images/tutorials/wolfram-get-app-id.png" style="max-width: 100%" alt="Wolfram get app ID">
</a>

Finally, copy the AppID to your clipboard:

<a href="/images/tutorials/wolfram-app-id.png" target="_blank">
  <img src="/images/tutorials/wolfram-app-id.png" style="max-width: 100%" alt="Wolfram app ID">
</a>
