...
* If you want to set up realtime communication with IoT devices on platforms for which there's no native Ably client library available, you can use the "MQTT protocol adapter":/mqtt.
* If you wish to migrate from PubNub or Pusher to Ably, you can use the relevant "protocol adapter":/adapters to "switch to Ably":https://knowledge.ably.com/can-you-help-ease-the-pain-of-migration-from-another-data-stream-network, and then gradually switch over to using Ably client library SDKs.
