...
Further, assuming that the game can only start when at least two participants competing against each other are present, the server will need to be aware of the presence events published by clients whenever they enter or leave.
