...
Ably currently supports the following sources of data can be streamed by Firehose:
...
For details of authenticating these services with Ably, see our "AWS authentication":/general/aws-authentication/ documentation.
