...
The web client provides a browser-based interface for testing and debugging your realtime application. It offers realtime insights into application-wide events, such as connection status changes and channel activity. These features enable you to:
