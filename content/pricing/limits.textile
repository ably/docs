...
| *Presence members per channel with "server-side batching":/messages/batch#server-side enabled*<p>_the maximum number of clients that can be simultaneously present on a channel when server-side batching is enabled_</p> | 200 | 5,000 | 10,000 | 20,000 |
...
Integration limits relate to the rate and concurrency of "webhooks":/integrations/webhooks, "queues":/integrations/queues and "Firehose":/integrations/streaming.
