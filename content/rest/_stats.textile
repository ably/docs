...
- <span lang="default">options</span><span lang="objc,swift">query</span> := an optional <span lang="default">object</span><span lang="ruby">Hash</span><span lang="php">Associative Array</span><span lang="objc,swift">@ARTStatsQuery@</span><span lang="java">"@Param@":#param[] array</span> containing the query parameters
