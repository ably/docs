---
title: Edge network
intro: "Ably provides global connectivity through an edge network spanning 15+ AWS regions with CloudFront integration for optimal client routing to nearest datacenters. Ably's infrastructure includes DDoS protection, fallback mechanisms and latency based DNS routing for reliable worldwide access."
...
## Why the edge network matters <a id="why-matters"/>
...
## Edge network architecture <a id="architecture"/>
...
### Global deployment across multiple regions <a id="global-deployment"/>
...
### AWS CloudFront and network load balancers <a id="cloudfront-nlb"/>
...
### Fallback endpoints and secondary domains <a id="fallback-endpoints"/>
...
### Protocol-level resilience <a id="protocol-resilience"/>
...
### Infrastructure redundancy <a id="redundancy"/>
...
## Protection against denial of service attacks <a id="dos-protection"/>
...
### Layer 3/4 DoS protection with AWS Shield Advanced <a id="shield-advanced"/>
...
### Layer 7 protection with CloudFront WAF <a id="waf"/>
...
### Scalable infrastructure for absorbing traffic spikes <a id="traffic-scaling"/>
...
## Global connectivity considerations <a id="global-connectivity"/>
...
### Geographic coverage and edge presence <a id="geographic-coverage"/>
...
### Protocol support and transport optimization <a id="protocol-support"/>
...
### Handling network transitions and interruptions <a id="network-transitions"/>
...
## Operational monitoring and management <a id="monitoring"/>
...
### Health monitoring and alerting <a id="health-monitoring"/>
...
### Capacity planning and scaling <a id="capacity-planning"/>
