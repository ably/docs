...
The asset tracking solution provides two SDKs:
...
You will need to have a suitable developer environment installed, for example:
...
h2(#key-participants). Key participants
...
Resolution and Resolution policy are important aspects of the Ably Asset Tracking 
