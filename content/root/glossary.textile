...
Latency in the context of Ably can be measured by the time it takes for a message to be published in a channel on one connection and received in the channel by another connection.
