...
Under your Firebase project settings, click on the Cloud Messaging tab. You should be able to see your FCM server key, copy this key and paste it in 'Setting up Google/Firebase Cloud Messaging' section under the Notifications tab of your Ably app dashboard and click save.
