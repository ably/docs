...
CAVEAT-INPUT
Connection is implicit with instantiation, i.e. when a library is started, but this section covers explicit calls to connect and use cases for when to use this option.
...
Connection monitoring allows you to view and manage the states of connections to Ably.
...
```
p(note). The Ably dashboard contains a developer console. In the developer console you can view connection events. See https://ably.com/docs/tools#developer-console for more information.
...
h2(#closing-a-connection). Close a connection
