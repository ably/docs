...
meta_description: "Learn how to write asynchronous Javascript and consume the promise-based version of Ably's JavaScript SDK using the async/await syntax."
meta_keywords: "Ably realtime, JavaScript SDK, asynchronous JavaScript, async, await"
