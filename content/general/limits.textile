...
* @messages.hourly.warning.count@ - when you reach 80% of your pre-paid quota for the number of messages.
* @messages.hourly.soft.count@ - when your pre-paid quota for the number of messages has been exceeded.
...
* @messages.maxRate.warning@ - when you reach 50% of your pre-paid quota.
...
* @messages.hourly.warning.data@ - when you reach 80% of your pre-paid quota for bandwidth.
* @messages.hourly.soft.data@ - when your pre-paid quota for bandwidth has been exceeded.
...
Token request limit notifications are split into hourly and message rate notifications. 
...
* @tokenRequests.maxRate.warning@ - when you reach 50% of your pre-paid quota.
...
API requests limit notifications are split into hourly and message rate notifications. 
...
* @apiRequests.maxRate.warning@ - when you reach 50% of your pre-paid quota.
