...
h3(#token-request-process)(minimize). Ably TokenRequest is created by your servers and passed to clients
...
h3(#token-process)(minimize). Ably Token is issued by your servers and passed to clients
...
h3(#ably-jwt-process)(minimize). Ably JWT is created by your servers and passed to clients
...
h3(#jwt-embed-process)(minimize). Ably-compatible token is embedded in a External JWT from your server and passed to clients
...
h4(#capabilities-explained-all)(minimize). Ably Token request without capabilities example
...
h4(#capabilities-explained-intersection)(minimize). Ably Token is requested with intersection of capabilities example
...
h4(#capabilities-explained-error)(minimize). Ably Token is requested with incompatible capabilities
