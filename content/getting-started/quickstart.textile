...
blang[javascript,nodejs].
  ...
  <p>
    The JavaScript SDK can be used with React and React Native. We also provide a dedicated "React page":/frameworks/react with more information.
  </p>
  </aside>
blang[default].
...
blang[react].
  <!-- REACT TODO: review this section -->
