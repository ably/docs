...
Ably delivers over 500 billion messages monthly, demonstrating large throughput capability. [Learn how Ably scales to handle this volume](/docs/platform/architecture/platform-scalability#monitoring-and-auto-scaling).
</Aside>
