...
With the availability of both the "Realtime":/realtime as well as "REST":/rest libraries, choose what suits your application's needs best and get started.
...
* Don't use use different channels just to indicate different types of data or different events, if they're all going to the same set of clients. Use one channel, and distinguish between the different events using the message name.
