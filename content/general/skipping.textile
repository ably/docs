...
It can also be set to skip only specific rules. The rule id can be found alongside the rule on the integrations tab, or as part of the message envelope that is delivered to the integration.
