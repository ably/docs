...
* If you wish to migrate from PubNub/Pusher to Ably, you can use the relevant "protocol adapter":https://ably.com/protocols to "easily":https://knowledge.ably.com/can-you-help-ease-the-pain-of-migration-from-another-data-stream-network switch to Ably right away and gradually migrate to using native Ably client SDKs.
