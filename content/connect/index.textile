...
"Metachannels":/metadata-stats/metadata/subscribe are a namespace of channels beginning with the [meta] qualifier, separating them from regular channels. For connections there is a specific @[meta]connection.lifecycle@ channel that publishes messages about the lifecycle of realtime connections. The connection lifecycle consists of a number of "connection states":/connect/states#available-connection-states that can be observed and interacted with using methods available on the connection object.
