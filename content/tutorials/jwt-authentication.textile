...
This tutorial guides you through the process of creating a simple authentication server that generates a JWT. You'll see how the client can use this JWT to authenticate with Ably. You will also learn how the client can automatically request a new JWT, before the current JWT expires.
