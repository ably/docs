...
- <div lang="php">@isLast()@</div> := @true@ if this page is the last page<br>__Type: Boolean__
...
- <div lang="php">@hasNext()@</div> := @true@ if there are further pages<br>__Type: Boolean__
