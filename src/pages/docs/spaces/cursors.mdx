---
title: Live cursors
intro: Stream members' cursor positions across your application in Realtime to enhance collaborative awareness. Track mouse movements with automatic batching for optimal performance and contextual user engagement.
