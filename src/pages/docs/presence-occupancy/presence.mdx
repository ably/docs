...
When a client briefly disconnects, Ably preserves their connection state, including presence membership, for up to two minutes. This prevents false leave and re-enter events during temporary network issues. [Learn how Ably recovers connections seamlessly](/docs/platform/architecture/connection-recovery).
</Aside>
