...
Chat enables you to build fully featured realtime chat applications and chat features within your application.

Building realtime chat applications or implementing chat features within your application can be a challenging task. Ably's SDKs enable you to handle the realtime part of functionality whether this is to build a live support chat widget within your website or a live chat streaming platform.
