...
Stream Ably events to an external streaming or queuing service, or use Ably to distribute messages from a service such as Kafka or MongoDB to client devices.
...
The "MongoDB Connector":/general/mongodb-connector streams document changes from your database to your clients in realtime.
