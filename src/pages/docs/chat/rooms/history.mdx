...
Use the <If lang="javascript">[`messages.history()`](/docs/sdk/chat-js/v0/interfaces/chat-js.Messages.html#history)</If><If lang="swift">[`messages.get()`](/docs/sdk/chat-swift/v0/messages/get%28options%3A%29)</If><If lang="kotlin">[`messages.get()`](/docs/sdk/chat-kotlin/v0/chat-android/com.ably.chat/-messages/get.html)</If> method to retrieve messages that have been previously sent to a room. This returns a paginated response, which can be queried further to retrieve the next set of messages.
</If>

<If lang="react">
Use the [`history()`](/docs/sdk/chat-react/v0/interfaces/chat-react.UseMessagesResponse.html#history) method available from the response of the `useMessages` hook to retrieve messages that have been previously sent to a room. This returns a paginated response, which can be queried further to retrieve the next set of messages.
</If>
