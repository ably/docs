...
<a href="/images/concepts/mqtt/MQTT-Concepts-1.gif" target="_blank">
  <img src="/images/concepts/mqtt/MQTT-Concepts-1.gif" style="width: 100%" alt="MQTT basics">
</a>
...
The "QoS":https://support.ably.com/support/solutions/articles/3000044640 flag in Byte 1 is worth special consideration, since it lies at the heart of the variable functionality that MQTT supports. QoS flags contain the following values based on the intent and urgency of the message:
