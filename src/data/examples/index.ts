...
export const examples: Example[] = [
  ...
  },
  {
    ...
    name: 'Message append',
    description: 'Append data to a single message so streamed text is one compacted entry in channel history.',
    products: ['pubsub'],
    layout: 'single-horizontal',
    visibleFiles: [
      'src/script.ts',
    ...
    metaDescription: `Use the Ably Pub/Sub SDK to append data to a single message. Stream text delta-by-delta while keeping one compacted entry in channel history.`,
  },
  {
  ...
  },
  {
    ...
    name: 'Live voting with annotations',
    description: 'Run live polls and tally votes in realtime using message annotations.',
    products: ['pubsub'],
    languages: ['javascript'],
    layout: 'double-horizontal',
    githubUrl: 'https://github.com/ably-demos/live-voting-with-annotations',
    visibleFiles: [
      'src/script.ts',
      'src/shared/ably.ts',
      'src/voter.ts',
    ...
    metaTitle: `Build live voting using annotations with the Ably Pub/Sub SDK`,
    metaDescription: `Build a realtime live-voting app with Ably message annotations. Tally votes server-side with unique-vote summaries and stream live results to a presenter view.`,
  },
  {
