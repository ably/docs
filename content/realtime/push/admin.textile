...
h3(#access-control). Push admin access control and device authentication
...
Publishes a push notification directly to a device or group of devices sharing a "client identifier":/core-features/authentication#identified-clients. See the "push notification direct publishing documentation":/realtime/push/publish#direct-publishing for more information.
