...
intro: "Authenticate realtime connections and manage secure access using API keys, JWT tokens, or callback authentication methods. The Auth API supports token generation, renewal, identity management, and credential revocation for secure realtime messaging."
