...
Subscribe to receive messages in a room by registering a listener. Use the <If lang="javascript">[`messages.subscribe()`](/docs/sdk/chat-js/v0/interfaces/chat-js.Messages.html#subscribe)</If><If lang="swift">[`messages.subscribe()`](/docs/sdk/chat-swift/v0/documentation/ablychat/messages/subscribe%28%29-360z1)</If><If lang="kotlin">[`messages.subscribe()`](/docs/sdk/chat-kotlin/v0/-messages/subscribe.html)</If> method in a room to receive all messages that are sent to it:
</If>
...
<If lang="javascript,swift,kotlin">
Use the <If lang="javascript">[`messages.send()`](/docs/sdk/chat-js/v0/interfaces/chat-js.Messages.html#send)</If><If lang="swift">[`messages.send()`](/docs/sdk/chat-swift/v0/documentation/ablychat/messages/send%28params%3A%29)</If><If lang="kotlin">[`messages.send()`](/docs/sdk/chat-kotlin/v0/-messages/send.html)</If> method to send a message in a chat room. All users that are [subscribed](#subscribe) to messages on that room will receive it:
</If>
...
<If lang="javascript,swift,kotlin">
Use the <If lang="javascript">[`messages.subscribe()`](/docs/sdk/chat-js/v0/interfaces/chat-js.Messages.html#subscribe)</If><If lang="swift">[`messages.subscribe()`](/docs/sdk/chat-swift/v0/documentation/ablychat/messages/subscribe%28%29-8jolq)</If><If lang="kotlin">[`messages.subscribe()`](/docs/sdk/chat-kotlin/v0/-messages/subscribe.html)</If> method to receive messages in a room. To filter for updated messages, provide a listener that checks the <If lang="javascript,kotlin">`type`</If><If lang="swift">`action`</If> property of the message event:
</If>
...
<If lang="javascript,swift,kotlin">
Use the <If lang="javascript">[`messages.delete()`](/docs/sdk/chat-js/v0/interfaces/chat-js.Messages.html#delete)</If><If lang="swift">[`messages.delete()`](/docs/sdk/chat-swift/v0/documentation/ablychat/messages/delete%28message:params:%29)</If><If lang="kotlin">[`messages.delete()`](/docs/sdk/chat-kotlin/v0/-messages/delete.html)</If> method to delete a message in a chat room. All users that are [subscribed](#subscribe) to messages on that room will receive the deletion:
</If>
...
<If lang="javascript,swift,kotlin">
Use the <If lang="javascript">[`messages.subscribe()`](/docs/sdk/chat-js/v0/interfaces/chat-js.Messages.html#subscribe)</If><If lang="swift">[`messages.subscribe()`](/docs/sdk/chat-swift/v0/documentation/ablychat/messages/subscribe%28%29-8jolq)</If><If lang="kotlin">[`messages.subscribe()`](/docs/sdk/chat-kotlin/v0/-messages/subscribe.html)</If> method to receive messages in a room. To filter for deleted messages, provide a listener that checks the <If lang="javascript,kotlin">`type`</If><If lang="swift">`action`</If> property of the message event:
</If>
