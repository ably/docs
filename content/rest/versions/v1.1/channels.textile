...
It is also possible to publish a message to multiple channels at once using our "batch publish beta feature":/rest-api/batch.
...
It is common for a single message to be intended for multiple channels. If you wish to send a message to multiple channels within a single operation, you can make use of the "REST batch API":/rest-api/batch.
...
It is also possible to publish a message to multiple channels at once using our "batch publish feature":/rest-api/batch.
