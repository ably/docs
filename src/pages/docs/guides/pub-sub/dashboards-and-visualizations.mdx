...
### Streaming for audit and analytics

Outbound streaming enables you to capture dashboard data for both compliance and insights. Common use cases include building audit trails for regulated industries and powering realtime analytics pipelines.
