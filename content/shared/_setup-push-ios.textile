...
5 - A callback telling us we have deactivated push, we're just attempting reactivating it here.
6 - The standard callback from the application telling us that we received a push notification. We just print it out in the console but you more likely want to show an alert with the information.
...
8 - This is where the bulk of the token request to our server happens. It's just a simple GET request and JSONSerialization.
