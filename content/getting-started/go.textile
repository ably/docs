...
* Install "Go":https://go.dev/dl/ version 1.18 or greater.
...
* Update your @main()@ function to create a channel instance and register a listener to subscribe to the channel. Then run it with @go run main.go@:
...
* Update your @main()@ function to subscribe to, and join, the presence set of the channel. Then run it with @go run main.go@:
...
* Revisit the basics of "Pub/Sub":/docs/pub-sub?lang=go
