...
For a "message data":/api/realtime-sdk/message#data or "presence message data":/api/realtime-sdk/presence#presence-message of @{ "value1": "My first message", "value2": "My second message"}@, the following would be sent to your IFTTT endpoint:
