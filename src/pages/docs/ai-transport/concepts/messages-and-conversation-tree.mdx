---
title: "Messages and conversation tree"
...
- [Edit and regenerate](/docs/ai-transport/features/edit-and-regenerate): use branching in practice to fork and navigate conversations.
