...
h1. Realtime Client Library > Connection Object Reference
...
p[default]. Some text that applies to all other languages

p[python]. Some python text here

p[javascript]. Some text that applies to Javascript

p[nodejs]. Some text that applies to Node.js

p[ruby]. Some text that applies to Ruby

p[csharp]. Some text that applies to C#

p[cplusplus]. Some text that applies to C++

p[c]. Some text that applies to C

p[ios]. Some text that applies to iOS

p[appcelerator]. Some text that applies to Appcelerator

p[phonegap]. Some text that applies to PhoneGap
