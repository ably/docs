...
| Parameter | Required | Description | Type |
| --- | --- | --- | --- |
| params | Optional | Parameters to filter the presence set. | Ably.RealtimePresenceParams |
...
Requires `enableEvents` to be `true` in the [room's presence options](/docs/chat/api/javascript/rooms#get) (this is the default).
