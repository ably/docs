...
blang[php].
  ...
  Add the following to a file named @index.php@ to instance the Ably library inside your php script:
  ...
  "See this step in Github":https://github.com/ably/tutorials/commit/66bcfc7
...
blang[php].
  ...
  "See this step in Github":https://github.com/ably/tutorials/commit/f2906e4
...
blang[python].
  ...
  "See this step in Github":https://github.com/ably/tutorials/commit/d71f7ac
...
blang[php].
  ...
  "See this step in Github":https://github.com/ably/tutorials/commit/912cfa1
...
blang[python].
  ...
  "See this step in Github":https://github.com/ably/tutorials/commit/e8e4e8d
...
blang[php].
  ...
  And then run the demo locally by adding your "Ably API key":https://support.ably.io/support/solutions/articles/3000030502-setting-up-and-managing-api-keys to @index.php@ and running this script with @php index.php@.
...
blang[python].
  ...
  And then run the demo locally by adding your "Ably API key":https://support.ably.io/support/solutions/articles/3000030502-setting-up-and-managing-api-keys to @history.py@ and running this script with @python history.py@.
