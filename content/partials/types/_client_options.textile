...
- <span lang="default">transportParams</span><span lang="csharp">TransportParams</span><span lang="python">transport_params</span><span lang="ruby">:transport_params</span> := Optional. Can be used to pass in arbitrary connection parameters, such as "@heartbeatInterval@":/realtime/connection#heartbeats and "@remainPresentFor@":/realtime/presence#unstable-connections.<br>__Type: <span lang="default">@Object@</span><span lang="python">@Dict@</span><span lang="ruby">@Hash@</span><span lang="php">@Associative Array@</span><span lang="java">@Param []@</span><span lang="csharp">@Dictionary<string, string>@</span><span lang="flutter">@Map<String, String>@</span>__
