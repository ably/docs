...
6. Install [Ruby](https://www.ruby-lang.org/en/documentation/installation/) version 2.7 or greater.
7. Create a new project and install the Ably [Pub/Sub Ruby SDK](https://github.com/ably/ably-ruby):
...
Add the following to your client to close the connection after a simulated 10 seconds. Run it with `ruby get_started.rb`:
...
* Revisit the basics of [Pub/Sub](/docs/pub-sub?lang=ruby)
* Explore more [advanced](/docs/pub-sub/advanced?lang=ruby) Pub/Sub concepts
* Understand realtime [connections](/docs/connect?lang=ruby) to Ably
* Read more about how to use [presence](/docs/presence-occupancy/presence?lang=ruby) in your apps
* Fetch message [history](/docs/storage-history/history?lang=ruby) in your apps

You can also explore the Ably CLI further, or visit the Pub/Sub [API references](/docs/api/realtime-sdk?lang=ruby).
