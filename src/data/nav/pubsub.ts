          ...
          pages: [
            {
              ...
              pages: [
                { name: 'Realtime client', link: '/docs/pub-sub/api/javascript/realtime/realtime-client' },
          ...
          pages: [
            {
              ...
              languages: ['ruby', 'java', 'swift', 'objc', 'csharp', 'flutter'],
            },
            {
              name: 'Connection',
            ...
            },
            {
              ...
              languages: ['ruby', 'java', 'swift', 'objc', 'csharp'],
            },
            {
              name: 'Authentication',
            ...
            },
            {
              ...
              languages: ['ruby', 'java', 'swift', 'objc', 'python', 'android'],
            },
            {
            ...
            },
            {
              ...
              languages: ['ruby', 'java', 'swift', 'objc', 'csharp', 'flutter', 'go'],
            },
          ],
        },
        {
          ...
          pages: [
            {
              ...
              languages: ['ruby', 'java', 'swift', 'objc', 'csharp', 'flutter', 'go', 'python', 'php'],
            },
            {
              name: 'Channels',
            ...
            },
            {
              ...
              languages: ['ruby', 'java', 'swift', 'objc', 'csharp', 'go', 'python', 'php'],
            },
            {
              name: 'Authentication',
            ...
            },
            {
              ...
              languages: ['ruby', 'java', 'swift', 'objc', 'php', 'android'],
            },
            {
              name: 'Encryption',
