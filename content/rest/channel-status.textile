...
* See "Channel Status API Reference - Realtime":/api-reference/realtime-sdk#channel-status-api
* See "Channel Status API Reference - REST":/api-reference/rest-sdk#channel-status-api
