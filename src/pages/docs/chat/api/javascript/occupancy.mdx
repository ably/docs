...
Returns a promise. The promise is fulfilled with the current occupancy data, or rejected with an [`ErrorInfo`](/docs/chat/api/javascript/chat-client#errorinfo) object.
