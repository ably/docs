...
describe('Converts Blang strings to HTML', () => {
  ...
  it('Never interferes with a non-blang string', () => {
    fc.assert(
      fc.property(fc.string(), fc.string(), fc.boolean(), fc.boolean(), (content, language, innerTag, outerTag) => {
  ...
  it('Always replaces a blang block with HTML', () => {
    fc.assert(
      fc.property(fc.string(), alphaNumericString, fc.boolean(), (content, language, outerTag) => {
