...
<a href="/images/tutorials/reactor-event-google-dataflow-diagram.png" target="_blank">
  <img src="/images/tutorials/reactor-event-google-dataflow-diagram.png" style="width: 100%" alt="Diagram of the tutorial project's architecture">
</a>
...
Create a folder on your local machine, and in that folder, create a new package.json file, using @npm init@. Next, install the project dependencies using @npm install ably compromise fuzzyset@. Once you have done this, your package.json file will look something like this:
...
bq. _Note that while the above package.json file can be found in the tutorial repository, the package versions it references that may become outdated if we haven't updated the tutorial repository in a while (particularly the ably package, which is updated more frequently than the tutorial repository). We recommend performing the install step above, which will ensure that you are referencing up-to-date package versions._

From the "tutorial repository":http://todo-repository-link, download the "pizza.js":http://todo-repository-link/deployment-package/pizza.js file, and place it in your project file alongside @package.json@.
...
Finally, create a ZIP package from containing your project files, ready for deployment as described further below.
...
<a href="/images/tutorials/reactor-event-google-function-1.png" target="_blank">
  <img src="/images/tutorials/reactor-event-google-function-1.png" style="width: 100%" alt="Create a new function app">
</a>
...
# Enter the name of the function to execute. This should be the name of the function implemented in step 2, above.
# Finally, click the blue "Create" button, and wait while your function is deployed.

<a href="/images/tutorials/reactor-event-google-function-2.png" target="_blank">
  <img src="/images/tutorials/reactor-event-google-function-2.png" style="width: 100%" alt="Define function app details">
</a>
...
<a href="/images/tutorials/reactor-event-google-function-3.png" target="_blank">
  <img src="/images/tutorials/reactor-event-google-function-3.png" style="width: 100%" alt="Define function app details">
</a>

<a href="/images/tutorials/reactor-event-google-function-4.png" target="_blank">
  <img src="/images/tutorials/reactor-event-google-function-4.png" style="width: 100%" alt="Define function app details">
</a>
...
Choose the "Google Cloud" option:

<a href="/images/tutorials/reactor-event-rule-3.png" target="_blank">
  <img src="/images/tutorials/reactor-event-rule-3.png" style="width: 100%" alt="Select the Google Cloud option">
</a>
...
<a href="/images/tutorials/reactor-event-google-rule-4.png" target="_blank">
  <img src="/images/tutorials/reactor-event-google-rule-4.png" style="width: 100%" alt="Fill out the form">
</a>
