...
blang[java].
  ...
  To run the demo locally, Make sure to add your "Ably API key":https://knowledge.ably.com/setting-up-and-managing-api-keys to @Constants.java@, if you haven't already done so.
...
blang[javascript].
  ...
  # Make sure to add your "Ably API key":https://knowledge.ably.com/setting-up-and-managing-api-keys to @publisher.html@ and @subscriber.html@ files, if you haven't already done so.
...
blang[nodejs].
  ...
  Make sure to add your "Ably API key":https://knowledge.ably.com/setting-up-and-managing-api-keys to @constants.js@, if you haven't already done so.
...
1. If you would like to find out more about how to use the encryption API from your devices and apps, see the "Realtime encryption documentation":https://ably.com/documentation/realtime/encryption. Typically on servers customers prefer to use the "REST encryption API":https://ably.com/documentation/rest/encryption
