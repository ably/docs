...
h3. Example @channel.opened@ JSON payload
...
h3. Example @channel.closed@ JSON payload
...
h3. Example @channel.presence@ @enter@ JSON payload
...
h3. Example @channel.presence@ @update@ and @leave@ JSON payload
