...
In Firefox, the situation is simpler, as Firefox allows us to request for the screen capture directly.
...
<iframe src="https://ablyscreenshare.herokuapp.com/" height="400px" width="100%"  allow="geolocation; microphone; camera"></iframe>
...
Please note that if you are required to use a different computer as the screen-share cannot be captured with two browsers at the same time.

h2. Conclusion

In this tutorial, we have seen how to use WebRTC in conjunction with Ably to build a real-time screen share app. Have any thoughts on how we could make this lesson better? Let us know.
