...
realtime.push.admin.publish(recipient, data: ["data": ["foo": "bar"]]) { error in
  print("Push notification published")
}
```
```[java,android]
AblyRest rest = new AblyRest("{{API_KEY}}");
rest.push.admin.publishAsync(recipient, data, new CompletionListener() {
  @Override
  public void onSuccess() {
    System.out.print("Push notification published")
  }

  @Override
  public void onError(ErrorInfo errorInfo) {
    System.out.print("Failed to publish")
  }
});
```
...
bq(definition).
  ...
  python: "PushChannelSubscription":#push-channel-subscription get(channel_subscription="PushChannelSubscription":#push-channel-subscription)
  php: "PushChannelSubscription":#push-channel-subscription get("PushChannelSubscription":#push-channel-subscription channelSubscription)
  swift,objc: get("PushChannelSubscription":#push-channel-subscription channelSubscription, callback: (("PushChannelSubscription":#push-channel-subscription?, ARTErrorInfo?) -> Void)
  java,android: "PushChannelSubscription":#push-channel-subscription get("PushChannelSubscription":#push-channel-subscription channelSubscription)
...
blang[jsall,swift,objc].
  ...
  On failure to retrieve the push channel subscription, @err@ contains an "@ErrorInfo@":/realtime/types#error-info object with the failure reason.
...
blang[ruby].
  ...
  Failure to retrieve the push channel subscription will trigger the @errback@ callbacks of the "@Deferrable@":/realtime/types#deferrable with an "@ErrorInfo@":/realtime/types#error-info object with the failure reason.
