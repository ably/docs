...
bq(definition).
  ...
  dotnet: new AblyRealtime(string key)
...
bq(definition).
  ...
  dotnet:  public Task<"PaginatedResult":/realtime/types#paginated-result<"Stats":/realtime/types#stats>> StatsAsync(StatsDataRequestQuery query)
