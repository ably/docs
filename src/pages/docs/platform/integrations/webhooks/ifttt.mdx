...
intro: "Connect Ably events to IFTTT applets to create automated workflows that bridge your Realtime application with hundreds of popular services and devices. Trigger conditional chains when messages are published, users join or leave channels, or other events occur in your application."
