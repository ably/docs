...
| <If lang="javascript,nodejs,java,objc,swift,php,go">limit</If><If lang="ruby">:limit</If><If lang="csharp">Limit</If><If lang="python">limit</If> | _100_ maximum number of messages to retrieve up to 1,000 | <If lang="javascript,nodejs">`Number`</If><If lang="java,php,python,ruby,csharp,objc,swift,go">`Integer`</If> |
