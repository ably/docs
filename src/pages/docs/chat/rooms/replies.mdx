...
Ably achieves a global median message delivery latency of 37ms, ensuring replies appear instantly across all participants. [Learn how Ably measures and maintains low latency](/docs/platform/architecture/latency#how-latency-is-measured).
</Aside>
