...
Ably maintains message continuity for up to 2 minutes during disconnections. The SDKs automatically handle reconnection and deliver all missed messages. [Learn how Ably recovers connections seamlessly](/docs/platform/architecture/connection-recovery).
</Aside>
