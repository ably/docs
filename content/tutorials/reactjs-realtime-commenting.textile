...
And then run the app locally by adding your "Ably API key":https://knowledge.ably.com/setting-up-and-managing-api-keys to @src/ably.js@ and run
...
3. Learn more about Ably's "history feature":https://ably.com/tutorials/history#lang-javascript
