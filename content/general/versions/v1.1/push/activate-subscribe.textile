...
Before you subscribe to a channel for push, make sure its "channel namespace is configured to explicitly enable push notifications":https://knowledge.ably.com/what-are-channel-rules-and-how-can-i-use-them-in-my-app-1. By default, push notifications on channels are disabled.
