...
Use the <If lang="javascript">[`occupancy.current`](https://sdk.ably.com/builds/ably/ably-chat-js/main/typedoc/interfaces/chat-js.Occupancy.html#current)</If> property to retrieve the most recently received room occupancy:
