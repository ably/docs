...
This is a [durable session](/docs/ai-transport/why-ai-transport#durable-sessions). The HTTP request triggers the agent, but all communication flows through the Ably channel.
