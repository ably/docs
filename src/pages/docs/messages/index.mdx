...
intro: "Messages transport data between publishers and subscribers through decoupled pub/sub communication on channels. This pattern enables scalable, asynchronous data exchange where clients can send and receive content without direct connections."
meta_description: "Ably message concepts: transport data between publishers and subscribers via decoupled pub/sub communication on channels for scalable data exchange."
redirect_from:
  - /docs/rest/messages
