...
interface, in the staging environment only, to enable test applications and keys to be provisioned. Therefore, all tests are set up to run against the staging environment.
