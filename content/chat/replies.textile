...
Namespaces enable your chat to be grouped together based on a prefix that is included as part of the channel name. Defining namespaces helps with management of channels such as defining the speed at which members can post messages, or whether members can interact with messages such as reactions, replies, or threads.
