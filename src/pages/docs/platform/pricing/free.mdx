...
Once you upgrade to a [Standard](/docs/platform/pricing/standard) or [Pro](/docs/platform/pricing/pro) package, your consumption is counted from that point onwards. For example, if you upgrade in the middle of the month, you are charged for the first message you send after upgrading, not after the 6,000,000 messages allowed on the Free package.
...
If you're using the Free package, you can [close your account](/docs/account/users#close) at any time.
