...
# "Log into your app dashboard":https://knowledge.ably.com/how-do-i-access-my-app-dashboard-1
...
# "Ensure you are still logged into your app dashboard":https://knowledge.ably.com/how-do-i-access-my-app-dashboard-1 and navigate back to the app dashboard you used to provision your queue.
...
And then run the demo locally by adding your "Ably API key":https://knowledge.ably.com/setting-up-and-managing-api-keys-1 and Neutrino User ID and API Key to @server.js@, setting up the queues and queue rules as described in this tutorial and running the demo @node server.js@
