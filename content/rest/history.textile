...
bq(definition).
  ...
  dotnet:  Task<"PaginatedResult":#paginated-result<"Message":#message>> HistoryAsync("DataRequestQuery":/rest/types#data-request query);
...
h4. <span lang="default">@options@ parameters</span><span lang="objc,swift">@ARTDataQuery@ properties</span><span lang="dotnet">@DataRequestQuery@ query</span>

- <span lang="ruby">:</span>start := <span lang="dotnet">@null@ or a moment in time as @DateTimeOffset@</span><span lang="default">_beginning of time_ earliest <span lang="ruby">@Time@ or </span>time in milliseconds since the epoch for any message retrieved</span><br><br>__Type: <span lang="default">@Integer@</span><span lang="java">@Long Integer@</span><span lang="ruby">@Time@</span><span lang="objc,swift">@NSDate@</span><span lang="dotnet">@DateTimeOffset@</span>__
- <span lang="ruby">:</span>end := <span lang="dotnet">@null@ or a moment in time as @DateTimeOffset@</span><span lang="default">_current time_ latest <span lang="ruby">@Time@ or </span>time in milliseconds since the epoch for any messages retrieved</span><br>__Type: <span lang="default">@Integer@</span><span lang="java">@Long Integer@</span><span lang="ruby">@Time@</span><span lang="objc,swift">@NSDate@</span><span lang="dotnet">@DateTimeOffset@</span>__
- <span lang="ruby">:</span>direction := _backwards_ <span lang="ruby">@:@</span>@forwards@ or <span lang="ruby">@:@</span>@backwards@<br>__Type: <span lang="default">@String@</span><span lang="ruby">@Symbol@</span><span lang="dotnet">@QueryDirection@ enum</span>__
...
blang[dotnet].
  ...
  This method is asyncronous and the result needs to be awaited.
...
- <span lang="default">option</span><span lang="java">"Param":#param[] option</span><span lang="dotnet"></span> := <span lang="default">an optional object containing the query parameters</span><span lang="python">optional keyword arguments containing the query parameters</span><span lang="ruby">an optional set of key value pairs containing the query parameters</span><span lang="php">an Associate Array containing the query parameters</span>, as specified below.
...
h4. <span lang="default">@options@ parameters</span><span lang="objc,swift">@ARTDataQuery@ properties</span>

- <span lang="ruby">:</span>start := <span lang="dotnet">@null@ or a moment in time as @DateTimeOffset@</span><span lang="default">_beginning of time_ earliest <span lang="ruby">@Time@ or </span>time in milliseconds since the epoch for any message retrieved</span><br><br>__Type: <span lang="default">@Integer@</span><span lang="java">@Long Integer@</span><span lang="ruby">@Time@</span><span lang="objc,swift">@NSDate@</span><span lang="dotnet">@DateTimeOffset@</span>__
- <span lang="ruby">:</span>end := <span lang="dotnet">@null@ or a moment in time as @DateTimeOffset@</span><span lang="default">_current time_ latest <span lang="ruby">@Time@ or </span>time in milliseconds since the epoch for any messages retrieved</span><br>__Type: <span lang="default">@Integer@</span><span lang="java">@Long Integer@</span><span lang="ruby">@Time@</span><span lang="objc,swift">@NSDate@</span><span lang="dotnet">@DateTimeOffset@</span>__
- <span lang="ruby">:</span>direction := _backwards_ <span lang="ruby">@:@</span>@forwards@ or <span lang="ruby">@:@</span>@backwards@<br>__Type: <span lang="default">@String@</span><span lang="ruby">@Symbol@</span><span lang="dotnet">@QueryDirection@ enum</span>__
- <span lang="ruby">:</span>limit := _100_ maximum number of presence event messages to retrieve up to 1,000<br>__Type: @Integer@__
...
blang[dotnet].
  ...
  This method is asyncronous needs to be awaited.
