---
title: History
meta_description: "The client library provides message and presence event history for channels."
meta_keywords: "History, Message history, presence history"
section: realtime
index: 50
languages:
  - javascript
...
* See "History API Reference - Realtime":/realtime/realtime-api-reference#history-api
* See "History API Reference - REST":/rest/rest-api-reference#history-api
