...
- <div lang="dotnet">data</div> := The message payload, if provided<br>__Type: @String@, @byte[]@, plain C# object that can be serialized to Json
...
- timestamp := Timestamp when the presence update was received by the Ably the realtime service, as <span lang="default">milliseconds since the epoch</span><span lang="ruby">a @Time@ object</span><br>__Type: <span lang="default">@Integer@</span><span lang="java">@Long Integer@</span><span lang="dotnet">@DateTimeOffset@</span><span lang="ruby">@Time@</span>
