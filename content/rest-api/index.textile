...
When successful, returns an object with @channel@ and @messageId@ properties, in case you want to know the message ID assigned to correlate with messages received by realtime subscribers or integration recipients. When unsuccessful, returns an error as an "ErrorInfo":/rest/types#error-info object.
