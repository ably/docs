...
For building chat and reaction features, use the [Chat SDK](/docs/chat) which provides purpose-built APIs. The optimization patterns described in this guide apply to the underlying Pub/Sub channels that Chat uses.
</Aside>
...
- Consume stats live via the [`[meta]stats:minute`](/docs/metadata-stats/stats#app-meta) channel to track delta performance in real-time.
