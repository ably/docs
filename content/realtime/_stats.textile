...
- <span lang="default">options</span><span lang="objc,swift,dotnet">query</span> := an optional <span lang="default">object</span><span lang="ruby">Hash</span><span lang="objc,swift">@ARTStatsQuery@</span><span lang="dotnet">@StatsDataRequestQuery@</span><span lang="java">"@Param@":#param[] array</span> containing the query parameters
