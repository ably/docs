...
bq(definition).
  ...
  go:         First() ("HttpPaginatedResponse":/api/realtime-sdk/types#http-paginated-response, error)
...
bq(definition).
  ...
  go:       Next() ("HttpPaginatedResponse":/api/realtime-sdk/types#http-paginated-response, error)
