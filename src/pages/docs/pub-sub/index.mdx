---
title: Basic pub-sub
intro: "Pub/Sub messaging decouples publishers and subscribers through channels, enabling scalable message distribution across any number of connected clients. This fundamental pattern powers realtime communication by routing messages from publishers to all interested subscribers automatically."
meta_description: "Ably basic pub-sub: decouple publishers and subscribers through channels for scalable realtime message distribution and communication patterns."
---
