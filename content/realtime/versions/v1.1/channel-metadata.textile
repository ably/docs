...
The following events arise as messages on the @[meta]channel.lifecycle@ channel. In all cases, the @data@ member of the message is a "ChannelDetails":/api/realtime-sdk/channel-meta#channel-details instance.

- channel.opened := indicates that the channel has been activated globally; that is, it has become active in at least one region, having previously been inactive. The included ChannelDetails.status includes "occupancy":/api/realtime-sdk/channel-meta#occupancy globally
- channel.closed := indicates that the channel has been deactivated globally
- channel.region.active := indicates that the channel has been activated in a specific region. The included @ChannelDetails.status@ includes "occupancy":/api/realtime-sdk/channel-meta#occupancy in that region
- channel.region.inactive := indicates that the channel has been deactivated in a specific region. The included @ChannelDetails.status@ includes "occupancy":/api/realtime-sdk/channel-meta#occupancy in that region
...
View "Realtime channel metadata":/api/realtime-sdk/channel-meta for the associated Client Library SDK API reference.