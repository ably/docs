...
Whenever a member enters or leaves a channel, or updates their member data, an event is emitted to all presence subscribers on that channel.
...
h3(#other-events). Other events / more information
