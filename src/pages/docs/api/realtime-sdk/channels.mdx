---
title: Channels
intro: "Subscribe to topic-based pub/sub messaging and presence tracking across connected clients using named channels. The Channels API manages subscriptions, message publishing, channel operations, and live data distribution."
