...
This key can then be used to create time-limited "tokens":/api/realtime-sdk/authentication#tokens, with a limited set of access rights or "capabilities":/auth/capabilities, or with specific identities using "<span lang="default">@clientId@</span><span lang="csharp">@ClientId@</span>":/auth/capabilities#identified-clients. These tokens can the be distributed to untrusted clients.
