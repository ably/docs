...
* **Message references enabled** - If enabled, messages received on a channel will contain a unique @timeSerial@ that can be referenced by later messages for use with message interactions. Find out more about "message interactions":/realtime/messages#message-interactions.
