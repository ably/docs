...
<p>Clients must have the "privileged-headers":/docs/auth/capabilities#capability-operations capability enabled in their Ably "API key":/docs/auth or "token":/docs/auth/token to skip integrations.</p>
</aside>
