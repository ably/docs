...
When successful, returns an object with @channel@ and @messageId@ properties, in case you want to know the message ID assigned to correlate with messages received by realtime subscribers or Ably Integrations recipients. When unsuccessful, returns an error as an "ErrorInfo":/api/rest-sdk/types#error-info object.
