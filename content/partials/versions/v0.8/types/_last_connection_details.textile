...
- recoveryKey := An opaque string obtained from the "recoveryKey":/realtime/connection/#recovery-key attribute of the "Connection object":/api/realtime-sdk/connection before the page was unloaded. This property is used by the library to recover the connection<br>__Type: @String@__
