---
title: Subscribing to Channel Occupancy Events
excerpt: Learn how to access channel occupancy and make use of it in your apps
section: tutorials
category:
    - channels
group: sdk
...
Receiving realtime updates relating to Channel occupancy events is available only to our Enterprise customers via our "Realtime":/realtime client libraries. However, all users can use the "Channel Status API":/rest/channel-status to retrieve this data from the metachannels via REST requests whenever they need. "Get in touch":https://ably.com/pricing/enterprise with our sales team to get set up with an enterprise account.
