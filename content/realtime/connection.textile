...
bq(definition#on-state-listener).
  ...
  csharp:  public void On("ConnectionState":#connection-state @event, Action<"ConnectionStateChangehEventArgs":#connection-state-change> action)
...
bq(definition#on-listener).
  ...
  csharp:  public void On(Action<"ConnectionStateChangehEventArgs":#connection-state-change> action)
...
- <div lang="csharp">action</div> := action to be executed for matching state changes<br>__Type: "@ConnectionStateChangehEventArgs@":#connection-state-listener__
...
bq(definition#once-state-listener).
  ...
  csharp:  public void Once("ConnectionState":#connection-state @event, Action<"ConnectionStateChangehEventArgs":#connection-state-change> action)
...
bq(definition#once-listener).
  ...
  csharp:  public void Once(Action<"ConnectionStateChangehEventArgs":#connection-state-change> action)
...
bq(definition#off-state-listener).
  ...
  csharp:  public void Off("ConnectionState":#connection-state @event, Action<"ConnectionStateChangehEventArgs":#connection-state-change> action);
...
bq(definition#off-listener).
  ...
  csharp:  public void Off(Action<"ConnectionStateChangehEventArgs":#connection-state-change> action);
...
bq(definition).
  ...
  csharp:   public void Ping(Action<TimeSpan?, ErrorInfo> callback)
