...
* If connection option @autoConnect@ is true, any action that would implicitly or explicitly attach a channel will trigger the connection to be opened automatically.
