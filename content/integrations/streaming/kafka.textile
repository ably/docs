...
Use Ably's "Firehose":/docs/integrations/continuous-streaming/firehose#firehose-rules Kafka rule to send "data":/docs/integrations/continuous-streaming/firehoset#data-sources such as messages, occupancy, lifecycle and presence events from Ably to Kafka.
...
|_. Section                                                        |_. Purpose                                                                               |
|"Source":/docs/integrations/continuous-streaming/firehose#data-sources |Select the type of event source.                                                         |
