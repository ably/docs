  ...
  it('Text parser stage returns expected results', () => {
    expect(parsedData.replace(/\s/g, '')).toEqual(
      `<dl>
            ...
            <dd>Listener to be notified on completion<br /><em class="italics">Type: <a href="#completion-listener"><code>CompletionListener</code></a></em></dd>
  ...
  it('Lift language attributes stage returns expected results', () => {
    ...
    expect(loadedDom('body *').html().replace(/\s/g, '')).toEqual(
      `<div lang="javascript,nodejs"><dt><div>callback</div></dt><dd>is a function of the form <code>function(err)</code> which is called upon completion</dd></div>
    	<div lang="java"><dt><div>listener</div></dt><dd>Listener to be notified on completion<br><em class="italics">Type: <a href="#completion-listener"><code>CompletionListener</code></a></em></dd></div>
