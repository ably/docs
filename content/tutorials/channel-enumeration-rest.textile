...
2. If you would like to check out the other related tutorials to work with channel metadata, see "Channel Lifecycle Events":/tutorials/channel-lifecycle-events and "Channel Occupancy Events":/tutorials/channel-occupancy-events tutorials.
