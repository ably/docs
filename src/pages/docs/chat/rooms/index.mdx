...
Applications maintain their state during disruptions. All messages are received in correct order with zero message loss. [Learn how connection recovery works](/docs/platform/architecture/connection-recovery).
</Aside>
