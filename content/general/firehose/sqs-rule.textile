...
<a href="/images/screenshots/sqs-rule/integrations-tab.png" target="_blank">
  <img src="/images/screenshots/sqs-rule/integrations-tab.png" style="width: 100%" alt="Integrations tab">
</a>
...
<a href="/images/screenshots/sqs-rule/choose-sqs.png" target="_blank">
  <img src="/images/screenshots/sqs-rule/choose-sqs.png" style="width: 100%" alt="Choose sqs">
</a>
...
<a href="/images/screenshots/sqs-rule/sqs-rule-settings-sqs.png" target="_blank">
  <img src="/images/screenshots/sqs-rule/sqs-rule-settings-sqs.png" style="width: 100%" alt="sqs rule settings - sqs-specific">
</a>

The general settings:

<a href="/images/screenshots/sqs-rule/sqs-rule-settings-general.png" target="_blank">
  <img src="/images/screenshots/sqs-rule/sqs-rule-settings-general.png" style="width: 100%" alt="sqs rule settings - general">
</a>
...
See some examples of creating rules in the "rules section":/account/control-api/curl-examples#examples-rules of the Control API documentation. You can also refer to the "rule section":/api/control-api/api-reference#tag/rules/paths/~1apps~1{app_id}~1rules/post of the Control API Reference for information on creating a SQS rule. You will need to select a @ruleType@ of @aws/sqs@.
