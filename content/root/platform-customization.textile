...
- *Realtime*: @https://[ENDPOINT].realtime.ably.io/time@ (e.g. https://endpoint-example-realtime.ably.io/time)
- *REST*: @https://[ENDPOINT]-rest.ably.io/time@ (e.g. https://endpoint-example-rest.ably.io/time)
