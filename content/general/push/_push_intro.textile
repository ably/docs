...
<a href="/images/diagrams/push-publish-models.jpg" target="_blank">
  <img src="/images/diagrams/push-publish-models.jpg" style="width: 100%" alt="Push Notifications in Ably">
</a>
...
A separate and distinct push admin API is additionally provided in our client libraries specifically designed for use by your servers to facilitate managing and delivering push notifications across all of your registered devices. This API, amongst other things, includes features to manage registered devices, channel subscriptions and deliver push notifications directly. Currently the "push admin API":/general/push/admin is available in our JavaScript, Ruby, Java/Android and iOS libraries.
