...
Note that the average message size is 2KiB. Every 2KiB in size counts as 1 message towards your "message count":#messages. For example, although a message can be published that is 16KiB, this will count as 8 messages towards your message count.
