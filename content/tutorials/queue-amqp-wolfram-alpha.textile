...
And then run the demo locally by adding your "Ably API key":https://knowledge.ably.com/setting-up-and-managing-api-keys and Wolfram AppID to @server.js@, setting up the queues and queue rules as described in this tutorial and running the demo @node server.js@
