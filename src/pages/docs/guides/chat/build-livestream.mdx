...
<Aside data-type="usp">
Chat scales without limits or server management.

Ably automatically handles millions of concurrent chat connections, managing all websocket servers, failover, and scaling for you. [Learn about Ably's scalability](/docs/platform/architecture/platform-scalability).
</Aside>
...
<Aside data-type="usp">
Instant traffic spike absorption.

With 50% capacity headroom built in, Ably instantly absorbs traffic spikes without degradation or pre-provisioning. [Learn about Ably's infrastructure operations](/docs/platform/architecture/infrastructure-operations#resource-implications).
</Aside>
